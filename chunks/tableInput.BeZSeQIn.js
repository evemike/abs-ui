...
import { bc as Da, o as Pa, I as Ua, bb as ja, f as ee, aB as Oa, bh as Ya, O as _e, y as ce, m as $a, _ as Ba, a as U, aJ as za, ar as ae, aq as Fa, an as Ma, as as P } from "./vendor.DW1gWLiY.js";
import { b as te } from "./api.CF1BbFLh.js";
import { C as Qa } from "./main.De1Wc5h8.js";
import { u as se } from "./index.C61KVsTJ.js";
const Ra = {
  "w-full": "",
  "h-full": "",
  "overflow-auto": ""
  ...
  setup(I, { emit: z }) {
    const j = /* @__PURE__ */ Object.assign({ "./icon/airbyte.png": he, "./icon/airflow.png": ye, "./icon/amazon-s3.png": we, "./icon/amundsen.png": ke, "./icon/athena.png": qe, "./icon/atlas.png": Ce, "./icon/azuresql.png": Ie, "./icon/bigquery.png": Ne, "./icon/clickhouse.png": xe, "./icon/databrick.png": Ve, "./icon/dbt.png": Te, "./icon/delta-lake.png": Le, "./icon/domo.png": Se, "./icon/doris.png": Ee, "./icon/druid.png": De, "./icon/dynamodb.png": Pe, "./icon/glue.png": Ue, "./icon/googleCloudService.png": je, "./icon/hive.png": Oe, "./icon/ibmdb2.png": Ye, "./icon/iceberg.png": $e, "./icon/impala.png": Be, "./icon/kafka.png": ze, "./icon/kinesis.png": Fe, "./icon/looker.png": Me, "./icon/mariadb.png": Qe, "./icon/metabase.png": Re, "./icon/mlflow.png": Ge, "./icon/mode.png": Je, "./icon/mongodb.png": Ae, "./icon/mssql.png": He, "./icon/mysql.png": Ke, "./icon/oracle.png": We, "./icon/pinot.png": Xe, "./icon/postgres.png": Ze, "./icon/power-bi.png": ea, "./icon/presto.png": aa, "./icon/qliksense.png": ta, "./icon/quicksight.png": sa, "./icon/redash.png": na, "./icon/redpanda.png": ia, "./icon/redshift.png": oa, "./icon/sagemaker.png": la, "./icon/salesforce.png": _a, "./icon/saphana.png": ca, "./icon/singlestore.png": ra, "./icon/snowflakes.png": ga, "./icon/sqlalchemy.png": pa, "./icon/sqlite.png": ua, "./icon/superset.png": va, "./icon/tableau.png": da, "./icon/trino.png": ma, "./icon/vertica.png": ba }), O = /* @__PURE__ */ Object.assign({ "./svg/dakaishujukulianjie.svg": fa, "./svg/database.svg": ha, "./svg/field.svg": ya, "./svg/icon_clickhouse.svg": wa, "./svg/liebiaoziduanguanli.svg": ka, "./svg/mongodb.svg": qa, "./svg/mysql.svg": Ca, "./svg/oracle.svg": Ia, "./svg/postgresql.svg": Na, "./svg/schema.svg": xa, "./svg/server.svg": Va, "./svg/shujuku.svg": Ta, "./svg/table.svg": La }), F = I, { serverId: M, schemaIds: Q, sql: R, groups: ne, testConnect: Y, preview: c, refresh: b } = F, u = z, C = (t, s) => {
      ...
      setup(t, s) {
        const { id: i = "", groups: d } = t, e = { label: "label", leaf: "isLeaf", children: "children", value: "value", emitPath: !1 }, r = E([]), f = async () => {
          r.length = 0;
    ...
    const re = (t) => {
      ...
      emits: ["click"],
      setup(t, s) {
        const i = t.data, d = t.ids, e = i.isLeaf, r = q(!1), f = q(!1), h = E([]), p = (a = []) => {
          h.length = 0, h.push(...a);
        }, n = async (a) => {
        ...
        return d && d.includes(i.value) && !e && n(), () => m("div", { key: i.value, class: "w-full" }, [
          m("div", { class: "w-full m-y-1", style: "display:flex;align-items:center;gap:.5em;cursor:pointer;", onClick: o }, [
            e ? "" : f.value ? m(Pa, { class: "is-loading" }, { default: () => m(Ua) }) : m("b", { style: "color:#aaa;line-height:.9em;width:1em;text-align:center;", onClick: (a) => n(a) }, r.value ? "-" : "+"),
      ...
      setup(t, s) {
        const { server: i } = le(t), { ids: d = [] } = t, e = E([...d]), r = E([]), f = (o = []) => {
          r.length = 0, r.push(...o);
        ...
        return i.value && p(i.value), H(i, (o, l) => {
    ...
    const ue = () => "Select * from " + A.value, ve = (t) => {
      ...
      emits: ["up:sql"],
      setup(t, s) {
        const { schema: i, server: d } = le(t), e = q(t.sql || ""), r = [ja()], f = q(), h = (p = "") => {
        ...
        D("div", Ga, [
          ...
          D("div", null, [
            g(Y) != null ? (B(), K(g(ee), {
              key: 0,
              loading: k.value,
              icon: T[(i = v.value) == null ? void 0 : i.id] == !0 ? g(Oa) : g(Ya),
