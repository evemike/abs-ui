...
import { b5 as tt, a4 as X, B as M, b6 as ut, a_ as Y, b7 as pt, ay as dt, i as ft, b8 as et, aZ as Q, m as V, b9 as gt, b3 as N, ba as W } from "./vendor.Bh6KHC77.js";
var P;
((n) => {
      ...
      F.forEach((j) => {
        ...
        if (U(g))
          ...
          if (D[O] || (D[O] = []), g.isDirectRender === !0) {
            const L = v(g == null ? void 0 : g.tag) ?? v(e == null ? void 0 : e.tag) ?? "div", E = N(d) ? d({ tag: L, elem: g, context: e, params: _, parent: l }, y) : N(L) ? L({ elem: g, context: e, params: _ }, y) : L, st = typeof v(E) == "string" ? v(E) : W(v(E).name);
            D[O].push(
              (Z = {}) => H(E, xt(g, { ..._, ...Z }), {
                default: (rt = {}) => [
                  H(J("els-elem"), {
