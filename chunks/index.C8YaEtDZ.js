...
var $e = (l, e, t) => e in l ? _e(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t;
var C = (l, e, t) => ($e(l, typeof e != "symbol" ? e + "" : e, t), t);
import "../css/index-CX9pL3kB.css";
import { defineComponent as W, inject as e1, shallowRef as R, computed as M, onMounted as re, openBlock as F, createElementBlock as b, normalizeClass as Ee, createBlock as S, unref as c, createCommentVNode as J, createStaticVNode as t1, createElementVNode as E, watch as te, mergeProps as Fe, withCtx as V, Fragment as Z, renderList as ae, ref as Q, toRefs as pe, createVNode as N, toDisplayString as K, withModifiers as He, createTextVNode as ge, normalizeStyle as Ve, resolveDynamicComponent as i1, withDirectives as Oe, vShow as Ke, toRef as o1, provide as le, markRaw as $, render as a1, h as Ue, onUnmounted as r1 } from "vue";
import { g as v, M as s1, o as z, q as be, k as X, t as n1, x as l1, y as c1, z as d1, A as Ye, B as p1, d as I, C as ie, G as Be, D as A1, f as oe, F as Qe, H as Je, I as Te, J as P, K as De, L as Ze, N as h1, O as C1, P as Y, Q as g1, R as ee, S as f1, s as u1, T as w1, U as m1, V as B1, W as ve, X as y1, i as E1, h as F1, Y as Q1, Z as D1, _ as I1, $ as M1, a0 as H1, a1 as b1, a2 as v1, a3 as S1, a4 as L1, a5 as x1, a6 as T, a7 as k1, a8 as N1, a9 as G1, aa as ye, ab as U, ac as R1, ad as Se, n as fe, ae as P1, af as ce, e as q, ag as V1, ah as O1, ai as K1, aj as Le, ak as U1, al as Y1, am as J1, an as T1, ao as Z1 } from "./vendor.CNZ6m-gA.js";
import { E as _ } from "./main.CzNHmSIX.js";
import { _ as ue } from "./main.vue_vue_type_script_setup_true_lang.3rAtzWqA.js";
import { _ as j1 } from "./_plugin-vue_export-helper.CHgC5LLL.js";
import { _ as de, E as q1 } from "./main.vue_vue_type_script_setup_true_lang.6OQXopic.js";
import { _ as z1 } from "./view.vue_vue_type_style_index_0_lang.D7QP-7PN.js";
import { _ as W1, a as X1 } from "./main.vue_vue_type_script_setup_true_lang.Dru1xcKI.js";
import { _ as _1 } from "./main.vue_vue_type_style_index_0_lang.0u4eG972.js";
const $1 = /* @__PURE__ */ W({
  __name: "node",
  props: {
    node: {},
  ...
  setup(l) {
    const e = l, { node: t } = e, i = e1("GRAPH-CONTEXT"), { graphForm: a, graphShadow: o } = i, r = R(), s = M(() => {
    ...
    return re(() => {
      var h;
      p.value = { ...o == null ? void 0 : o.get(t), STEP_LIB: st, formStatus: a == null ? void 0 : a.getCellStatus(t) }, p.value.node = t, r.value = ((h = p.value.metadata) == null ? void 0 : h.markup) || (o == null ? void 0 : o.defaultNodeMarkup);
    }), (h, g) => (F(), b("div", {
      class: Ee(["default_node_style", A.value, { "is-selected": s.value, "is-current": n.value }])
    }, [
      r.value ? (F(), S(c(_), {
        key: 0,
        elem: r.value,
...
Note: This Processor expects CEF messages WITHOUT the syslog headers (i.e. starting at "CEF:0"`,
  ...
  connecting: {
    ...
    validateMagnet({ magnet: l }) {
      return l.getAttribute("port-group") !== "left";
    },
    validateConnection({
      sourceCell: l,
      targetCell: e,
      ...
      if (!o || !r || o[0] == "in" || r[0] == "out" || (o[1] || r[1]) && o[1] != r[1])
        return !1;
      const s = this.getEdges().filter((g) => g != a), n = s.filter((g) => g.getSourceCell() == l).length, A = s.filter((g) => g.getTargetCell() == e).length;
      return !(o[2] && be(o[2]) && n >= Number(o[2]) || r[2] && be(r[2]) && A >= Number(r[2]));
    }
  },
  highlighting: {
  ...
  stop: { bc: "#909399", c: "#909399" },
  loading: { bc: "#fff", c: "#999" },
  ...
  cls: [
    {
      ...
      cls: [
        { tag: X, "v-if": ({ step: l }) => c(l) == "loading", color: "#999", class: "_node-step is-loading", cls: { tag: n1 } },
        { tag: X, "v-if": ({ step: l }) => c(l) == "running", color: "#67C23A", class: "_node-step is-loading", cls: { tag: l1 } },
        { tag: X, "v-if": ({ step: l }) => c(l) == "invalid", color: "#E6A23C", class: "_node-step", cls: { tag: c1 } },
        { tag: X, "v-if": ({ step: l }) => c(l) == "stop", color: "#909399", class: "_node-step", cls: { tag: d1 } },
        { tag: X, cls: { tag: ue, ":name": "icon" } }
      ]
    },
    {
      tag: "div",
      ...
      cls: [
        {
          ...
          cls: [
            { tag: X, "#reference": "", class: "_node-tip-icon", cls: { tag: p1 } },
  ...
  cls: [
    { tag: "div", cls: [
      { tag: "b", class: "_title", cls: [{ tag: X, cls: { tag: ue, ":name": "data.icon" } }, "{{ data.label || '' }}"] }
      // { tag: "b", "@click": "() => close()", class: "_btn", cls: { tag: ElIcon, class: "_close", cls: Close } }
    ] },
    { tag: "div", class: "", cls: [
      { tag: I, "@click": ({ graphEvents: l, close: e, cell: t }) => {
        e() && l.eventCall("drawer:cancel", t);
      }, cls: "取消" },
      { tag: I, "@click": ({ graphEvents: l, close: e, cell: t }) => {
        l.eventCall("drawer:submit", t, e);
      }, type: "primary", cls: "确定" }
    ] }
  ]
}, lt = [
  {
    ...
    icon: oe,
    cls: "删除",
    "@click": ({ cell: l, graph: e, contextmenu: t }) => {
      e.removeCell(l), t.close();
    }
  }
], ct = [
  {
...
], dt = [
  {
    ...
    icon: Qe,
    cls: "全选",
    "@click": ({ graph: l, contextmenu: e }) => {
      l == null || l.trigger("cell:selectAll"), e.close();
    }
  },
  {
    tag: I,
    ...
    "@click": ({ graph: l, contextmenu: e, selectedCells: t, ElMessage: i }) => {
      t.value.length > 0 ? (l.cleanClipboard(), l.copy(t.value), e.close()) : i.warn("请先选中元素后再复制");
    }
  },
  {
    tag: I,
    ...
    "@click": ({ graph: l, contextmenu: e, clipboardCells: t }) => {
      const i = l.paste({ offset: 100 });
  ...
  { tag: P },
  {
    ...
    cls: "适合画布",
    "@click": ({ graph: l, contextmenu: e }) => {
      l.zoomToFit({ padding: { left: 50, top: 50, right: 50, bottom: 100 } }), e.close();
    }
  }
];
tt.newProcessorTypes.filter((l) => l.type.includes("ConsumeAMQP") || l.type.includes("ConsumeIMAP") || l.type.includes("ConsumeJMS")).map((l) => {
  const e = l.type.split(".").pop();
  return {
    name: "test-node",
    shape: "vue-node",
    ...
    tabs: [
      {
        label: "基础信息",
        type: "elem",
        elem: { tag: z, prop: "node.label", ":modelValue": "label", "@update:modelValue": ({ label: t, $: i }) => {
          t.value = i[0];
        } }
      },
      {
        ...
        column: [
          ...
          { prop: "type", label: "类型", value: `${e} ${l.bundle.version}`, required: !0, trigger: "change", message: "{{prop}} {{label}} is required!" },
          { prop: "code", label: "编码", value: "input.C.A", required: !0, rules: [{ required: !1 }, { min: 20 }] },
          { prop: "package", label: "打包", value: ` ${l.bundle.group} - ${l.bundle.artifact}` }
...
function wt(l, e) {
  return F(), b("svg", Ct, ut);
}
const mt = /* @__PURE__ */ j1(ht, [["render", wt]]), Bt = /* @__PURE__ */ W({
  __name: "drawer",
  props: {
    context: {},
    config: { default: () => ({
  ...
  setup(l) {
    const e = l, { config: t, context: i } = e, { graphShadow: a, graphForm: o } = i, r = a.currentCell;
    te(r, (y) => {
    ...
    }), n = M(() => a.get(r.value) || {}), A = M(() => (
      /* currentNode.value ? graphShadow.getByKey(currentNode.value,'tabHeader') : */
      nt
    )), p = M(() => r.value ? a.getTabs(r.value).value : []), h = M(() => p.value.map((y, u) => y.default ? "default-tab" : u + "")), g = M(() => ({ ...i, cell: r.value, data: r.value ? a.get(r.value) : {}, formStatus: r.value ? o.getCellStatus(r.value) : {} })), w = R(), m = g1((y, u) => {
    ...
    return (y, u) => (F(), S(c(Ze), Fe({
      ...
      default: V(() => [
        p.value.length > 0 ? (F(), b(Z, { key: 0 }, [
          p.value.length > 1 ? (F(), S(c(h1), {
            "model-value": "default-tab",
            key: s.value
          }, {
            default: V(() => [
              (F(!0), b(Z, null, ae(p.value, (d, f) => (F(), S(c(C1), {
                key: f + "-" + s.value,
                name: h.value[f],
                label: d.label
              }, {
                default: V(() => [
                  d.prop != null ? (F(), S(c(de), {
                    ...
                    params: g.value,
                    column: d.column,
                    elForm: { disabled: n.value.step.value == "running" }
...
class yt {
  ...
  blank() {
    ...
    (e = this.graph) == null || e.on("blank:click", (i) => {
      ...
      (n = this.contextmenuRef.value) == null || n.open(r), this.eventCall("blank:contextmenu", i);
    });
  }
  // 公共事件
  cell() {
    ...
    }), (n = this.graph) == null || n.on("cell:selectAll", () => {
      var p, h;
  ...
  node() {
    var e, t, i, a, o, r, s;
    (e = this.graph) == null || e.on("node:click", (n) => {
      ...
      this.clickHandle = setTimeout(() => {
        if (console.log("++++++++++++++++++", (/* @__PURE__ */ new Date()).getTime()), this.currentKeydown.has("Control"))
          return;
        const { node: A } = n;
        this.graphShadow.resetCurrentCell(A), this.graphForm.openDrawer(), this.eventCall("node:click", n), this.clickHandle = void 0;
      }, 500);
    }), (t = this.graph) == null || t.on("node:removed", (n) => {
      const { node: A } = n;
      this.graphShadow.removeCells([A]), this.eventCall("node:removed", n);
    }), (i = this.graph) == null || i.on("node:added", (n) => {
      this.eventCall("node:added", n);
    }), (a = this.graph) == null || a.on("node:moved", (n) => {
      this.eventCall("node:moved", n);
    }), (o = this.graph) == null || o.on("node:selected", (n) => {
      this.eventCall("node:selected", n);
    }), (r = this.graph) == null || r.on("node:unselected", (n) => {
      this.eventCall("node:unselected", n);
    }), (s = this.graph) == null || s.on("node:dblclick", (n) => {
      this.eventCall("node:dblclick", n);
    });
  }
  resetGraph(e) {
...
class Et {
  ...
  validateForm(e, t) {
    this.currentNode.value && e && t && t.validate == !0 && e.validate((i, a) => {
      ...
      (n = this.currentNode.value) != null && n.id && this.graphFormFailCells.add((A = this.currentNode.value) == null ? void 0 : A.id);
  ...
  async validateCell(e) {
    const t = e.id, i = this.data.value[t] || {}, a = this.cellColumn.get(t) || [], { status: o, info: r } = await q1.valideForm(i, a), s = this.getCellStatus(e);
    if (!s)
      return;
    if (o) {
    ...
    const n = Object.keys(r).map((A) => r[A].map((p) => p.message)).flat(1);
    s.value = { result: !1, info: n };
  }
  // 校验所有元素
  validateCells() {
    var t;
...
const Ft = { class: "_search" }, Qt = ["onMousedown", "title"], Dt = { class: "_label" }, It = /* @__PURE__ */ W({
  __name: "nodeList",
  props: {
  ...
  setup(l) {
    const e = l, t = Q(), { graph: i } = pe(e), { nodeList: a } = e, { initNodeFn: o } = e, r = Q(""), s = Q(), n = Q([]), A = f1(r, 500), p = M(() => {
      const w = A.value;
      let m = c(a) || [];
      w ? (m = m.filter(({ label: d, name: f, group: B }) => d.includes(w) || f.includes(w) || (B == null ? void 0 : B.includes(w))), n.value.push(...m.map((d) => d.group || ""))) : n.value = [];
      const y = [], u = [];
      for (const d of m) {
    ...
    return re(() => {
      ...
      N(c(w1), {
        ...
        default: V(() => [
          (F(!0), b(Z, null, ae(p.value, ([y, u]) => (F(), S(c(m1), {
            key: y,
            title: y,
            name: y
          }, {
            default: V(() => [
              (F(!0), b(Z, null, ae(u, (d) => (F(), b("div", {
                class: "_node_item",
                onMousedown: (f) => g(d, f),
                title: d.label
              }, [
  ...
  if (a) {
    let n = !1, A = 1;
    for (const p of a)
      n = n || p == null, t[A++] = p == null ? i : i.splice(0, p);
    n && i.length > 0 && (t[A] = i);
  } else if (o) {
    const n = new Array().concat(o), A = i.map((p) => ({ ...p, $_key: n.map((h) => v(p, h) || "").join() }));
    t = ve(A, "$_key");
  } else
    s ? t = ve(i, s) : r && (t = r(i));
  return t;
  ...
  return i && (t = y1(t, i)), a && (t = a(t)), o && (t = t.reverse()), t;
}, We = (l, e) => {
  let t = [...l];
  const { key: i = "id", blackList: a, whiteList: o, fn: r, items: s } = e;
  return a && (t = t.filter((n) => !a.includes(v(n, i)))), o && (t = t.filter((n) => o.includes(v(n, i)))), r && (t = t.filter((n) => r(n))), s && t.push(...s), t;
}, Mt = `## 组件使用说明
...
`, Ht = { class: "_menu" }, bt = {
  ...
  setup(l, { expose: e }) {
    const t = l, { context: i } = t, { config: a } = pe(t), o = i == null ? void 0 : i.graphTools, r = i == null ? void 0 : i.markdownRef, s = [
      { title: "导出", key: "export", icon: E1, handle: () => o == null ? void 0 : o.export() },
      { title: "导入", key: "import", icon: F1, handle: () => o == null ? void 0 : o.import() },
      { title: "撤销", key: "undo", icon: Q1, handle: () => o == null ? void 0 : o.undo() },
      { title: "恢复", key: "redo", icon: D1, handle: () => o == null ? void 0 : o.redo() },
      { title: "放大", key: "zoomBig", icon: I1, handle: () => o == null ? void 0 : o.zoomBig() },
      { title: "缩小", key: "zoomSmall", icon: M1, handle: () => o == null ? void 0 : o.zoomSmall() },
      { title: "保存", key: "save", icon: Qe, handle: () => o == null ? void 0 : o.zoomSmall() },
      { title: "帮助", key: "help", icon: H1, handle: () => {
        var A;
        return (A = r == null ? void 0 : r.value) == null ? void 0 : A.init(Mt);
      } },
    ...
    return e({}), (A, p) => (F(), b("div", Ht, [
      (F(!0), b(Z, null, ae(n.value, (h) => (F(), b(Z, null, [
        Array.isArray(h) ? (F(), b("div", bt, [
          (F(!0), b(Z, null, ae(h, (g) => (F(), b(Z, null, [
            g.tag ? (F(), S(c(_), {
              key: 0,
              elem: h,
              params: c(i)
  ...
  setup(l, { expose: e }) {
    const t = l, { config: i, context: a } = t, { elem: o } = pe(t), r = R(o.value || {}), { showFooter: s, ...n } = i, A = R(n), p = Q(!1);
    let h;
    const g = (d, f) => {
      ...
      typeof d == "string" ? A.value[d] = f : A.value = ie({}, n, d);
    }, y = () => {
...
class kt {
  ...
  initCell(e) {
    ...
    t.isEdge() && (o.source = Q(((s = t == null ? void 0 : t.source) == null ? void 0 : s.cell) || ""), o.target = Q(((n = t == null ? void 0 : t.target) == null ? void 0 : n.cell) || ""), o.labelConfig = R({})), t.isNode() && (o.inCells = Q(/* @__PURE__ */ new Set()), o.outCells = Q(/* @__PURE__ */ new Set())), this.cells.set(t.id, o);
  }
  //
  updateEdge(e) {
  ...
  removeCells(e = []) {
    ...
    for (const o of e) {
      if (o.isEdge()) {
        const r = o.id, s = this.get(o), n = s.source.value, A = s.target.value;
        n && ((i = this.cells.get(n)) == null ? void 0 : i.outCells.value).delete(r), A && ((a = this.cells.get(A)) == null ? void 0 : a.outCells.value).delete(r);
      }
      this.del(o);
    }
...
const Gt = {
...
}, Vt = /* @__PURE__ */ E("span", { style: { "--i": "1" } }, null, -1), Ot = /* @__PURE__ */ E("span", { style: { "--i": "2" } }, null, -1), Kt = /* @__PURE__ */ E("span", { style: { "--i": "3" } }, null, -1), Ut = /* @__PURE__ */ E("span", { style: { "--i": "4" } }, null, -1), Yt = /* @__PURE__ */ E("span", { style: { "--i": "5" } }, null, -1), Jt = /* @__PURE__ */ E("span", { style: { "--i": "6" } }, null, -1), Tt = /* @__PURE__ */ E("span", { style: { "--i": "7" } }, null, -1), Zt = /* @__PURE__ */ E("span", { style: { "--i": "8" } }, null, -1), jt = /* @__PURE__ */ E("span", { style: { "--i": "9" } }, null, -1), qt = /* @__PURE__ */ E("span", { style: { "--i": "10" } }, null, -1), zt = [
  Vt,
  Ot,
  Kt,
  Ut,
  ...
  setup(l) {
    var se, ne;
    const e = l, { edge: t, context: i } = e, { graphShadow: a, graph: o, graphForm: r } = i, s = M(() => {
      const k = e.config, G = a.getEdgeLabelConfig(t).value || {};
      return { enabled: !0, icon: 0, icons: [k1], prop: "edge", params: {}, title: "", ...k, ...G };
    }), { icon: n, prop: A, params: p } = c(s), h = r.getCellFormData(t), g = a.getEdgeData(t), w = g.source, m = g.target, y = g.step, u = g.label, d = (se = o.value) == null ? void 0 : se.getCellById(c(w)), f = (ne = o.value) == null ? void 0 : ne.getCellById(c(m)), B = Q(c(n)), D = M(() => {
    ...
    return re(() => {
    }), (k, G) => s.value.enabled ? (F(), b("div", Gt, [
      N(c(Ye), {
        placement: "top",
        width: "auto",
        teleported: !1,
  ...
  setup(l, { expose: e }) {
    const i = o1(l, "value"), a = Q(i.value || ""), o = (h) => {
    ...
    return te(i, (h = "") => {
      ...
      default: V(() => [
        N(c(z1), { value: a.value }, null, 8, ["value"])
      ]),
      _: 1
    }, 8, ["modelValue"]));
  }
...
class ti {
  ...
  //
  initMenus() {
    const e = this.config.node || [], t = this.config.edge || [], i = this.config.blank || [], o = this.config.useDefaultMenu ?? !0 ? { node: [...ct], edge: [...lt], blank: [...dt] } : { node: [], edge: [], blank: [] };
  ...
  createContextmenu(e, t) {
    ...
    let o = this.menus[i] || [];
    if (i === "node") {
      const s = (t == null ? void 0 : t.getData()) || {}, n = s == null ? void 0 : s.contextmenu;
      n && Array.isArray(n) && n.length > 0 && (o = [...n, { tag: P }, ...o]);
    }
...
const ii = /* @__PURE__ */ W({
  ...
  setup(l, { expose: e }) {
    ...
    return e({
      ...
      (F(), S(c(_), {
        ...
        context: { params: { ElMessage: c(T), ElNotification: c(N1) } }
      }, null, 8, ["elem", "params", "context"]))
    ], 4)), [
      [Ke, c(i).visible.value]
    ]);
  }
}), oi = { class: "_box-main" }, ai = { class: "_main-content" }, ri = {
  name: "ElsX6"
}, si = /* @__PURE__ */ W({
  ...ri,
  props: {
  ...
  setup(l, { expose: e }) {
    const t = l, { viewModel: i, nodeListConfig: a } = pe(t), { graphConfig: o, menuConfig: r, pluginsConfig: s, contextmenuConfig: n, edgeLabelConfig: A, defaultNodeMarkup: p, register: h, events: g } = t, w = G1(), m = R(), y = Q(), u = Q(), d = Q(), f = Q(), B = Q(), D = Q(), H = Q(), x = Q(), L = new kt().resetDefaultNodeMarkup(p), O = new Et(L), j = new yt({ graphShadow: L, graphForm: O, contextmenuRef: D, events: g, containerBox: d }), se = new xt(s), ne = new Nt({ elsX6Ref: y }), k = {
      graph: m,
      graphShadow: L,
      graphForm: O,
      graphEvents: j,
    ...
    return le("GRAPH-SHADOW", L), le("GRAPH", m), le("GRAPH-FORM", O), le("GRAPH-MARKDOWN", f), le("GRAPH-CONTEXT", k), pt(), At(), h && h(Be), re(() => {
      const G = ie(it, o);
      m.value = $(new Be({
        ...G,
        // 自定义 边的弹出展示
        ...
        container: u.value
      })), se.usePlugins(m.value), L.setGraph(m.value), O.setGraph(m.value), ne.init(m.value), j.resetGraph(m.value).registerEvent().onMounted(k);
    }), e({
      graph: m
    }), (G, we) => {
      var Ae, he;
      return F(), b("div", {
        ...
        N(mt),
        E("div", oi, [
          (Ae = c(a)) != null && Ae.enabled || !c(i) ? (F(), S(It, Fe({
            key: 0,
            graph: m.value
          }, c(a)), null, 16, ["graph"])) : J("", !0),
          E("div", ai, [
            ((he = c(r)) == null ? void 0 : he.enabled) !== !1 || !c(i) ? (F(), S(vt, {
              key: 0,
              ref_key: "menuRef",
              ref: x,
              class: "_menu",
...
}), ni = "/openmetadata-api", Xe = (l) => {
  const e = ni + "/openMetadata/query", t = new FormData();
  return t.append("suffix", l), new Promise((i, a) => {
  ...
  const l = "v1/services/messagingServices?fields=owner&limit=9999";
  try {
    return await Xe(l);
  } catch {
    return;
  ...
  const e = `v1/topics?service=${l}&fields=owner%2Ctags&include=non-deleted`;
  try {
    return await Xe(e);
  } catch {
    return;
  ...
  const e = Q({}), t = Q({}), i = Q([]), a = Q([]), o = Q([]), r = Q([]), s = "name", n = (l == null ? void 0 : l.kafkaOptionKey) || "connection.config.bootstrapServers", A = (l == null ? void 0 : l.topicOptionKey) || "name", p = (l == null ? void 0 : l.kafkaFormatKeys) || me[0], h = (l == null ? void 0 : l.topicFormatKeys) || me[1];
  li().then((d) => {
    i.value = d.data, o.value = d.data.map((f) => ({ label: f.name, value: v(f, n), tag: $(ye) }));
  }), te(e, (d) => {
  ...
  const g = (d, f) => {
    ...
    if (v(e.value, n) != f) {
      e.value = i.value.filter((H) => v(H, n) == f)[0] || {};
      const D = p;
...
}, { kafkaOptions: xe, topicOptions: ke, valueKey: Zi, currentKafka: ji, currentTopic: qi, resetFormData: zi, NIFI_FORMAT_KEYS: Wi, setKafkaServer: Ne, setKafkaTopic: Ge, initKafkaServer: Xi } = di(), pi = {
  "org.apache.nifi.processors.kafka.pubsub.ConsumeKafka_2_6": {
    "bootstrap.servers": { tag: $(U), filterable: !0, allowCreate: !0, defaultFirstOption: !0, cls: xe, ":modelValue": "formData['bootstrap.servers']", "@update:modelValue": ({ formData: l, $: e }) => Ne(l, e[0]) },
    topic: { tag: $(U), filterable: !0, allowCreate: !0, defaultFirstOption: !0, cls: ke, ":modelValue": "formData['topic']", "@update:modelValue": ({ formData: l, $: e }) => Ge(l, e[0]) }
  ...
  const i = l.relationships, a = t.that, o = t.modelValue;
  t.id;
  const r = l.outPorts, s = e.inPorts;
  return {
    tag: "div",
    cls: [
      {
        ...
        column: [
          ...
          //
          { tag: U, label: "从输出", prop: "source.id", "v-if": r.length > 0, cls: r.map((n) => ({ value: n.id, label: n.component.name })) },
          { tag: U, label: "输入", prop: "destination.id", "v-if": s.length > 0, cls: s.map((n) => ({ value: n.id, label: n.component.name })) },
          // 连线规则 关系
          { tag: Se, label: "输出数据流", value: i.length == 1 ? [i[0].name] : [], "v-if": i.length > 0, required: !0, prop: "selectedRelationships", cls: i.map((n) => ({ tag: fe, label: n.name, title: n.description })) },
          // 优先级
          { tag: Se, label: "优先级设置器", prop: "prioritizers", cls: a.prioritizers.map((n) => ({ tag: fe, label: n.type, cls: n.type.split(".").reverse()[0] })) },
          //
          { tag: z, label: "FlowFile 过期时间", prop: "flowFileExpiration", value: "0 sec" },
          //
          ...
          { tag: z, label: "属性名称", prop: "loadBalancePartitionAttribute", value: "", "v-if": ({ formData: n }) => n.value.loadBalanceStrategy == "PARTITION_BY_ATTRIBUTE" },
          {
            tag: U,
            label: "负载均衡压缩",
            prop: "loadBalanceCompression",
            "v-if": ({ formData: n }) => n.value.loadBalanceStrategy != "DO_NOT_LOAD_BALANCE",
  ...
  const e = l.groupBreadcrumb, t = e.length - 1, i = e.map((a, o) => ({ tag: I, link: !0, key: "elem", type: o == t ? "primary" : "success", cls: a.name, "@click": () => {
    l.initGraph(a.id);
  ...
  useDefaultMenu: !1,
  node: [
    { tag: I, link: !0, icon: q, cls: "开始", "v-if": ({ status: t }) => c(t).runStatus == "Stopped", "@click": ({ cell: t, contextmenu: i }) => l.nodeRun(t, i) },
    { tag: I, link: !0, icon: q, cls: "停止", "v-if": ({ status: t }) => c(t).runStatus == "Running", "@click": ({ cell: t, contextmenu: i }) => l.nodeStop(t, i) },
    { tag: I, link: !0, icon: q, cls: "校验", "v-if": ({ cell: t, status: i }) => l.nodeType(t) == "PROCESS" && c(i).runStatus != "Running", "@click": ({ cell: t, contextmenu: i }) => l.nodeCheck(t, i) },
    //
    { tag: P, "v-if": ({ status: t }) => c(t).runStatus != "Invalid" },
    //
    { tag: I, link: !0, icon: q, cls: "查看", "v-if": ({ status: t }) => c(t).runStatus == "Running", "@click": ({ cell: t, contextmenu: i }) => l.nodeEdit(t, i) },
    { tag: I, link: !0, icon: q, cls: "编辑", "v-if": ({ cell: t, status: i }) => l.nodeType(t) != "FUNNELS" && c(i).runStatus != "Running", "@click": ({ cell: t, contextmenu: i }) => l.nodeEdit(t, i) },
    { tag: P, "v-if": ({ cell: t }) => l.nodeType(t).includes("PROCESS") },
    { tag: I, link: !0, icon: q, cls: "查看历史", "v-if": ({ cell: t }) => ["PROCESS", "PROCESS-GROUP"].includes(l.nodeType(t)), "@click": ({ cell: t, contextmenu: i }) => l.initCellHistory(t, i) },
    ...
    { tag: P },
    {
      ...
      "@click": ({ cell: t, contextmenu: i, graph: a, graphShadow: o }) => {
        ...
        l.nodeDisable(t, i, s.value == "disabled");
      }
    },
    { tag: P },
    { tag: I, link: !0, icon: oe, cls: "删除", "@click": ({ cell: t, contextmenu: i }) => l.nodeDel(t, i) },
    { tag: I, link: !0, icon: oe, cls: "批量删除", "v-if": ({ selectedCells: t }) => t.value.length > 1, "@click": ({ selectedCells: t, contextmenu: i }) => l.nodesDel(t.value, i) }
  ],
  edge: [
    { tag: I, link: !0, icon: q, cls: "列出队列", "@click": ({ cell: t, contextmenu: i }) => l.initCellHistory(t, i) },
    { tag: I, link: !0, icon: q, cls: "清空队列", "@click": ({ cell: t, contextmenu: i }) => l.initCellHistory(t, i) },
    { tag: P },
    { tag: I, link: !0, icon: q, cls: "查看历史", "@click": ({ cell: t, contextmenu: i }) => l.initCellHistory(t, i) },
    { tag: P },
    { tag: I, link: !0, icon: q, cls: "编辑", "@click": ({ cell: t, contextmenu: i }) => l.edgeEdit(t, i) },
    { tag: P },
    { tag: I, link: !0, icon: oe, cls: "删除", "@click": ({ cell: t, contextmenu: i }) => l.edgeDel(t, i) }
  ],
  blank: [
  ...
  if (!t)
    return;
  const i = (h = e.graphShadow) == null ? void 0 : h.get(l), a = (g = e.graphShadow) == null ? void 0 : g.get(i.source.value), o = (w = e.graphShadow) == null ? void 0 : w.get(i.target.value), r = e.nodeType(a), s = e.nodeType(o), n = t.component, A = n.source, p = n.destination;
  return {
    tag: "div",
    class: "_edge-label-box",
    cls: [
  ...
  var w, m;
  const t = l.data, i = t.component.type, a = e.nodeType(l), o = ((m = (w = t.component) == null ? void 0 : w.config) == null ? void 0 : m.descriptors) || {}, r = pi[i], s = a == "PROCESS" && o ? Object.keys(o).map((y) => {
  ...
  }).filter((y) => y != null) : [], n = a == "PROCESS" ? t.component.relationships.map((y, u) => ({
    tag: "p",
    ...
    cls: [
      { tag: O1, prop: "config.retryCount", label: "重试尝试次数", tip: "For relationships set to retry, this number indicates how many times a FlowFile will attempt to reprocess before it is routed elsewhere." },
      {
        tag: K1,
      ...
      column: [
        {
          ...
          cls: [
            { tag: "legend", cls: "基础" },
            { prop: "state", label: "是否启用", tag: P1, activeValue: "STOPPED", inactiveValue: "DISABLED" },
    ...
    { label: "控制器配置", type: "elem", elem: { tag: W1, application: "Group", node: t, controllerType: [] } }
  ], g = {
    label: "基础信息",
    type: "form",
    validate: !0,
...
}, fi = { class: "nifi-history" }, ui = { class: "_left" }, wi = { class: "_info" }, mi = /* @__PURE__ */ E("i", null, "ID", -1), Bi = /* @__PURE__ */ E("i", null, "GroupId", -1), yi = { key: 0 }, Ei = /* @__PURE__ */ E("i", null, "Source Name", -1), Fi = { key: 1 }, Qi = /* @__PURE__ */ E("i", null, "Destination Name", -1), Di = /* @__PURE__ */ E("i", null, "开始时间", -1), Ii = /* @__PURE__ */ E("i", null, "结束时间", -1), Mi = /* @__PURE__ */ E("p", null, [
  /* @__PURE__ */ E("i", null, "最小值"),
  /* @__PURE__ */ ge("/"),
  /* @__PURE__ */ E("i", null, "最大值"),
  /* @__PURE__ */ ge("/"),
  /* @__PURE__ */ E("i", null, "平均值")
], -1), Hi = { class: "_right" }, bi = { class: "_header" }, vi = { class: "_chart-box" }, Si = /* @__PURE__ */ W({
  __name: "history",
  props: {
    data: {}
  },
  setup(l) {
    var w, m, y, u;
    const e = l, { data: t } = pe(e), i = Q(), a = Q(), o = {
      tooltip: {
        trigger: "axis",
        position: function(d) {
          return [d[0], "10%"];
    ...
    }), n = Q(((u = (y = (m = (w = c(t)) == null ? void 0 : w.statusHistory) == null ? void 0 : m.fieldDescriptors) == null ? void 0 : y[0]) == null ? void 0 : u.field) || ""), A = M(() => {
      var d, f;
      return ((f = (d = c(t)) == null ? void 0 : d.statusHistory) == null ? void 0 : f.aggregateSnapshots) || [];
    }), p = M(() => c(A).map((d) => [d.timestamp, v(d.statusMetrics, c(n))])), h = M(() => c(p).map((d) => d[1])), g = M(() => ({ title: { text: c(n) }, series: [{ name: c(n), data: c(p) || [] }] }));
    return te(g, (d) => {
      var f;
      (f = a.value) == null || f.setOption(d);
    }), re(() => {
      a.value = $(U1(i.value)), console.log("ops === ", ie({}, o, c(g))), a.value.setOption(ie({}, o, c(g))), setTimeout(() => {
        a.value.resize();
      }, 50);
    }), (d, f) => (F(), b("div", fi, [
      E("div", ui, [
        E("div", wi, [
          ...
          c(ee)(r.value, "Source Name") ? (F(), b("p", yi, [
            Ei,
            E("b", null, K(r.value["Source Name"]), 1)
          ])) : J("", !0),
          c(ee)(r.value, "Destination Name") ? (F(), b("p", Fi, [
            Qi,
        ...
        E("div", null, [
          Mi,
          E("p", null, K(c(Y1)(h.value)) + " " + K(n.value.includes("Bytes") ? "bytes" : "") + " / " + K(c(J1)(h.value)) + " " + K(n.value.includes("Bytes") ? "bytes" : "") + " / " + K(c(T1)(h.value)) + " " + K(n.value.includes("Bytes") ? "bytes" : ""), 1)
        ])
      ]),
      E("div", Hi, [
        E("div", bi, [
          N(c(U), {
            ...
            default: V(() => [
              (F(!0), b(Z, null, ae(s.value, (B) => (F(), S(c(ye), {
                label: B.label,
                value: B.value,
                title: B.title,
                key: B.value
...
class xi {
  constructor() {
    ...
    this.apiGetClientId(), this.initProcessType(), this.initPrioritizers(), this.initRoot(), this.apiGetRootStatus(), this.NIFI_DATA = JSON.parse(Li), this.initGraph(), this.contextmenu = Ci(this), re(() => {
    }), r1(() => {
  ...
  async procesorUpdate(e) {
    ...
    await X1(e.id, a) && (this.apiUpdateEdge(e), this.initGraph());
  }
  // 构建节点列表
  buildNodesFromTypes() {
    this.processTypes.map((e) => {
      const { bundle: t, tags: i, type: a, description: o, restricted: r } = e, s = a.split(".").reverse()[0], n = t.group;
      return { name: s, group: n, label: s, tags: i, type: a, description: o, restricted: r };
    });
  }
  //
  ...
  async initGraph(e = "root") {
    ...
    try {
      await this.initFlow(e), await this.initGraphFlowData(), this.graph ? this.graph.fromJSON(this.graphData) : this.initFinishFlag = !0;
    } catch (i) {
      console.warn(i);
    }
    return this;
  ...
  async initFlow(e) {
    ...
    this.groupBreadcrumb = a.reverse(), this.menuElems.value = hi(this);
  }
  // 初始化算子元素，节点和边
  async initGraphFlowData() {
    const { connections: e = [], processors: t = [], processGroups: i = [], inputPorts: a, outputPorts: o } = this.groupFlowData;
    for (const s of i) {
      const n = await this.apiGetControllServices(s.id), A = [], p = s.inputPortCount || 0, h = s.outputPortCount || 0;
    ...
    for (const s of t) {
      const n = this.NIFI_DATA.cellData, A = this.nodeList.value.filter((w) => w.name == s.component.type)[0].groupName, p = n[A] || {}, h = await this.apiGetNode(s.id), g = {
        ...p,
        id: s.id,
        position: s.position,
        shape: "vue-node",
    ...
    const r = [...t, ...i];
    for (const s of e) {
      const n = s.sourceGroupId != this.groupId ? s.sourceGroupId : s.sourceId, A = s.destinationGroupId != this.groupId ? s.destinationGroupId : s.destinationId, p = s.component.source, h = s.component.destination, g = p.type == "PROCESSOR" ? p.name : `${r.filter((u) => u.id == n)[0].component.name} ( ${p.name} )`, w = h.type == "PROCESSOR" ? h.name : `${r.filter((u) => u.id == A)[0].component.name} (${h.name})`, m = `[${g}] -> [${w}]`, y = {
        id: s.id,
        shape: "vue-edge",
        source: { cell: n, port: "out" },
  ...
  async initCellHistory(e, t) {
    ...
    try {
      ...
      console.log(o), ((a = (i = o == null ? void 0 : o.statusHistory) == null ? void 0 : i.aggregateSnapshots) == null ? void 0 : a.length) == 0 ? T.info("历史记录不足，请稍后再试") : Z1({ title: "状态历史", message: Ue(Si, { data: o }) });
    } catch (o) {
  ...
  async nodeSave(e, t) {
    ...
    a.component = i, await this.nodeUpdate(a, e), t();
  }
  async nodeDel(e, t) {
    var a;
  ...
  async nodeUpdate(e, t) {
    ...
    let a;
    i == "PROCESS" && (a = await this.apiUpdateNode(e)), i == "PROCESS-GROUP" && (a = await this.apiUpdateGroup(e)), a && (a.status.runStatus == "Invalid" ? this.nodeCheck(t) : this.cellUpdate([a]));
  }
  // node 启用/禁用
  async nodeDisable(e, t, i) {
    var a;
    try {
      await this.apiDisOrEnableNode(e, t, i), t.close();
      const o = (a = this.graphShadow) == null ? void 0 : a.get(e, "step");
      o.value = i ? "undisabled" : "disabled";
    } catch {
    }
  }
  async nodeCheck(e, t) {
    ...
    if (!(a.length < 1))
      try {
        ...
        const n = await a[3].call(this, e.id);
        this.cellUpdate([n]);
      } catch (r) {
        console.warn(r);
      }
  ...
  getEdgeData(e) {
    var m, y, u, d, f, B, D;
    const t = e.data, i = (m = this.graphShadow) == null ? void 0 : m.get(e), a = c(i.source), o = c(i.target), r = (y = this.graph) == null ? void 0 : y.getCellById(a), s = (u = this.graph) == null ? void 0 : u.getCellById(o), n = ((f = (d = r == null ? void 0 : r.data) == null ? void 0 : d.component) == null ? void 0 : f.relationships) || [], A = t.component.name || (t.component.selectedRelationships || []).join(",");
    let p = "", h = [], g = [], w = {};
    return t != null && t.id ? (p = e.prop("title"), w = e.data.component, h = ((B = this.graphShadow) == null ? void 0 : B.get(a, "outputPorts")) || [], g = ((D = this.graphShadow) == null ? void 0 : D.get(o, "inputPorts")) || []) : p = `[${r == null ? void 0 : r.prop("label")}] -> [${s == null ? void 0 : s.prop("label")}]`, { title: p, outPorts: h, inPorts: g, modelValue: w, label: A, relationships: n, sourceNode: r, targetNode: s, sourceId: a, targetId: o, id: t == null ? void 0 : t.id };
  }
  async getEdgeInfo(e) {
    ...
    if ((o == null ? void 0 : o.data.outputPortCount) > 0) {
      const j = await this.apiGetGroupData(i);
      s = j.processGroupFlow.flow.outputPorts, w.id = s[0].id, w.type = "OUTPUT_PORT", w.groupId = i, (H = this.graphShadow) == null || H.set(i, "processGroupFlow", j.processGroupFlow), (x = this.graphShadow) == null || x.set(i, "outputPorts", s);
    }
    if ((r == null ? void 0 : r.data.inputPortCount) > 0) {
      const j = await this.apiGetGroupData(a);
      n = j.processGroupFlow.flow.inputPorts, m.id = n[0].id, m.type = "INPUT_PORT", m.groupId = a, (L = this.graphShadow) == null || L.set(a, "processGroupFlow", j.processGroupFlow), (O = this.graphShadow) == null || O.set(a, "inputPorts", n);
    }
    return { title: p, inPorts: n, outPorts: s, source: w, destination: m, modelValue: { source: w, destination: m }, relationships: A, sourceNode: o, targetNode: r };
  }
  async edgeElem(e) {
    const { title: t, inPorts: i, outPorts: a, relationships: o, targetNode: r, modelValue: s } = await this.getEdgeInfo(e), n = Ai({ relationships: o, outPorts: a }, { cell: r, inPorts: i }, { that: this, modelValue: s });
  ...
  async edgeAdd(e) {
    ...
    (o = (a = this.graphDialogRef) == null ? void 0 : a.value) == null || o.open(t), (s = (r = this.graphDialogRef) == null ? void 0 : r.value) == null || s.setConfig({ title: i }), (n = this.graph) == null || n.removeCell(e);
  }
  async edgeEdit(e, t) {
    var s, n, A, p;
    const { elem: i, title: a, inPorts: o, outPorts: r } = await this.edgeElem(e);
    t.close(), (n = (s = this.graphDialogRef) == null ? void 0 : s.value) == null || n.open(i), (p = (A = this.graphDialogRef) == null ? void 0 : A.value) == null || p.setConfig({ title: a });
  }
  async edgeSubmit(e) {
    var t;
    if (this.currentEdgeJson.id)
      this.apiNewEdge(e).then((i) => {
        ...
        (r = this.graph) == null || r.addEdge(o), (n = (s = this.graphDialogRef) == null ? void 0 : s.value) == null || n.close(), this.currentEdgeJson = {}, setTimeout(() => {
          this.cellUpdate([i]);
        }, 10);
      });
    else {
    ...
    e.forEach((t) => {
      ...
      if (t.component.name || (t.component.selectedRelationships || []).join(","), a.prop("data", o), (s = this.graphShadow) == null || s.setStatus(a, o.status.aggregateSnapshot), o.status.runStatus)
        switch (o.status.runStatus) {
          case "Invalid":
            (n = this.graphShadow) == null || n.setStep(a, "invalid");
            break;
          case "Running":
  ...
  async groupRefresh() {
    this.refreshTimeHandle && clearInterval(this.refreshTimeHandle), this.refreshTimeHandle = setInterval(async () => {
      ...
      this.groupRefreshCount--;
      try {
        const e = await this.apiGetGroupData(this.groupId), { processGroupFlow: t } = e, { flow: i } = t, { processors: a, connections: o, processGroups: r, outputPorts: s, labels: n, inputPorts: A, funnels: p } = i;
  ...
  apiRunStatusNode(e, t) {
    const i = e.id, a = e.data, { clientId: o, version: r } = a.revision, s = { revision: { clientId: o, version: r }, state: t, disconnectedNodeAcknowledged: !1 }, n = `/nifi-api/processors/${i}/run-status`;
    return this.apiPut(n, s);
  }
  ...
  apiDisOrEnableNode(e, t, i = !1) {
    const { id: a } = e, o = {
      revision: this.getReversion(e),
      state: i ? "STOPPED" : "DISABLED",
      disconnectedNodeAcknowledged: !1
      // 暂时未获取，先暂定false
    }, r = `/nifi-api/processors/${a}/run-status`;
    return this.apiPut(r, o);
  }
