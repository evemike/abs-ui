...
import { aJ as pe, f as E, p as de, ay as ie, o as fe, aK as ce, y as N, g as d, ar as _, ap as me, aI as ve, am as ye, aq as T, aL as _e, j as Ve, P as be, a5 as H, an as we, aM as x } from "./vendor.DCDhdkpx.js";
import { C as q } from "./main.Bwix_asg.js";
import { E as ke } from "./main.kMixB6Ql.js";
const he = {
  flex: "",
  "items-center": "",
  "justify-between": "",
  ...
  flex: "",
  "items-center": ""
}, Ke = /* @__PURE__ */ r("span", { "min-w-120": "" }, "描述", -1), Ie = {
  flex: "",
  "items-center": ""
}, Je = /* @__PURE__ */ r("span", { "min-w-120": "" }, "是否可删除", -1), Fe = {
  flex: "",
  "justify-end": ""
}, Re = {
  key: 0,
  ...
  setup(G, { emit: M }) {
    const j = G, D = M, { keys: F, keyName: R, modelValue: m, format: B, size: y, isNew: Le, isAdd: Q } = j;
    se(j);
    ...
    (() => {
      ...
      if (F.length == 0)
        ...
        let s = m || {};
        Array.isArray(m) && (s = Object.fromEntries(m.map((v) => [v[a], v[o]]))), b.value = F.map((v) => ({ ...v, value: d(s, v.prop) ?? v.value }));
      }
      for (const s of b.value)
        _(u, s.prop, s.value);
    })();
    const S = I(!1), h = L(), K = {}, oe = (a) => {
