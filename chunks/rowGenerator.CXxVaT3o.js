...
import { B as v, y as z, z as o, g as b, aL as g, ax as L, q as y, aw as P } from "./vendor.4pP_Prrf.js";
const X = `{
  "formatters": {
    "localDateFormats": [
      "",
...
`, F = /* @__PURE__ */ w("div", { style: { "font-weight": "bold", display: "inline-block", "font-size": "15px" } }, "条件：", -1), G = { style: { display: "inline-block", "margin-bottom": "5px", "margin-right": "5%" } }, J = /* @__PURE__ */ k({
  ...
  setup(U) {
    ...
    return (d, _) => {
      const s = C("el-input"), D = C("el-form");
      return u(), I("div", null, [
        w("div", null, [
          F,
          w("div", G, [
...
}, tabs: [
  {
    ...
    column: [
      ...
      { prop: "never_ending", label: "从不停止生成行", tag: P, inlinePrompt: !0, activeValue: "Y", inactiveValue: "N", activeText: "Y", inactiveText: "N" },
