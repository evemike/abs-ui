...
import { defineComponent as W, useSlots as G, toRefs as X, ref as i, shallowRef as x, watch as T, onMounted as Y, openBlock as c, createElementBlock as b, createElementVNode as f, normalizeClass as Z, renderSlot as B, normalizeStyle as q, withDirectives as J, createVNode as K, unref as l, createCommentVNode as C, createBlock as Q, vShow as ee, markRaw as te } from "vue";
import { aT as oe, aU as ae, aV as le, aW as s, aX as v, aY as O, aP as se, f as R, P as re, aZ as ne } from "./vendor.jH9g53BU.js";
  ...
  setup(H, { expose: L, emit: D }) {
    ...
    return T(k, (e) => {
      ...
      f("div", {
        ...
        ref: y,
        class: Z(["_mask", { "is-visible": o.value }])
      }, [
        f("div", ce, [
