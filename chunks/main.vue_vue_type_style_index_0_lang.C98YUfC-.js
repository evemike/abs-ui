...
import { defineComponent as ae, toRefs as se, reactive as ne, unref as l, shallowRef as L, ref as K, watch as ue, openBlock as n, createElementBlock as z, normalizeClass as re, createElementVNode as r, createVNode as d, Fragment as C, renderList as I, toDisplayString as P, createBlock as c, withCtx as i, createCommentVNode as f, mergeProps as w, createTextVNode as k } from "vue";
import { aN as de, C as E, p as pe, aC as ie, L as ce, aO as fe, r as N, B as p, ay as _, j as me, aM as ve, k as ye, ax as T, aP as _e, F as Ve, a0 as be, ag as H, c as we, aQ as x } from "./vendor.Bh6KHC77.js";
import { C as G } from "./main.DF-kfnLt.js";
import { E as ke } from "./main.B9WXvT3v.js";
const he = {
  flex: "",
  "items-center": "",
  "justify-between": "",
  ...
  flex: "",
  "items-center": ""
}, De = /* @__PURE__ */ r("span", { "min-w-120": "" }, "属性名称", -1), Oe = {
  flex: "",
  "items-center": ""
  ...
  setup(M, { emit: Q }) {
    const j = M, B = Q, { keys: J, keyName: R, modelValue: m, format: D, size: y, isNew: Le, isAdd: q } = j;
    se(j);
          ...
          r("ul", xe, [
            (n(!0), z(C, null, I(b.value, (e, g) => (n(), z("li", {
              ...
              r("b", Ne, [
                e.tag != null ? (n(), c(l(ke), {
                  ...
                  e.type == "select" ? (n(), c(l(me), w({
                    ...
                    default: i(() => [
                      (n(!0), z(C, null, I(e.cls || [], (t) => (n(), c(l(ve), {
                        label: t.label,
                        value: t.value
              ...
              r("b", je, [
                ...
                e.btns ? (n(!0), z(C, { key: 2 }, I(e.btns, (t) => (n(), c(l(E), w(t.attr || {}, {
                  link: "",
                  title: t.title,
