import { D as c } from "./index.DXYJNOia.js";
import { p as b, c as t, h as l } from "./index.DEa1ourJ.js";
import { as as r, au as i } from "./vendor.jH9g53BU.js";
let u = [
  {
...
const S = () => ({ name: "org.apache.nifi.processors.standard.PutDatabaseRecord_2_0", excludeKeys: [
  ...
  var d;
  let e = (d = s.event.form) == null ? void 0 : d.data.value[a.id].config.properties;
  b(e, u);
  let { databaseType: p, tableName: o } = JSON.parse(
    e["web预留（自动填入）"]
  );
  p || t("请选择数据源"), o || t("请选择表"), e["db-type"] && l[e["db-type"]] !== p && t("数据库获取数据库类型应与数据源类型一致"), i(e, "put-db-record-table-name", o);
} });
export {
  S as default
};
