...
import { aO as de, C as E, p as pe, aD as ie, L as ce, aP as fe, r as N, B as p, az as _, j as me, aN as ve, k as ye, ay as T, aQ as _e, F as Ve, a0 as be, ag as H, c as we, aR as x } from "./vendor.oF5jPd5s.js";
import { C as G } from "./main.CwjSrSug.js";
import { E as ke } from "./main.DvwxyXtf.js";
const he = {
  flex: "",
  "items-center": "",
  "justify-between": "",
  ...
  setup(Q, { emit: q }) {
    const j = Q, D = q, { keys: J, keyName: R, modelValue: m, format: B, size: y, isNew: Le, isAdd: M } = j;
    se(j);
