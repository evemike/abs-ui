...
import { aM as de, B as E, p as pe, aB as ie, K as fe, aN as ce, q as N, A as p, ax as _, g as me, aL as ve, j as ye, aw as T, aO as _e, D as Ve, $ as be, af as H, b as we, aP as x } from "./vendor.4pP_Prrf.js";
import { C as q } from "./main.ClmZZr2j.js";
import { E as ke } from "./main.BrWO7REl.js";
const he = {
  flex: "",
  "items-center": "",
  "justify-between": "",
  ...
  setup(G, { emit: M }) {
    const j = G, B = M, { keys: J, keyName: $, modelValue: m, format: D, size: y, isNew: Le, isAdd: Q } = j;
    se(j);
    ...
    return ue(u, de((a) => {
      ...
      if (D && typeof D == "function")
        ...
        const { propKey: s, valueKey: v } = $, e = m.map((g) => g[s]);
        o = b.value.map((g) => {
