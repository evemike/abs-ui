...
import { defineComponent as D, toRefs as E, ref as V, onMounted as I, resolveComponent as J, openBlock as K, createElementBlock as w, createTextVNode as m, createVNode as p, unref as v, withCtx as n, createElementVNode as _, toDisplayString as N } from "vue";
import { g as B, f as O, a5 as F, b9 as M, ar as b, a as P } from "./vendor.CawUkpaF.js";
...
const U = { class: "nifi-column" }, z = {
  ...
  setup(i) {
    const y = i, { formdata: g, inputV: S, propInput: x, propOutput: k } = E(y), s = V(S.value), l = V(!1), c = () => {
      l.value = !0;
    }, u = {
      key: "name",
      label: "name"
