...
import { defineComponent as ae, toRefs as se, reactive as ne, unref as l, shallowRef as P, ref as I, watch as ue, openBlock as n, createElementBlock as E, normalizeClass as re, createElementVNode as r, createVNode as p, Fragment as C, renderList as J, toDisplayString as H, createBlock as f, withCtx as i, createCommentVNode as c, mergeProps as w, createTextVNode as k } from "vue";
import { aF as pe, f as z, p as de, aG as ie, o as fe, aH as ce, y as N, g as d, ar as _, ap as me, aE as ve, am as ye, aq as L, aI as _e, j as Ve, P as be, a5 as T, an as we, aJ as x } from "./vendor.vR4RX31U.js";
import { C as G } from "./main.DQzE2JzC.js";
import { E as ke } from "./main.yWXEAUcF.js";
const he = {
  flex: "",
  "items-center": "",
  "justify-between": "",
  ...
  setup(q, { emit: M }) {
    ...
    }, le = (a) => O ? (O = !1, A) : (A = JSON.stringify(d(l(u), a) || {}, null, 2), A);
    (() => {
      ...
      if (K.length == 0)
        ...
        let s = m || {};
        Array.isArray(m) && (s = Object.fromEntries(m.map((v) => [v[a], v[o]]))), b.value = K.map((v) => ({ ...v, value: d(s, v.prop) ?? v.value }));
      }
    ...
    const S = I(!1), h = P(), F = {}, oe = (a) => {
      ...
      ["json", "code"].includes(o) ? d(F, s).openDialog() : (h.value = a, S.value = !0);
    }, te = {
      formData: u,
      elsListFormProps: j
    };
          ...
          r("ul", xe, [
            (n(!0), E(C, null, J(b.value, (e, g) => (n(), E("li", {
              ...
              r("b", Ne, [
                e.tag != null ? (n(), f(l(ke), {
                  ...
                  e.type == "select" ? (n(), f(l(me), w({
                    ...
                    default: i(() => [
                      (n(!0), E(C, null, J(e.cls || [], (t) => (n(), f(l(ve), {
                        label: t.label,
                        value: t.value
              ...
              r("b", je, [
                ...
                e.btns ? (n(!0), E(C, { key: 2 }, J(e.btns, (t) => (n(), f(l(z), w(t.attr || {}, {
                  link: "",
                  title: t.title,
