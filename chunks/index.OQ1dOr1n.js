...
var e1 = (l, e, t) => e in l ? $e(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t;
var g = (l, e, t) => (e1(l, typeof e != "symbol" ? e + "" : e, t), t);
import "../css/index-Bhec2kAk.css";
import { defineComponent as q, inject as t1, shallowRef as R, computed as M, onMounted as te, openBlock as F, createElementBlock as v, normalizeClass as Ee, createBlock as L, unref as c, createCommentVNode as Y, createStaticVNode as i1, createElementVNode as E, watch as X, mergeProps as Fe, withCtx as P, Fragment as Z, renderList as ee, ref as Q, toRefs as ce, createVNode as k, toDisplayString as V, withModifiers as He, createTextVNode as ge, normalizeStyle as Oe, resolveDynamicComponent as o1, withDirectives as Ke, vShow as Ue, toRef as a1, provide as ae, markRaw as W, render as r1, h as Ye, onUnmounted as s1 } from "vue";
import { g as b, M as n1, o as j, q as be, k as le, t as Je, x as l1, d as H, y as _, G as Be, z as c1, f as $, A as Qe, B as Te, C as Ze, D as O, F as De, H as je, I as d1, J as p1, K as U, L as A1, N as ne, O as h1, s as C1, P as g1, Q as f1, R as u1, S as ve, T as w1, i as m1, h as B1, U as y1, V as E1, W as F1, X as Q1, Y as D1, Z as I1, _ as M1, $ as H1, a0 as b1, a1 as v1, a2 as T, a3 as L1, a4 as S1, a5 as x1, a6 as ye, a7 as K, a8 as k1, a9 as Le, n as fe, aa as N1, ab as re, e as he, ac as G1, ad as R1, ae as P1, af as Se, ag as V1, ah as O1, ai as K1, aj as U1, ak as Y1 } from "./vendor.3wbU5Pec.js";
import { E as z } from "./main.BeuaEiRW.js";
import { _ as ue } from "./main.vue_vue_type_script_setup_true_lang.JAwHWiRX.js";
import { _ as J1 } from "./_plugin-vue_export-helper.CHgC5LLL.js";
import { _ as se, E as T1 } from "./main.vue_vue_type_script_setup_true_lang.CokmhVkK.js";
import { _ as Z1 } from "./view.vue_vue_type_style_index_0_lang.CiSdV8c3.js";
import { _ as j1, a as q1 } from "./main.vue_vue_type_script_setup_true_lang.CY_zDk0A.js";
import { _ as z1 } from "./main.vue_vue_type_style_index_0_lang.Bu-s41wu.js";
const W1 = /* @__PURE__ */ q({
  __name: "node",
  props: {
    node: {},
  ...
  setup(l) {
    const e = l, { node: t } = e, i = t1("GRAPH-CONTEXT"), { graphForm: a, graphShadow: o } = i, r = R(), s = M(() => {
      const f = ((o == null ? void 0 : o.selectedCells.value) || []).map((B) => B.id);
      return !!(f.length > 0 && f.includes((t == null ? void 0 : t.id) || ""));
    }), n = M(() => {
      var B;
      const A = t == null ? void 0 : t.id, f = (B = o == null ? void 0 : o.currentCell.value) == null ? void 0 : B.id;
      return !!(A && f && A == f);
    }), d = M(() => {
      const A = o == null ? void 0 : o.get(t);
      return b(A, "metadata.status.aggregateSnapshot.runStatus") || "";
    }), p = R({});
    return te(() => {
      var A;
      p.value = { ...o == null ? void 0 : o.get(t), formStatus: a == null ? void 0 : a.getCellStatus(t) }, p.value.node = t, r.value = ((A = p.value.metadata) == null ? void 0 : A.markup) || (o == null ? void 0 : o.defaultNodeMarkup);
    }), (A, f) => (F(), v("div", {
      class: Ee(["default_node_style", d.value, { "is-selected": s.value, "is-current": n.value }])
    }, [
      r.value ? (F(), L(c(z), {
        key: 0,
        elem: r.value,
        params: p.value
      }, null, 8, ["elem", "params"])) : Y("", !0)
    ], 2));
  }
}), X1 = [
  {
...
Note: This Processor expects CEF messages WITHOUT the syslog headers (i.e. starting at "CEF:0"`,
  ...
  connecting: {
    ...
    validateConnection({
      ...
      var p, A;
      const o = (p = t == null ? void 0 : t.getAttribute("port")) == null ? void 0 : p.split("."), r = (A = i == null ? void 0 : i.getAttribute("port")) == null ? void 0 : A.split(".");
      if (!o || !r || o[0] == "in" || r[0] == "out" || (o[1] || r[1]) && o[1] != r[1])
        return !1;
      const s = this.getEdges().filter((f) => f != a), n = s.filter((f) => f.getSourceCell() == l).length, d = s.filter((f) => f.getTargetCell() == e).length;
      return !(o[2] && be(o[2]) && n >= Number(o[2]) || r[2] && be(r[2]) && d >= Number(r[2]));
    }
  },
  highlighting: {
  ...
  // 
  defaultLabel: {
    markup: n1.getForeignObjectMarkup(),
    attrs: {
      fo: {
        width: 30,
        height: 30,
      ...
      cls: [
        {
          ...
          cls: [
            { tag: le, "#reference": "", class: "_node-tip-icon", cls: { tag: l1 } },
  ...
  cls: [
    { tag: "div", cls: [
      { tag: "b", class: "_title", cls: [{ tag: le, cls: { tag: ue, ":name": "data.icon" } }, "{{ data.label || '' }}"] }
      // { tag: "b", "@click": "() => close()", class: "_btn", cls: { tag: ElIcon, class: "_close", cls: Close } }
    ] },
    { tag: "div", class: "", cls: [
      { tag: H, "@click": ({ graphEvents: l, close: e, cell: t }) => {
...
_1.newProcessorTypes.filter((l) => l.type.includes("ConsumeAMQP") || l.type.includes("ConsumeIMAP") || l.type.includes("ConsumeJMS")).map((l) => {
    ...
    tabs: [
      {
        label: "基础信息",
        type: "elem",
        elem: { tag: j, prop: "node.label", ":modelValue": "label", "@update:modelValue": ({ label: t, $: i }) => {
          t.value = i[0];
        } }
      },
      {
...
function Ct(l, e) {
  return F(), v("svg", dt, ht);
}
const gt = /* @__PURE__ */ J1(ct, [["render", Ct]]), ft = /* @__PURE__ */ q({
  __name: "drawer",
  props: {
    context: {},
    config: { default: () => ({
  ...
  setup(l) {
    ...
    X(r, (w) => {
      w == null && o.closeDrawer();
    });
    const s = M(() => {
      var w;
      return ((w = r.value) == null ? void 0 : w.id) || "";
    }), n = M(() => (
      /* currentNode.value ? graphShadow.getByKey(currentNode.value,'tabHeader') : */
      ot
    )), d = M(() => r.value ? a.getTabs(r.value).value : []), p = M(() => d.value.map((w, u) => w.default ? "default-tab" : u + "")), A = M(() => ({ ...i, cell: r.value, data: r.value ? a.get(r.value) : {}, formStatus: r.value ? o.getCellStatus(r.value) : {} })), f = R(), B = A1((w, u) => {
      u && (f.value = u), o.validateForm(u || f.value, w);
    }, 100);
    return (w, u) => (F(), L(c(je), Fe({
      "modal-class": "_graph-drawer",
      "text-14": ""
    }, c(t), {
      modelValue: c(o).visible.value,
      "onUpdate:modelValue": u[5] || (u[5] = (C) => c(o).visible.value = C)
    }), {
      header: P(({ close: C, titleId: h, titleClass: m }) => [
        s.value ? (F(), L(c(z), {
          key: s.value,
          elem: n.value,
          params: A.value,
          context: { params: { close: C, titleId: h, titleClass: m } }
        }, null, 8, ["elem", "params", "context"])) : Y("", !0)
      ]),
      default: P(() => [
        d.value.length > 0 ? (F(), v(Z, { key: 0 }, [
          d.value.length > 1 ? (F(), L(c(d1), {
            "model-value": "default-tab",
            key: s.value
          }, {
            default: P(() => [
              (F(!0), v(Z, null, ee(d.value, (C, h) => (F(), L(c(p1), {
                key: h + "-" + s.value,
                name: p.value[h],
                label: C.label
              }, {
                default: P(() => [
                  C.prop != null ? (F(), L(c(se), {
                    key: 0,
                    ref_for: !0,
                    ref: (m) => f.value = m,
                    onChange: () => c(B)(C),
                    "model-value": c(b)(c(o).data.value[s.value], C.prop),
                    "onUpdate:modelValue": (m) => {
                      const y = {};
                      c(U)(y, C.prop, m), c(o).resetCellFormData(s.value, y);
                    },
                    params: A.value,
                    column: C.column
                  }, null, 8, ["onChange", "model-value", "onUpdate:modelValue", "params", "column"])) : C.type === "form" ? (F(), L(c(se), {
                    key: 1,
                    ref_for: !0,
                    ref: (m) => f.value = m,
                    onChange: () => c(B)(C),
                    "model-value": c(o).data.value[s.value],
                    "onUpdate:modelValue": u[0] || (u[0] = (m) => c(o).resetCellFormData(s.value, m)),
                    params: A.value,
                    column: C.column
                  }, null, 8, ["onChange", "model-value", "params", "column"])) : (F(), L(c(z), {
                    key: 2,
                    elem: C.elem,
                    params: A.value,
            ...
            d.value[0].prop != null ? (F(), L(c(se), {
              key: 0,
              ref: (C) => f.value = C,
              onChange: u[1] || (u[1] = () => c(B)(d.value[0])),
              "model-value": c(b)(c(o).data.value[s.value], d.value[0].prop),
              "onUpdate:modelValue": u[2] || (u[2] = (C) => {
                const h = {};
                c(U)(h, d.value[0].prop, C), c(o).resetCellFormData(s.value, h);
              }),
              params: A.value,
              column: d.value[0].column
            }, null, 8, ["model-value", "params", "column"])) : d.value[0].type === "form" ? (F(), L(c(se), {
              key: 1,
              ref: (C) => f.value = C,
              onChange: u[3] || (u[3] = () => c(B)(d.value[0])),
              "model-value": c(o).data.value[s.value],
              "onUpdate:modelValue": u[4] || (u[4] = (C) => c(o).resetCellFormData(s.value, C)),
              params: A.value,
              column: d.value[0].column
            }, null, 8, ["model-value", "params", "column"])) : (F(), L(c(z), {
              key: 2,
              elem: d.value[0].elem,
              params: A.value,
...
class ut {
  ...
  constructor(e) {
    ...
    g(this, "selectedCells", R([]));
    g(this, "clipboardCells", R([]));
    g(this, "clickHandle");
  ...
  cell() {
    var e, t, i, a, o, r, s, n;
    (e = this.graph) == null || e.on("cell:added", (d) => {
      const { cell: p } = d;
      console.log(".............", p.id), this.graphShadow.initCell(p), this.graphForm.initCell(p).validateCell(p), this.eventCall("cell:added", d), this.eventCall("init:cell", p), p.isEdge() && this.eventCall("init:edge", p), p.isNode() && this.eventCall("init:node", p);
    }), (t = this.graph) == null || t.on("cell:click", (d) => {
      var p;
      (p = this.contextmenuRef.value) == null || p.close(), this.currentKeydown.has("Control") || this.graphShadow.clearSelectedCells(), this.eventCall("cell:click", d);
      ...
      const { cell: p } = d;
      this.currentKeydown.has("Control") ? (this.graphShadow.toggleSelectedCell(p), this.eventCall("cell:selected", d)) : this.graphShadow.clearSelectedCells();
    }), (r = this.graph) == null || r.on("cell:unselected", (d) => {
      const { cell: p } = d;
      this.graphShadow.delSelectedCell(p), this.eventCall("cell:unselected", d);
    }), (s = this.graph) == null || s.on("cell:contextmenu", (d) => {
      var w, u;
      const { cell: p, x: A, y: f } = d, B = (w = this.graph) == null ? void 0 : w.localToGraph({ x: A, y: f });
      (u = this.contextmenuRef.value) == null || u.open(B, p), this.eventCall("cell:contextmenu", d);
    }), (n = this.graph) == null || n.on("cell:selectAll", () => {
      var p, A;
      const d = (p = this.graph) == null ? void 0 : p.getCells();
      d && d.length > 0 && ((A = this.graph) == null || A.select(d), this.graphShadow.resetSelectedCells(d), this.eventCall("cell:selectAll", d));
    });
  }
  // 边连接事件
  edge() {
    ...
    (e = this.graph) == null || e.on("node:click", (n) => {
      ...
      this.clickHandle = setTimeout(() => {
        if (console.log("++++++++++++++++++", (/* @__PURE__ */ new Date()).getTime()), this.currentKeydown.has("Control"))
          return;
        const { node: d } = n;
        this.graphShadow.resetCurrentCell(d), this.graphForm.openDrawer(), this.eventCall("node:click", n), this.clickHandle = void 0;
      }, 500);
    }), (t = this.graph) == null || t.on("node:removed", (n) => {
      const { node: d } = n;
      this.graphShadow.removeCells([d]), this.eventCall("node:removed", n);
...
class wt {
  constructor(e) {
    ...
    g(this, "visible", Q(!1));
    this.graphShadow = e, this.currentNode = e.currentCell, X(this.currentNode, (t, i) => {
  ...
  initCell(e) {
    const t = e.id;
    if (this.status.set(t, Q({ result: !0, info: [] })), ne(this.data.value, t) || (this.data.value[t] = {}), !this.cellColumn.has(t)) {
  ...
  validateForm(e, t) {
    this.currentNode.value && e && t && t.validate == !0 && e.validate((i, a) => {
      ...
      (n = this.currentNode.value) != null && n.id && this.graphFormFailCells.add((d = this.currentNode.value) == null ? void 0 : d.id);
      const r = Object.keys(a).map((p) => a[p].map((A) => A.message)).flat(1);
      console.log(":::::validate:::::", i, a, r, o), o.value = { result: i, info: r };
    });
  }
  async validateCell(e) {
    const t = e.id, i = this.data.value[t] || {}, a = this.cellColumn.get(t) || [], { status: o, info: r } = await T1.valideForm(i, a), s = this.getCellStatus(e);
    if (!s)
      return;
    if (o) {
    ...
    const n = Object.keys(r).map((d) => r[d].map((p) => p.message)).flat(1);
...
const mt = { class: "_search" }, Bt = ["onMousedown", "title"], yt = { class: "_label" }, Et = /* @__PURE__ */ q({
  __name: "nodeList",
  props: {
  ...
  setup(l) {
    const e = l, t = Q(), { graph: i, nodeList: a } = ce(e), { initNodeFn: o } = e, r = Q(""), s = Q(), n = Q([]), d = h1(r, 500), p = M(() => {
      const B = d.value;
      let w = a.value || [];
      B ? (w = w.filter(({ label: h, name: m, group: y }) => h.includes(B) || m.includes(B) || (y == null ? void 0 : y.includes(B))), n.value.push(...w.map((h) => h.group || ""))) : n.value = [];
      const u = [], C = [];
      for (const h of w) {
        const { group: m = "默认分组" } = h, y = u.indexOf(m);
        y > -1 ? C[y][1].push(h) : (u.push(m), C.push([m, [h]]));
      }
      return console.log("====>", w, C), C;
    }), A = () => {
      i.value && (s.value = new u1({
        target: i.value,
        dndContainer: t.value,
        getDragNode: (B) => B.clone({ keepId: !0 }),
        getDropNode: (B) => B.clone({ keepId: !0 })
      }));
    }, f = (B, w) => {
      var m;
      const u = i.value;
      if (!u)
        return;
      s.value || A(), B.shape || (B.shape = "vue-node"), B.ports || (B.ports = {});
      const C = B.ports;
      if (C.groups || (C.groups = qe.groups), o) {
        try {
          o(B).then((y) => {
            var D;
            return (D = s.value) == null ? void 0 : D.start(u.createNode(y), w);
          });
        } catch (y) {
          console.warn(y);
        }
      ...
      (m = s.value) == null || m.start(u.createNode(h), w);
    };
    return te(() => {
      A();
    }), (B, w) => (F(), v("div", {
      ...
      k(c(g1), {
        modelValue: n.value,
        "onUpdate:modelValue": w[1] || (w[1] = (u) => n.value = u)
      }, {
        default: P(() => [
          (F(!0), v(Z, null, ee(p.value, ([u, C]) => (F(), L(c(f1), {
            key: u,
            title: u,
            name: u
          }, {
            default: P(() => [
              (F(!0), v(Z, null, ee(C, (h) => (F(), v("div", {
                class: "_node_item",
                onMousedown: (m) => f(h, m),
                title: h.label
              }, [
                k(c(le), { class: "_icon" }, {
                  default: P(() => [
                    k(c(ue), {
                      name: h.icon || "#prep-virtual-node-font"
                    }, null, 8, ["name"])
                  ]),
                  _: 2
                }, 1024),
                E("span", yt, V(h.label), 1)
              ], 40, Bt))), 256))
            ]),
            _: 2
          }, 1032, ["title", "name"]))), 128))
  ...
  let o = l;
  return t && (o = Xe(o, t)), i && (o = We(o, i)), a && (o = ze(o, a)), o;
}, ze = (l, e) => {
  let t = {}, i = [...l];
  ...
  if (a) {
    let n = !1, d = 1;
    for (const p of a)
      n = n || p == null, t[d++] = p == null ? i : i.splice(0, p);
    n && i.length > 0 && (t[d] = i);
  } else if (o) {
    const n = new Array().concat(o), d = i.map((p) => ({ ...p, $_key: n.map((A) => b(p, A) || "").join() }));
    t = ve(d, "$_key");
  } else
    s ? t = ve(i, s) : r && (t = r(i));
  return t;
  ...
  return i && (t = w1(t, i)), a && (t = a(t)), o && (t = t.reverse()), t;
}, Xe = (l, e) => {
  let t = [...l];
  const { key: i = "id", blackList: a, whiteList: o, fn: r, items: s } = e;
  return a && (t = t.filter((n) => !a.includes(b(n, i)))), o && (t = t.filter((n) => o.includes(b(n, i)))), r && (t = t.filter((n) => r(n))), s && t.push(...s), t;
}, Ft = `## 组件使用说明
...
`, Qt = { class: "_menu" }, Dt = {
  ...
  setup(l, { expose: e }) {
    const t = l, { context: i } = t, { config: a } = ce(t), o = i == null ? void 0 : i.graphTools, r = i == null ? void 0 : i.markdownRef, s = [
      { title: "导出", key: "export", icon: m1, handle: () => o == null ? void 0 : o.export() },
      { title: "导入", key: "import", icon: B1, handle: () => o == null ? void 0 : o.import() },
      { title: "撤销", key: "undo", icon: y1, handle: () => o == null ? void 0 : o.undo() },
      { title: "恢复", key: "redo", icon: E1, handle: () => o == null ? void 0 : o.redo() },
      { title: "放大", key: "zoomBig", icon: F1, handle: () => o == null ? void 0 : o.zoomBig() },
      { title: "缩小", key: "zoomSmall", icon: Q1, handle: () => o == null ? void 0 : o.zoomSmall() },
      { title: "保存", key: "save", icon: Qe, handle: () => o == null ? void 0 : o.zoomSmall() },
      { title: "帮助", key: "help", icon: D1, handle: () => {
        var d;
        return (d = r == null ? void 0 : r.value) == null ? void 0 : d.init(Ft);
      } },
      ...
      const { elems: d = [], filter: p, order: A, group: f } = c(a) || {}, B = [...s, ...c(d)];
      let w = B;
      return p && (w = Xe(B, p)), A && (w = We(w, A)), f && (w = ze(w, f)), console.log("menu - list = ", w, d, p, A, f, a.value), w && !Array.isArray(w) && (w = Object.keys(w).map((u) => b(w, u))), w;
    });
    return e({}), (d, p) => (F(), v("div", Qt, [
      (F(!0), v(Z, null, ee(n.value, (A) => (F(), v(Z, null, [
        Array.isArray(A) ? (F(), v("div", Dt, [
          (F(!0), v(Z, null, ee(A, (f) => (F(), v(Z, null, [
            f.tag ? (F(), L(c(z), {
              key: 0,
              elem: A,
              params: c(i)
            }, null, 8, ["elem", "params"])) : (F(), L(c(H), {
              key: 1,
              onClick: f.handle,
              title: f.title,
              icon: f.icon
  ...
  setup(l, { expose: e }) {
    const t = l, { config: i, context: a } = t, { elem: o } = ce(t), r = R(o.value || {}), { showFooter: s, ...n } = i, d = R(n), p = Q(!1), A = (C) => {
      C && (r.value = C), r.value && (p.value = !0);
    }, f = () => {
      p.value = !1;
    }, B = (C, h) => {
      typeof C == "string" ? d.value[C] = h : d.value = _({}, n, C);
    }, w = () => {
      a.graphEvents.hasEvent("dialog:cancel") ? a.graphEvents.eventCall("dialog:cancel") : f();
    }, u = () => {
      a.graphEvents.hasEvent("dialog:submit") ? a.graphEvents.eventCall("dialog:submit") : f();
    };
    return X(o, (C) => {
      C && (r.value = C);
    }), e({
      ...
      class: "_graph-dialog",
      modelValue: p.value,
      "onUpdate:modelValue": h[0] || (h[0] = (m) => p.value = m)
    }, d.value, { "destroy-on-close": "" }), {
      default: P(() => [
        k(c(z), {
          elem: r.value,
          params: c(a)
        }, null, 8, ["elem", "params"]),
        c(s) ? (F(), L(c(O), { key: 0 })) : Y("", !0),
        c(s) ? (F(), v("div", Mt, [
          k(c(H), {
            onClick: He(w, ["stop"])
          }, {
...
class vt {
  constructor(e = {}) {
    ...
    //
    g(this, "currentCell", R());
    // 已选的节点集合
    g(this, "selectedCells", R([]));
    // 剪切板中复制的节点集合
    g(this, "clipboardCells", R([]));
    //
    g(this, "defaultNodeMarkup", Ie);
  ...
  initCell(e) {
    ...
    let a = b(i, "status.aggregateSnapshot.runStatus") || "";
    const o = {
      id: t.id,
      cell: t,
      status: Q({}),
  ...
  removeCells(e = []) {
    ...
    for (const o of e) {
      if (o.isEdge()) {
        const r = o.id, s = this.get(o), n = s.source.value, d = s.target.value;
        n && ((i = this.cells.get(n)) == null ? void 0 : i.outCells.value).delete(r), d && ((a = this.cells.get(d)) == null ? void 0 : a.outCells.value).delete(r);
      }
      this.del(o);
    }
...
const St = {
...
}, Nt = /* @__PURE__ */ E("span", { style: { "--i": "1" } }, null, -1), Gt = /* @__PURE__ */ E("span", { style: { "--i": "2" } }, null, -1), Rt = /* @__PURE__ */ E("span", { style: { "--i": "3" } }, null, -1), Pt = /* @__PURE__ */ E("span", { style: { "--i": "4" } }, null, -1), Vt = /* @__PURE__ */ E("span", { style: { "--i": "5" } }, null, -1), Ot = /* @__PURE__ */ E("span", { style: { "--i": "6" } }, null, -1), Kt = /* @__PURE__ */ E("span", { style: { "--i": "7" } }, null, -1), Ut = /* @__PURE__ */ E("span", { style: { "--i": "8" } }, null, -1), Yt = /* @__PURE__ */ E("span", { style: { "--i": "9" } }, null, -1), Jt = /* @__PURE__ */ E("span", { style: { "--i": "10" } }, null, -1), Tt = [
  Nt,
  Gt,
  Rt,
  Pt,
  ...
  setup(l) {
    ...
    const e = l, { edge: t, context: i } = e, { graphShadow: a, graph: o, graphForm: r } = i, s = M(() => {
      const x = e.config, N = a.getEdgeLabelConfig(t).value || {};
      return { enabled: !0, icon: 0, icons: [L1], prop: "edge", params: {}, title: "", ...x, ...N };
    }), { icon: n, prop: d, params: p } = c(s), A = r.getCellFormData(t), f = a.getEdgeData(t), B = f.source, w = f.target, u = f.step, C = f.label, h = (ie = o.value) == null ? void 0 : ie.getCellById(c(B)), m = (oe = o.value) == null ? void 0 : oe.getCellById(c(w)), y = Q(c(n)), D = M(() => {
      const x = s.value.icons[c(y)];
      return x.icon ? x : { icon: x };
    }), I = Q(!1), G = Q(!1);
    let S;
    const J = (x) => {
      window.clearTimeout(S), x === !1 ? S = setTimeout(() => {
        I.value = !1;
      }, 500) : I.value = !0;
    }, de = () => {
      const x = s.value.icons;
      if (c(x).length == 1)
        return;
      y.value >= x.length - 1 ? y.value = 0 : y.value++;
      const N = x[y.value];
      A[d] = typeof N == "string" ? y.value : N.value;
    };
    return te(() => {
    }), (x, N) => s.value.enabled ? (F(), v("div", St, [
      k(c(Je), {
        placement: "top",
        width: "auto",
        teleported: !1,
        visible: G.value || I.value,
        ...
        reference: P(() => [
          E("div", {
            class: "_icon-box",
            onClick: de,
            onMouseenter: N[0] || (N[0] = () => J(!0)),
            onMouseleave: N[1] || (N[1] = () => J(!1))
          }, [
            E("span", {
              flex: "",
              "items-center": "",
              ...
              "rd-4": "",
              "p-x-4": "",
              style: Oe(c(C) ? "" : "border:none;padding:0;")
            }, [
              k(c(le), {
                class: Ee([]),
                "text-16": ""
        ...
        default: P(() => [
          E("div", {
            class: "_popover-box",
            onMouseenter: N[3] || (N[3] = () => J(!0)),
            onMouseleave: N[4] || (N[4] = () => J(!1))
          }, [
            E("div", Zt, [
              E("b", jt, V(s.value.title), 1),
              k(c(H), {
                link: "",
                type: G.value ? "primary" : "info",
                onClick: N[2] || (N[2] = (we) => G.value = !G.value)
              }, {
                icon: P(() => [
                  k(c(ue), {
                    name: "#icon-tuding",
            ...
            s.value.elem ? (F(), v("div", qt, [
              k(c(z), {
                elem: s.value.elem,
                params: { edge: c(t), sourceNode: c(h), targetNode: c(m), ...c(i), ...c(p) }
              }, null, 8, ["elem", "params"])
            ])) : Y("", !0)
          ], 32)
        ]),
  ...
  setup(l, { expose: e }) {
    const i = a1(l, "value"), a = Q(i.value || ""), o = (A) => {
      /\.md$/.test(A) && fetch(A).then((f) => f.text()).then((f) => {
        d(f);
      });
    }, r = (A) => {
    }, s = async (A) => {
    ...
    return X(i, (A = "") => {
      ...
      default: P(() => [
        k(c(Z1), { value: a.value }, null, 8, ["value"])
      ]),
      _: 1
    }, 8, ["modelValue"]));
  }
...
class Xt {
  ...
  //
  initMenus() {
    const e = this.config.node || [], t = this.config.edge || [], i = this.config.blank || [], o = this.config.useDefaultMenu ?? !0 ? { node: [...rt], edge: [...at], blank: [...st] } : { node: [], edge: [], blank: [] };
  ...
  createContextmenu(e, t) {
    ...
    let a = this.menus[i] || [];
    if (i === "node") {
      const r = (t == null ? void 0 : t.getData()) || {}, s = r == null ? void 0 : r.contextmenu;
      s && Array.isArray(s) && s.length > 0 && (a = [...s, { tag: O }, ...a]);
    }
...
const _t = /* @__PURE__ */ q({
  ...
  setup(l, { expose: e }) {
    ...
    return e({
      ...
      style: Oe(`position:absolute;z-index:9999;left:${c(i).x.value}px;top:${c(i).y.value}px`)
    }, [
      (F(), L(c(z), {
        key: c(i).key.value,
        elem: c(i).menu.value,
        params: c(i).params.value,
        context: { params: { ElMessage: c(T), ElNotification: c(S1) } }
      }, null, 8, ["elem", "params", "context"]))
    ], 4)), [
      [Ue, c(i).visible.value]
    ]);
  }
}), $t = { class: "_box-main" }, ei = { class: "_main-content" }, ti = {
  name: "ElsX6"
}, ii = /* @__PURE__ */ q({
  ...ti,
  props: {
  ...
  setup(l, { expose: e }) {
    const t = l, { viewModel: i, nodeListConfig: a } = ce(t), { graphConfig: o, menuConfig: r, pluginsConfig: s, contextmenuConfig: n, edgeLabelConfig: d, defaultNodeMarkup: p, register: A, events: f } = t, B = x1(), w = R(), u = Q(), C = Q(), h = Q(), m = Q(), y = Q(), D = Q(), I = Q(), G = Q(), S = new vt().resetDefaultNodeMarkup(p), J = new wt(S), de = new ut({ graphShadow: S, graphForm: J, contextmenuRef: D, events: f, containerBox: h }), ie = new bt(s), oe = new Lt({ elsX6Ref: u }), x = {
      graph: w,
      graphShadow: S,
      graphForm: J,
      graphEvents: de,
    ...
    return ae("GRAPH-SHADOW", S), ae("GRAPH", w), ae("GRAPH-FORM", J), ae("GRAPH-MARKDOWN", m), ae("GRAPH-CONTEXT", x), nt(), lt(), A && A(Be), te(() => {
      const N = _($1, o);
      w.value = W(new Be({
        ...N,
        // 自定义 边的弹出展示
        onEdgeLabelRendered: (we) => {
          const { selectors: pe, edge: Ae } = we, Me = pe.foContent;
          Me && r1(
            Ye(zt, {
              edge: Ae,
              config: d,
        ...
        container: C.value
      })), ie.usePlugins(w.value), S.setGraph(w.value), J.setGraph(w.value), oe.init(w.value), de.resetGraph(w.value).registerEvent().onMounted(x);
    }), e({
      graph: w
    }), (N, we) => {
      var pe, Ae;
      return F(), v("div", {
        ...
        k(gt),
        E("div", $t, [
          (pe = c(a)) != null && pe.enabled || !c(i) ? (F(), L(Et, Fe({
            key: 0,
            graph: w.value
          }, c(a)), null, 16, ["graph"])) : Y("", !0),
          E("div", ei, [
            ((Ae = c(r)) == null ? void 0 : Ae.enabled) !== !1 || !c(i) ? (F(), L(It, {
              key: 0,
              ref_key: "menuRef",
              ref: G,
              class: "_menu",
...
}), oi = "/openmetadata-api", _e = (l) => {
  const e = oi + "/openMetadata/query", t = new FormData();
  ...
  const e = Q({}), t = Q({}), i = Q([]), a = Q([]), o = Q([]), r = Q([]), s = "name", n = (l == null ? void 0 : l.kafkaOptionKey) || "connection.config.bootstrapServers", d = (l == null ? void 0 : l.topicOptionKey) || "name", p = (l == null ? void 0 : l.kafkaFormatKeys) || me[0], A = (l == null ? void 0 : l.topicFormatKeys) || me[1];
  ai().then((h) => {
    i.value = h.data, o.value = h.data.map((m) => ({ label: m.name, value: b(m, n), tag: W(ye) }));
  }), X(e, (h) => {
    const m = h == null ? void 0 : h.name;
    m && ri(m).then((y) => {
      a.value = y.data, r.value = y.data.map((D) => ({ label: D.name, value: b(D, d), tag: W(ye) }));
    });
  }), X(t, () => {
  });
  const f = (h, m) => {
    ...
    const y = b(e.value, n);
    if (y != m) {
      e.value = i.value.filter((I) => b(I, n) == m)[0] || {};
      const D = p;
      Object.keys(D).forEach((I) => {
        const G = b(D, I), S = b(e.value, I);
        U(h, G, S);
      }), y != null && u(h);
    }
  }, w = (h, m) => {
    t.value = a.value.filter((D) => b(D, d) == m)[0] || {};
    const y = A;
    Object.keys(y).forEach((D) => {
      const I = b(y, D), G = b(t.value, D);
      U(h, I, G);
    });
  }, u = (h) => {
    t.value = {};
    ...
    Object.keys(m).forEach((y) => {
      const D = b(m, y), I = b(t.value, y);
      U(h, D, I);
    });
  };
  return { valueKey: s, currentKafka: e, currentTopic: t, kafkaList: i, topicList: a, kafkaOptions: o, topicOptions: r, resetFormData: (h, m) => {
    const [y, D] = m;
    Object.keys(y).map((I) => {
      const G = y[I], S = b(c(e), I);
      S != null && U(h, G, S);
    }), Object.keys(D).map((I) => {
      const G = D[I], S = b(c(t), I);
      S != null && U(h, G, S);
    }), console.log(".... ==> ", h);
  }, setKafkaServer: B, setKafkaTopic: w, initKafkaServer: f, NIFI_FORMAT_KEYS: me };
}, { kafkaOptions: xe, topicOptions: ke, valueKey: Ui, currentKafka: Yi, currentTopic: Ji, resetFormData: Ti, NIFI_FORMAT_KEYS: Zi, setKafkaServer: Ne, setKafkaTopic: Ge, initKafkaServer: Re } = si(), ni = {
  "org.apache.nifi.processors.kafka.pubsub.ConsumeKafka_2_6": {
    "bootstrap.servers": { tag: W(K), filterable: !0, allowCreate: !0, defaultFirstOption: !0, cls: xe, ":modelValue": "formData['bootstrap.servers']", "@update:modelValue": ({ formData: l, $: e }) => Ne(l, e[0]), setup: ({ params: l }) => {
      Re(l.formData, "bootstrap.servers");
    } },
    topic: { tag: W(K), filterable: !0, allowCreate: !0, defaultFirstOption: !0, cls: ke, ":modelValue": "formData['topic']", "@update:modelValue": ({ formData: l, $: e }) => Ge(l, e[0]) }
    ...
    cls: [
      {
        ...
        column: [
          // 基础信息
          { tag: j, label: "名称", prop: "name", value: "" },
          { tag: j, label: "编号", prop: "id", disabled: !0 },
          //
          { tag: K, label: "从输出", prop: "source.id", "v-if": r.length > 0, cls: r.map((n) => ({ value: n.id, label: n.component.name })) },
          { tag: K, label: "输入", prop: "destination.id", "v-if": s.length > 0, cls: s.map((n) => ({ value: n.id, label: n.component.name })) },
          // 连线规则 关系
          { tag: Le, label: "输出数据流", value: i.length == 1 ? [i[0].name] : [], "v-if": i.length > 0, required: !0, prop: "selectedRelationships", cls: i.map((n) => ({ tag: fe, label: n.name, title: n.description })) },
          // 优先级
          { tag: Le, label: "优先级设置器", prop: "prioritizers", cls: a.prioritizers.map((n) => ({ tag: fe, label: n.type, cls: n.type.split(".").reverse()[0] })) },
          //
          { tag: j, label: "FlowFile 过期时间", prop: "flowFileExpiration", value: "0 sec" },
          //
          { tag: j, label: "背压对象阈值", prop: "backPressureObjectThreshold", value: "1000", rules: [{ pattern: /^\d+(\.\d+)?$/, message: "只能输入数字" }] },
          { tag: j, label: "背压大小阈值", prop: "backPressureDataSizeThreshold", value: "1 GB" },
          //
          { tag: K, label: "负载均衡策略", prop: "loadBalanceStrategy", value: "DO_NOT_LOAD_BALANCE", cls: [{ label: "do not load balance", value: "DO_NOT_LOAD_BALANCE" }, { label: "partition by attribute", value: "PARTITION_BY_ATTRIBUTE" }, { label: "round robin", value: "ROUND_ROBIN" }, { label: "single node", value: "SINGLE_NODE" }] },
          { tag: j, label: "属性名称", prop: "loadBalancePartitionAttribute", value: "", "v-if": ({ formData: n }) => n.value.loadBalanceStrategy == "PARTITION_BY_ATTRIBUTE" },
          {
            tag: K,
            label: "负载均衡压缩",
  ...
  const e = l.groupBreadcrumb, t = e.length - 1, i = e.map((a, o) => ({ tag: H, link: !0, key: "elem", type: o == t ? "primary" : "success", cls: a.name, "@click": () => {
    l.initGraph(a.id);
  ...
  useDefaultMenu: !1,
  node: [
    { tag: H, link: !0, icon: he, cls: "编辑", "v-if": ({ cell: t }) => l.nodeType(t) != "FUNNELS", "@click": ({ cell: t, contextmenu: i }) => l.nodeEdit(t, i) },
    { tag: O, "v-if": ({ cell: t }) => l.nodeType(t).includes("PROCESS") },
    { tag: H, link: !0, icon: he, cls: "查看历史", "v-if": ({ cell: t }) => ["PROCESS", "PROCESS-GROUP"].includes(l.nodeType(t)), "@click": ({ cell: t, contextmenu: i }) => l.initCellHistory(t, i) },
    ...
    { tag: O },
    { tag: H, link: !0, icon: $, cls: "删除", "@click": ({ cell: t, contextmenu: i }) => l.nodeDel(t, i) },
    { tag: H, link: !0, icon: $, cls: "批量删除", "v-if": ({ selectedCells: t }) => t.value.length > 1, "@click": ({ selectedCells: t, contextmenu: i }) => l.nodesDel(t.value, i) }
  ],
  edge: [
    { tag: H, link: !0, icon: he, cls: "查看历史", "@click": ({ cell: t, contextmenu: i }) => l.initCellHistory(t, i) },
    { tag: O },
    { tag: H, link: !0, icon: he, cls: "编辑", "@click": ({ cell: t, contextmenu: i }) => l.edgeEdit(t, i) },
    { tag: O },
    { tag: H, link: !0, icon: $, cls: "删除", "@click": ({ cell: t, contextmenu: i }) => l.edgeDel(t, i) }
  ],
  blank: [
    { tag: H, link: !0, icon: Qe, cls: "全选" },
    { tag: H, link: !0, icon: Te, cls: "复制", ":disabled": "selectedCells.length == 0" },
    { tag: H, link: !0, icon: Ze, cls: "粘贴", ":disabled": "clipboardCells.length == 0" },
    { tag: O },
    {
      tag: H,
      link: !0,
  ...
  if (!t)
    return;
  const i = (A = e.graphShadow) == null ? void 0 : A.get(l), a = (f = e.graphShadow) == null ? void 0 : f.get(i.source.value), o = (B = e.graphShadow) == null ? void 0 : B.get(i.target.value), r = e.nodeType(a), s = e.nodeType(o);
  console.log("getEdgeLabelElem == ", i, a, o, i.label.value);
  const n = t.component, d = n.source, p = n.destination;
  return {
    tag: "div",
    class: "_edge-label-box",
    cls: [
      ...
      ] },
      {
        ...
        class: "_edge-box",
        cls: [
          { tag: "p", "v-if": d.type == "OUTPUT_PORT", cls: ["从", { tag: "b", cls: d.name }] },
  ...
  var B, w;
  const t = l.data, i = t.component.type, a = e.nodeType(l), o = ((w = (B = t.component) == null ? void 0 : B.config) == null ? void 0 : w.descriptors) || {}, r = ni[i], s = a == "PROCESS" && o ? Object.keys(o).map((u) => {
    const C = o[u], h = C.name, m = C.displayName, y = C.description, D = C.required, I = C.dependencies.length > 0 ? "select" : "string", G = I == "select" ? C.dependencies.map((J) => ({ label: J.propertyName, value: J.dependentValues[0] })) : [], S = r == null ? void 0 : r[h];
    if (S !== !1)
      return S ? Object.assign({ type: I, prop: h, label: m, desc: y, required: D, cls: G }, S) : { type: I, prop: h, label: m, desc: y, required: D, value: C.defaultValue, cls: G };
  }).filter((u) => u != null) : [], n = a == "PROCESS" ? t.component.relationships.map((u, C) => ({
    tag: "p",
    class: "nifi-form-relationships",
    cls: [
      { tag: "span", cls: u.name },
      { tag: fe, prop: "relationships." + C + ".autoTerminate", label: "", cls: "Terminate" },
      { tag: fe, prop: "relationships." + C + ".retry", cls: "retry", label: "" }
    ]
  })) : [], d = {
    tag: "div",
    "v-if": ({ formData: u }) => {
      var C;
      return ((C = u.value.relationships) == null ? void 0 : C.filter((h) => h.retry).length) > 0;
    },
    cls: [
      { tag: R1, prop: "config.retryCount", label: "重试尝试次数", tip: "For relationships set to retry, this number indicates how many times a FlowFile will attempt to reprocess before it is routed elsewhere." },
      {
        tag: P1,
      ...
      column: [
        {
          ...
          cls: [
            { tag: "legend", cls: "基础" },
            { prop: "state", label: "是否启用", tag: N1, activeValue: "STOPPED", inactiveValue: "DISABLED" },
            ...
            { tag: K, prop: "config.bulletinLevel", label: "公告级别", cls: [{ value: "DEBUG", label: "调试" }, { value: "INFO", label: "信息" }, { value: "WARN", label: "警告" }, { value: "ERROR", label: "错误" }, { value: "NONE", label: "无" }], tip: "The level at which this processor will generate bulletins." }
          ]
        },
        {
          tag: "fieldset",
          cls: [
            { tag: "legend", cls: "调度" },
            {
              ...
              "@change": ({ formData: u, $: C }) => {
                C[0] == "CRON_DRIVEN" ? (U(c(u), "config.schedulingPeriod", "* * * * * ?"), U(c(u), "config.concurrentlySchedulableTaskCount", "1")) : (U(c(u), "config.schedulingPeriod", "0 sec"), U(c(u), "config.concurrentlySchedulableTaskCount", "1"));
              },
            ...
            { tag: K, prop: "config.executionNode", label: "执行", cls: [{ value: "ALL", label: "所有节点" }, { value: "PRIMARY", label: "主节点" }], tip: "The node(s) that this processor will be scheduled to run on when clustered." }
          ]
        },
        {
          tag: "fieldset",
    ...
    { label: "控制器配置", type: "elem", elem: { tag: j1, application: "Group", node: t, controllerType: [] } }
  ], f = {
    label: "基础信息",
    type: "form",
    validate: !0,
    ...
    column: [
      {
        ...
        "@update:modelValue": ({ data: u, $: C, cell: h, formData: m }) => {
          var y, D;
          u.label.value = C[0] || h.data.component.name, U(c(m), "name", C[0] || h.data.component.name), (y = e.graphForm) != null && y.getCellFormData(h) && U((D = e.graphForm) == null ? void 0 : D.getCellFormData(h), "name", C[0] || h.data.component.name);
        }
      },
      { tag: "p", class: "nifi-form-item", cls: [{ tag: "b", cls: "编号" }, { tag: re, cls: t.id, "@click": () => T.success(`复制 [ ${t.id} ]`) && Pe(t.id) }] },
      { tag: "p", class: "nifi-form-item", "v-if": t.component.type != null, cls: [{ tag: "b", cls: "类型" }, { tag: re, cls: t.component.type, title: t.component.type, "@click": () => T.success(`复制 [ ${t.component.type} ]`) && Pe(t.component.type) }] },
      { tag: "p", class: "nifi-form-item", "v-if": t.revision != null, cls: [{ tag: "b", cls: "版本号" }, { tag: re, cls: t.revision.version, type: "success" }] },
      { tag: "p", class: "nifi-form-item", "v-if": t.status, cls: [{ tag: "b", cls: "运行状态" }, { tag: re, type: "info", cls: t.status.runStatus }, { tag: re, cls: t.status.statsLastRefreshed }] }
    ]
  };
  return a == "PROCESS" ? [f, ...p] : a == "PROCESS-GROUP" ? [f, ...A] : [];
}, Ai = { class: "nifi-history" }, hi = { class: "_left" }, Ci = { class: "_info" }, gi = /* @__PURE__ */ E("i", null, "ID", -1), fi = /* @__PURE__ */ E("i", null, "GroupId", -1), ui = { key: 0 }, wi = /* @__PURE__ */ E("i", null, "Source Name", -1), mi = { key: 1 }, Bi = /* @__PURE__ */ E("i", null, "Destination Name", -1), yi = /* @__PURE__ */ E("i", null, "开始时间", -1), Ei = /* @__PURE__ */ E("i", null, "结束时间", -1), Fi = /* @__PURE__ */ E("p", null, [
  /* @__PURE__ */ E("i", null, "最小值"),
  /* @__PURE__ */ ge("/"),
  /* @__PURE__ */ E("i", null, "最大值"),
  /* @__PURE__ */ ge("/"),
  /* @__PURE__ */ E("i", null, "平均值")
], -1), Qi = { class: "_right" }, Di = { class: "_header" }, Ii = { class: "_chart-box" }, Mi = /* @__PURE__ */ q({
  __name: "history",
  props: {
    data: {}
  },
  setup(l) {
    var B, w, u, C;
    const e = l, { data: t } = ce(e), i = Q(), a = Q(), o = {
      tooltip: {
        trigger: "axis",
        position: function(h) {
          return [h[0], "10%"];
      ...
      const { statusHistory: h } = c(t), { componentDetails: m } = h;
      return m;
    }), s = M(() => {
      const { statusHistory: h } = c(t), { fieldDescriptors: m } = h;
      return m.map((y) => ({ label: y.label, value: y.field, title: y.description }));
    }), n = Q(((C = (u = (w = (B = c(t)) == null ? void 0 : B.statusHistory) == null ? void 0 : w.fieldDescriptors) == null ? void 0 : u[0]) == null ? void 0 : C.field) || ""), d = M(() => {
      var h, m;
      return ((m = (h = c(t)) == null ? void 0 : h.statusHistory) == null ? void 0 : m.aggregateSnapshots) || [];
    }), p = M(() => c(d).map((h) => [h.timestamp, b(h.statusMetrics, c(n))])), A = M(() => c(p).map((h) => h[1])), f = M(() => ({ title: { text: c(n) }, series: [{ name: c(n), data: c(p) || [] }] }));
    return X(f, (h) => {
      var m;
      (m = a.value) == null || m.setOption(h);
    }), te(() => {
      a.value = W(V1(i.value)), console.log("ops === ", _({}, o, c(f))), a.value.setOption(_({}, o, c(f))), setTimeout(() => {
        a.value.resize();
      }, 50);
    }), (h, m) => (F(), v("div", Ai, [
      E("div", hi, [
        E("div", Ci, [
          E("p", null, [
            gi,
            E("b", null, V(r.value.Id), 1)
          ]),
          E("p", null, [
            fi,
            E("b", null, V(r.value["Group Id"]), 1)
          ]),
          c(ne)(r.value, "Source Name") ? (F(), v("p", ui, [
            wi,
            E("b", null, V(r.value["Source Name"]), 1)
          ])) : Y("", !0),
          c(ne)(r.value, "Destination Name") ? (F(), v("p", mi, [
            Bi,
            E("b", null, V(r.value["Destination Name"]), 1)
          ])) : Y("", !0)
        ]),
        E("div", null, [
          E("p", null, [
            yi,
            E("b", null, V(new Date(d.value[0].timestamp).toLocaleString()), 1)
          ]),
          E("p", null, [
            Ei,
            E("b", null, V(new Date(d.value.at(-1).timestamp).toLocaleString()), 1)
          ])
        ]),
        E("div", null, [
          Fi,
          E("p", null, V(c(O1)(A.value)) + " " + V(n.value.includes("Bytes") ? "bytes" : "") + " / " + V(c(K1)(A.value)) + " " + V(n.value.includes("Bytes") ? "bytes" : "") + " / " + V(c(U1)(A.value)) + " " + V(n.value.includes("Bytes") ? "bytes" : ""), 1)
        ])
      ]),
      E("div", Qi, [
        E("div", Di, [
          k(c(K), {
            ...
            default: P(() => [
              (F(!0), v(Z, null, ee(s.value, (y) => (F(), L(c(ye), {
                label: y.label,
                value: y.value,
                title: y.title,
                key: y.value
...
class bi {
  constructor() {
    g(this, "NIFI_DATA", {});
    g(this, "initFinishFlag", !1);
    g(this, "refreshTimeHandle");
    g(this, "groupRefreshCount", 1);
    //
    g(this, "contextmenu", {});
    //
    g(this, "clientId", "");
    ...
    //
    g(this, "groupId", "");
    g(this, "groupFlowData", {});
    g(this, "groupBreadcrumb", []);
    g(this, "graphData", []);
    g(this, "graphFormData", {});
    g(this, "graphCellData", {});
    //
    g(this, "graph");
    g(this, "graphForm");
    g(this, "graphShadow");
    g(this, "graphDialogRef");
    g(this, "graphDrawerRef");
    //
    g(this, "currentConnectForm", Q({}));
    g(this, "dialogRef");
    //
    g(this, "menuElems", R([]));
    g(this, "menuConfig", R({ enabled: !0, elems: this.menuElems, filter: { key: "key", whiteList: ["elem"] } }));
    //
    g(this, "events", {
      mounted: (e) => {
    ...
    this.apiGetClientId(), this.initProcessType(), this.initPrioritizers(), this.initRoot(), this.apiGetRootStatus(), this.NIFI_DATA = JSON.parse(Hi), this.initGraph(), this.contextmenu = di(this), te(() => {
      this.groupRefresh();
    }), s1(() => {
  ...
  async procesorUpdate(e) {
    ...
    await q1(e.id, a) && (this.apiUpdateEdge(e), this.initGraph());
  }
  // 构建节点列表
  buildNodesFromTypes() {
  ...
  async initGraphFlowData() {
    ...
    for (const s of i) {
      const n = await this.apiGetControllServices(s.id), d = [], p = s.inputPortCount || 0, A = s.outputPortCount || 0;
      p > 0 && d.push(this.NIFI_DATA.portIn), A > 0 && d.push(this.NIFI_DATA.portOut);
      const f = {
        id: s.id,
        position: s.position,
        shape: "vue-node",
      ...
      this.graphData.push(f), this.graphFormData[s.id] = s.component, this.graphCellData[s.id] = s;
    }
    for (const s of t) {
      const n = this.NIFI_DATA.cellData, d = this.nodeList.value.filter((B) => B.name == s.component.type)[0].groupName, p = n[d] || {}, A = await this.apiGetNode(s.id), f = {
        ...p,
        id: s.id,
        position: s.position,
        shape: "vue-node",
      ...
      this.graphData.push(f), this.graphFormData[s.id] = s.component.config, this.graphCellData[s.id] = s;
    }
    const r = [...t, ...i];
    for (const s of e) {
      const n = s.sourceGroupId != this.groupId ? s.sourceGroupId : s.sourceId, d = s.destinationGroupId != this.groupId ? s.destinationGroupId : s.destinationId, p = s.component.source, A = s.component.destination, f = p.type == "PROCESSOR" ? p.name : `${r.filter((C) => C.id == n)[0].component.name} ( ${p.name} )`, B = A.type == "PROCESSOR" ? A.name : `${r.filter((C) => C.id == d)[0].component.name} (${A.name})`, w = `[${f}] -> [${B}]`, u = {
        id: s.id,
        shape: "vue-edge",
        source: { cell: n, port: "out" },
        target: { cell: d, port: "in" },
        title: w,
        data: s
      };
      this.graphData.push(u), this.graphFormData[s.id] = s.component, this.graphCellData[s.id] = s;
    }
  }
  initGraphStatus() {
  ...
  async initCellHistory(e, t) {
    ...
    try {
      ...
      console.log(o), ((a = (i = o == null ? void 0 : o.statusHistory) == null ? void 0 : i.aggregateSnapshots) == null ? void 0 : a.length) == 0 ? T.info("历史记录不足，请稍后再试") : Y1({ title: "状态历史", message: Ye(Mi, { data: o }) });
    } catch (o) {
  ...
  async nodeSave(e, t) {
    ...
    a.component = i, this.nodeUpdate(a, e);
  }
  async nodeDel(e, t) {
    var i;
    try {
      await this.apiDelNode(e), (i = this.graph) == null || i.removeCell(e), t == null || t.close();
    } catch {
    }
  }
  async nodesDel(e, t) {
  ...
  getEdgeData(e) {
    var w, u, C, h, m, y, D;
    const t = e.data, i = (w = this.graphShadow) == null ? void 0 : w.get(e), a = c(i.source), o = c(i.target), r = (u = this.graph) == null ? void 0 : u.getCellById(a), s = (C = this.graph) == null ? void 0 : C.getCellById(o), n = ((m = (h = r == null ? void 0 : r.data) == null ? void 0 : h.component) == null ? void 0 : m.relationships) || [], d = t.component.name || (t.component.selectedRelationships || []).join(",");
    let p = "", A = [], f = [], B = {};
    return t != null && t.id ? (p = e.prop("title"), B = e.data.component, A = ((y = this.graphShadow) == null ? void 0 : y.get(a, "outputPorts")) || [], f = ((D = this.graphShadow) == null ? void 0 : D.get(o, "inputPorts")) || []) : p = `[${r == null ? void 0 : r.prop("label")}] -> [${s == null ? void 0 : s.prop("label")}]`, { title: p, outPorts: A, inPorts: f, modelValue: B, label: d, relationships: n, sourceNode: r, targetNode: s, sourceId: a, targetId: o, id: t == null ? void 0 : t.id };
  }
  async getEdgeInfo(e) {
    var f, B, w, u, C, h, m, y, D;
    const t = (f = this.graphShadow) == null ? void 0 : f.get(e), i = c(t.source), a = c(t.target), o = (B = this.graph) == null ? void 0 : B.getCellById(i), r = (w = this.graph) == null ? void 0 : w.getCellById(a);
    let s = [], n = [], d = { $EdgeJSONData: e.toJSON() };
    const p = ((C = (u = o == null ? void 0 : o.data) == null ? void 0 : u.component) == null ? void 0 : C.relationships) || [], A = `[${o == null ? void 0 : o.prop("label")}] -> [${r == null ? void 0 : r.prop("label")}]`;
    if (o == null || o.data.component.parentGroupId, r == null || r.data.component.parentGroupId, (o == null ? void 0 : o.data.outputPortCount) > 0) {
      const I = await this.apiGetGroupData(i);
      s = I.processGroupFlow.flow.outputPorts, s[0].id, (h = this.graphShadow) == null || h.set(i, "processGroupFlow", I.processGroupFlow), (m = this.graphShadow) == null || m.set(i, "outputPorts", s);
    }
    if ((r == null ? void 0 : r.data.inputPortCount) > 0) {
      const I = await this.apiGetGroupData(a);
      n = I.processGroupFlow.flow.inputPorts, n[0].id, (y = this.graphShadow) == null || y.set(a, "processGroupFlow", I.processGroupFlow), (D = this.graphShadow) == null || D.set(a, "inputPorts", n);
    }
    return { title: A, inPorts: n, outPorts: s, modelValue: d, relationships: p, sourceNode: o, targetNode: r };
  }
  async edgeElem(e) {
    const { title: t, inPorts: i, outPorts: a, relationships: o, targetNode: r, modelValue: s } = await this.getEdgeInfo(e), n = li({ relationships: o, outPorts: a }, { cell: r, inPorts: i }, { that: this, modelValue: s });
    return { title: t, outPorts: a, inPorts: i, modelValue: s, elem: n };
  }
  async edgeInit(e) {
    var t, i;
    if (e.data && e.data.id) {
      const a = Ve(e, this), { title: o, label: r } = this.getEdgeData(e);
  ...
  async edgeEdit(e, t) {
    ...
    t.close(), (n = (s = this.graphDialogRef) == null ? void 0 : s.value) == null || n.open(i), (p = (d = this.graphDialogRef) == null ? void 0 : d.value) == null || p.setConfig({ title: a });
  }
  async edgeSubmit(e) {
    var a;
    const { $EdgeJSONData: t, ...i } = e;
    if (t)
      this.apiNewEdge(i).then((o) => {
        var n, d, p;
        const r = o.component.name || (o.component.selectedRelationships || []).join(","), s = {
          ...t,
          id: o.id,
          label: r,
          data: o
        };
        (n = this.graph) == null || n.addEdge(s), (p = (d = this.graphDialogRef) == null ? void 0 : d.value) == null || p.close(), setTimeout(() => {
          this.cellUpdate([o]);
        }, 10);
      });
    else {
      const o = (a = this.graph) == null ? void 0 : a.getCellById(e.id), r = o == null ? void 0 : o.data;
      r.component = i, this.apiUpdateEdge(r).then((s) => {
        var n, d;
        (d = (n = this.graphDialogRef) == null ? void 0 : n.value) == null || d.close(), this.cellUpdate([s]);
      });
    }
  }
  async edgeDel(e, t) {
  ...
  async cellUpdate(e = []) {
    e.forEach((t) => {
      var s, n, d, p;
      const i = t.id, a = (s = this.graph) == null ? void 0 : s.getCellById(i);
      if (!a)
        return;
      const o = _(a.data || {}, t), r = t.component.name || (t.component.selectedRelationships || []).join(",");
      a.prop("data", o), (n = this.graphShadow) == null || n.setLabel(a, r), (d = this.graphShadow) == null || d.setData(a, o), (p = this.graphShadow) == null || p.setStatus(a, o.status.aggregateSnapshot);
    });
  }
  //
  async groupRefresh() {
    this.refreshTimeHandle && clearInterval(this.refreshTimeHandle), console.log(".....groupRefresh"), this.refreshTimeHandle = setInterval(async () => {
      if (console.log(".......setInterval", this.groupRefreshCount), this.groupRefreshCount <= 0) {
        this.groupRefreshCount++;
        return;
      }
      this.groupRefreshCount--;
      try {
        const e = await this.apiGetGroupData(this.groupId), { processGroupFlow: t } = e, { flow: i } = t, { processors: a, connections: o, processGroups: r, outputPorts: s, labels: n, inputPorts: d, funnels: p } = i;
        this.cellUpdate(a), this.cellUpdate(o), this.cellUpdate(r), this.cellUpdate(p);
      } catch (e) {
        console.warn(e);
      }
