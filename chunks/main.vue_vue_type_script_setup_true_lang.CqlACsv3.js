import { unref as g, computed as q, useAttrs as B, ref as z, toRef as j, h as O, onUnmounted as K, defineComponent as H, useSlots as Q, reactive as M, onMounted as N, watch as $, onBeforeUnmount as Y, openBlock as J, createElementBlock as X, createVNode as Z } from "vue";
import { a as P, E as ee } from "./main.DROQpkh8.js";
import { aE as te, a$ as G, V as b, ad as D, g as y, b0 as L, b1 as I, b2 as se, b3 as re, au as T, C as oe, av as ne, b4 as S, y as le, aw as ce, b5 as ae, x as ie, ar as ue, aL as fe, aA as de, o as me, aQ as he, b6 as pe, aP as ge } from "./vendor.jH9g53BU.js";
const k = (n = [], e = () => {
}, t = {}) => {
...
((n) => {
  n.buildRules = (e) => {
    const t = g(e.required) ?? !1, o = g(e.trigger) ?? "blur", s = b(e, "message") ? P.getExpValue(g(e.message), e) : b(e, "label") ? P.getExpValue(w.required, e) : "", r = D(g(e.rules)) ? [...g(e.rules)] : [], u = Object.keys(w), a = [];
    let l = !1;
    return r.forEach((c) => {
      var m;
      const i = { ...g(c) }, f = ((m = u.filter((h) => b(i, h))) == null ? void 0 : m[0]) || "common", d = i.message || g(e.message) || b(e, "label") ? y(w, f) : "";
...
const ye = A.buildRules, ke = A.buildElFormItemProps, Fe = A.isNeedElFormItem, ve = ({ tag: n, parent: e }) => n || (e && b(V, S(e.tagname)) ? V[S(e.tagname)] : le), _e = (n) => {
  ...
  setup(n, { expose: e, emit: t }) {
    const o = t, s = n, r = j(s, "modelValue"), u = Q(), a = typeof g(r) != "object", l = a ? M({}) : M(r.value);
    let c = !1;
    const i = () => {
    ...
    const d = M(/* @__PURE__ */ new Set()), m = { formProps: d, formData: l, emitChange: f }, p = (s.UIPluging || Ae)(s, m, { slots: u });
    if (s.autoClean) {
      let E = [];
      N(() => {
        E = Array.from(d);
        ...
        R.length > 0 && (R.forEach((x) => I(g(l), x)), E = _, o("update:modelValue", g(l)));
      });
    }
