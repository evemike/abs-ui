...
import { defineComponent as U, useSlots as G, toRefs as J, ref as n, shallowRef as S, watch as x, onMounted as K, openBlock as d, createElementBlock as g, createElementVNode as c, normalizeClass as W, renderSlot as V, normalizeStyle as q, withDirectives as Q, createVNode as X, unref as l, createCommentVNode as _, createBlock as Y, vShow as Z, markRaw as ee } from "vue";
import { aH as te, aI as oe, aJ as ae, aK as i, aL as T, aM as B, aC as le, f as H, P as se, aN as re } from "./vendor.ufXmPQRI.js";
...
const we = {
  ...
  setup(L, { expose: R, emit: M }) {
    const D = M, N = L;
    G(), ae();
    const { modelValue: b, showOperate: O, theme: C, format: r, teleport: ge, dialog: _e, dialogTitle: be, lang: f } = J(N), k = n(), m = n();
    n();
    const s = S(), u = S();
    let a = b.value || "";
    const o = n(!0), E = n("");
    ...
    return x(b, (e) => {
      ...
      c("div", {
        ...
        ref: k,
        class: W(["_mask", { "is-visible": o.value }])
      }, [
        c("div", de, [
