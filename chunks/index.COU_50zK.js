...
var $e = (n, e, t) => e in n ? _e(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t;
var C = (n, e, t) => ($e(n, typeof e != "symbol" ? e + "" : e, t), t);
import "../css/index-CX9pL3kB.css";
import { defineComponent as X, inject as e1, shallowRef as R, computed as M, onMounted as re, openBlock as F, createElementBlock as b, normalizeClass as Ee, createBlock as S, unref as c, createCommentVNode as J, createStaticVNode as t1, createElementVNode as E, watch as te, mergeProps as Fe, withCtx as V, Fragment as j, renderList as ae, ref as Q, toRefs as pe, createVNode as N, toDisplayString as K, withModifiers as He, createTextVNode as ge, normalizeStyle as Ve, resolveDynamicComponent as i1, withDirectives as Oe, vShow as Ke, toRef as o1, provide as le, markRaw as $, render as a1, h as Ue, onUnmounted as r1 } from "vue";
import { g as v, M as s1, o as W, q as be, k as z, t as n1, x as l1, y as c1, z as d1, A as p1, B as Ye, C as A1, d as I, D as ie, G as Be, F as h1, f as oe, H as Qe, I as Je, J as Te, K as P, L as De, N as Ze, O as C1, P as g1, Q as Y, R as f1, S as ee, T as u1, s as w1, U as m1, V as B1, W as y1, X as ve, Y as E1, i as F1, h as Q1, Z as D1, _ as I1, $ as M1, a0 as H1, a1 as b1, a2 as v1, a3 as S1, a4 as L1, a5 as x1, a6 as k1, a7 as T, a8 as N1, a9 as G1, aa as R1, ab as ye, ac as U, ad as P1, ae as Se, n as fe, af as V1, ag as ce, e as Z, ah as O1, ai as K1, aj as U1, ak as Le, al as Y1, am as J1, an as T1, ao as Z1, ap as j1 } from "./vendor.3EV9Wvnx.js";
import { E as _ } from "./main.B-m_TxZg.js";
import { _ as ue } from "./main.vue_vue_type_script_setup_true_lang.CnKtBnHt.js";
import { _ as q1 } from "./_plugin-vue_export-helper.CHgC5LLL.js";
import { _ as de, E as z1 } from "./main.vue_vue_type_script_setup_true_lang.BE2wO8F3.js";
import { _ as W1 } from "./view.vue_vue_type_style_index_0_lang.Citm7Yqz.js";
import { _ as X1, a as _1 } from "./main.vue_vue_type_script_setup_true_lang.DYW0Qm6f.js";
import { _ as $1 } from "./main.vue_vue_type_style_index_0_lang.BIAzF8Gy.js";
const et = /* @__PURE__ */ X({
  __name: "node",
  props: {
    node: {},
  ...
  setup(n) {
    const e = n, { node: t } = e, i = e1("GRAPH-CONTEXT"), { graphForm: a, graphShadow: o } = i, r = R(), s = M(() => {
      const g = ((o == null ? void 0 : o.selectedCells.value) || []).map((w) => w.id);
      return !!(g.length > 0 && g.includes((t == null ? void 0 : t.id) || ""));
    }), l = M(() => {
      var w;
      const h = t == null ? void 0 : t.id, g = (w = o == null ? void 0 : o.currentCell.value) == null ? void 0 : w.id;
      return !!(h && g && h == g);
    }), A = M(() => {
      const h = o == null ? void 0 : o.get(t);
      return v(h, "metadata.status.aggregateSnapshot.runStatus") || "";
    }), p = R({});
    return re(() => {
      var h;
      p.value = { ...o == null ? void 0 : o.get(t), STEP_LIB: nt, formStatus: a == null ? void 0 : a.getCellStatus(t) }, p.value.node = t, r.value = ((h = p.value.metadata) == null ? void 0 : h.markup) || (o == null ? void 0 : o.defaultNodeMarkup);
    }), (h, g) => (F(), b("div", {
      class: Ee(["default_node_style", A.value, { "is-selected": s.value, "is-current": l.value }])
    }, [
      r.value ? (F(), S(c(_), {
        key: 0,
        elem: r.value,
        params: p.value
      }, null, 8, ["elem", "params"])) : J("", !0)
    ], 2));
  }
}), tt = [
  {
...
Note: This Processor expects CEF messages WITHOUT the syslog headers (i.e. starting at "CEF:0"`,
  ...
  connecting: {
    ...
    validateMagnet({ magnet: n }) {
      return n.getAttribute("port-group") !== "left";
    },
    validateConnection({
      sourceCell: n,
      targetCell: e,
      ...
      var p, h;
      const o = (p = t == null ? void 0 : t.getAttribute("port")) == null ? void 0 : p.split("."), r = (h = i == null ? void 0 : i.getAttribute("port")) == null ? void 0 : h.split(".");
      if (!o || !r || o[0] == "in" || r[0] == "out" || (o[1] || r[1]) && o[1] != r[1])
        return !1;
      const s = this.getEdges().filter((g) => g != a), l = s.filter((g) => g.getSourceCell() == n).length, A = s.filter((g) => g.getTargetCell() == e).length;
      return !(o[2] && be(o[2]) && l >= Number(o[2]) || r[2] && be(r[2]) && A >= Number(r[2]));
    }
  },
  highlighting: {
  ...
  // 
  defaultLabel: {
    markup: s1.getForeignObjectMarkup(),
    attrs: {
      fo: {
        width: 30,
        height: 30,
  ...
  left: { position: "left", attrs: Ce },
  top: { position: "top", attrs: Ce },
  bottom: { position: "bottom", attrs: Ce },
  right: { position: "right", attrs: Ce },
  "arrow-left": {
    position: { name: "left" },
    markup: [
      {
  ...
  running: { bc: "#67C23A", c: "#67C23A" },
  stop: { bc: "#409EFF", c: "#409EFF" },
  loading: { bc: "#909399", c: "#999" },
  invalid: { bc: "#E6A23C", c: "#E6A23C" },
  init: { bc: "#fff", c: "#666" },
  disabled: { bc: "#bbb", c: "#bbb" }
}, Ie = {
  tag: "div",
  class: "_default-node",
  ":class": "step",
  cls: [
    {
      ...
      cls: [
        { tag: z, "v-if": ({ step: n }) => c(n) == "loading", color: "#909399", class: "_node-step is-loading", cls: { tag: n1 } },
        { tag: z, "v-if": ({ step: n }) => c(n) == "running", color: "#67C23A", class: "_node-step is-loading", cls: { tag: l1 } },
        { tag: z, "v-if": ({ step: n }) => c(n) == "invalid", color: "#E6A23C", class: "_node-step", cls: { tag: c1 } },
        { tag: z, "v-if": ({ step: n }) => c(n) == "stop", color: "#409EFF", class: "_node-step", cls: { tag: d1 } },
        { tag: z, "v-if": ({ step: n }) => c(n) == "disabled", color: "#bbb", class: "_node-step", cls: { tag: p1 } },
        { tag: z, cls: { tag: ue, ":name": "icon" } }
      ]
    },
    {
      tag: "div",
      ...
      cls: [
        {
          ...
          cls: [
            { tag: z, "#reference": "", class: "_node-tip-icon", cls: { tag: A1 } },
  ...
  cls: [
    { tag: "div", cls: [
      { tag: "b", class: "_title", cls: [{ tag: z, cls: { tag: ue, ":name": "data.icon" } }, "{{ data.label || '' }}"] }
      // { tag: "b", "@click": "() => close()", class: "_btn", cls: { tag: ElIcon, class: "_close", cls: Close } }
    ] },
    { tag: "div", class: "", cls: [
      { tag: I, "@click": ({ graphEvents: n, close: e, cell: t }) => {
        e() && n.eventCall("drawer:cancel", t);
      }, cls: "取消" },
      { tag: I, "@click": ({ graphEvents: n, close: e, cell: t }) => {
        n.eventCall("drawer:submit", t, e);
      }, type: "primary", cls: "确定" }
    ] }
  ]
}, ct = [
  {
    ...
    icon: oe,
    cls: "删除",
    "@click": ({ cell: n, graph: e, contextmenu: t }) => {
      e.removeCell(n), t.close();
    }
  }
], dt = [
  {
...
], pt = [
  {
    ...
    icon: Qe,
    cls: "全选",
    "@click": ({ graph: n, contextmenu: e }) => {
      n == null || n.trigger("cell:selectAll"), e.close();
    }
  },
  {
    tag: I,
    ...
    "@click": ({ graph: n, contextmenu: e, selectedCells: t, ElMessage: i }) => {
      t.value.length > 0 ? (n.cleanClipboard(), n.copy(t.value), e.close()) : i.warn("请先选中元素后再复制");
    }
  },
  {
    tag: I,
    ...
    "@click": ({ graph: n, contextmenu: e, clipboardCells: t }) => {
      const i = n.paste({ offset: 100 });
  ...
  { tag: P },
  {
    ...
    cls: "适合画布",
    "@click": ({ graph: n, contextmenu: e }) => {
      n.zoomToFit({ padding: { left: 50, top: 50, right: 50, bottom: 100 } }), e.close();
    }
  }
];
it.newProcessorTypes.filter((n) => n.type.includes("ConsumeAMQP") || n.type.includes("ConsumeIMAP") || n.type.includes("ConsumeJMS")).map((n) => {
  const e = n.type.split(".").pop();
  return {
    name: "test-node",
    shape: "vue-node",
    ...
    tabs: [
      {
        label: "基础信息",
        type: "elem",
        elem: { tag: W, prop: "node.label", ":modelValue": "label", "@update:modelValue": ({ label: t, $: i }) => {
          t.value = i[0];
        } }
      },
      {
        ...
        column: [
          ...
          { prop: "type", label: "类型", value: `${e} ${n.bundle.version}`, required: !0, trigger: "change", message: "{{prop}} {{label}} is required!" },
          { prop: "code", label: "编码", value: "input.C.A", required: !0, rules: [{ required: !1 }, { min: 20 }] },
          { prop: "package", label: "打包", value: ` ${n.bundle.group} - ${n.bundle.artifact}` }
...
function mt(n, e) {
  return F(), b("svg", gt, wt);
}
const Bt = /* @__PURE__ */ q1(Ct, [["render", mt]]), yt = /* @__PURE__ */ X({
  __name: "drawer",
  props: {
    context: {},
    config: { default: () => ({
  ...
  setup(n) {
    const e = n, { config: t, context: i } = e, { graphShadow: a, graphForm: o } = i, r = a.currentCell;
    te(r, (y) => {
      y == null && o.closeDrawer();
    });
    const s = M(() => {
      var y;
      return ((y = r.value) == null ? void 0 : y.id) || "";
    }), l = M(() => a.get(r.value) || {}), A = M(() => (
      /* currentNode.value ? graphShadow.getByKey(currentNode.value,'tabHeader') : */
      lt
    )), p = M(() => r.value ? a.getTabs(r.value).value : []), h = M(() => p.value.map((y, u) => y.default ? "default-tab" : u + "")), g = M(() => ({ ...i, cell: r.value, data: r.value ? a.get(r.value) : {}, formStatus: r.value ? o.getCellStatus(r.value) : {} })), w = R(), m = f1((y, u) => {
      u && (w.value = u), o.validateForm(u || w.value, y);
    }, 100);
    return (y, u) => (F(), S(c(Ze), Fe({
      "modal-class": "_graph-drawer",
      "text-14": ""
    }, c(t), {
      modelValue: c(o).visible.value,
      "onUpdate:modelValue": u[5] || (u[5] = (d) => c(o).visible.value = d)
    }), {
      header: V(({ close: d, titleId: f, titleClass: B }) => [
        s.value ? (F(), S(c(_), {
          key: s.value,
          elem: A.value,
          params: g.value,
          context: { params: { close: d, titleId: f, titleClass: B } }
        }, null, 8, ["elem", "params", "context"])) : J("", !0)
      ]),
      default: V(() => [
        p.value.length > 0 ? (F(), b(j, { key: 0 }, [
          p.value.length > 1 ? (F(), S(c(C1), {
            "model-value": "default-tab",
            key: s.value
          }, {
            default: V(() => [
              (F(!0), b(j, null, ae(p.value, (d, f) => (F(), S(c(g1), {
                key: f + "-" + s.value,
                name: h.value[f],
                label: d.label
              }, {
                default: V(() => [
                  d.prop != null ? (F(), S(c(de), {
                    key: 0,
                    ref_for: !0,
                    ref: (B) => w.value = B,
                    onChange: () => c(m)(d),
                    "model-value": c(v)(c(o).data.value[s.value], d.prop),
                    "onUpdate:modelValue": (B) => {
                      const D = {};
                      c(Y)(D, d.prop, B), c(o).resetCellFormData(s.value, D);
                    },
                    params: g.value,
                    column: d.column,
                    elForm: { disabled: l.value.step.value == "running" }
                  }, null, 8, ["onChange", "model-value", "onUpdate:modelValue", "params", "column", "elForm"])) : d.type === "form" ? (F(), S(c(de), {
                    key: 1,
                    ref_for: !0,
                    ref: (B) => w.value = B,
                    modelValue: c(o).data.value[s.value],
                    "onUpdate:modelValue": u[0] || (u[0] = (B) => c(o).data.value[s.value] = B),
                    onChange: () => c(m)(d),
                    params: g.value,
                    column: d.column,
                    elForm: { disabled: l.value.step.value == "running" }
                  }, null, 8, ["modelValue", "onChange", "params", "column", "elForm"])) : (F(), S(c(_), {
                    key: 2,
                    elem: d.elem,
                    params: g.value,
                    context: { params: { index: f } }
            ...
            p.value[0].prop != null ? (F(), S(c(de), {
              key: 0,
              ref: (d) => w.value = d,
              onChange: u[1] || (u[1] = () => c(m)(p.value[0])),
              "model-value": c(v)(c(o).data.value[s.value], p.value[0].prop),
              "onUpdate:modelValue": u[2] || (u[2] = (d) => {
                const f = {};
                c(Y)(f, p.value[0].prop, d), c(o).resetCellFormData(s.value, f);
              }),
              params: g.value,
              column: p.value[0].column
            }, null, 8, ["model-value", "params", "column"])) : p.value[0].type === "form" ? (F(), S(c(de), {
              key: 1,
              ref: (d) => w.value = d,
              onChange: u[3] || (u[3] = () => c(m)(p.value[0])),
              "model-value": c(o).data.value[s.value],
              "onUpdate:modelValue": u[4] || (u[4] = (d) => c(o).resetCellFormData(s.value, d)),
              params: g.value,
              column: p.value[0].column
            }, null, 8, ["model-value", "params", "column"])) : (F(), S(c(_), {
              key: 2,
              elem: p.value[0].elem,
              params: g.value,
...
class Et {
  ...
  constructor(e) {
    ...
    C(this, "contextmenuRef");
    C(this, "containerBox");
    //
    C(this, "graph");
    C(this, "events", {});
    //
    C(this, "currentKeydown", /* @__PURE__ */ new Set());
    C(this, "selectedCells", R([]));
    C(this, "clipboardCells", R([]));
    C(this, "clickHandle");
  ...
  blank() {
    ...
    (e = this.graph) == null || e.on("blank:click", (i) => {
      ...
      var s, l;
      const { x: a, y: o } = i, r = (s = this.graph) == null ? void 0 : s.localToGraph({ x: a, y: o });
      (l = this.contextmenuRef.value) == null || l.open(r), this.eventCall("blank:contextmenu", i);
    });
  }
  // 公共事件
  cell() {
    var e, t, i, a, o, r, s, l;
    (e = this.graph) == null || e.on("cell:added", (A) => {
      const { cell: p } = A;
      console.log(".............", p.id), this.graphShadow.initCell(p), this.graphForm.initCell(p).validateCell(p), this.eventCall("cell:added", A), this.eventCall("init:cell", p), p.isEdge() && this.eventCall("init:edge", p), p.isNode() && this.eventCall("init:node", p);
    }), (t = this.graph) == null || t.on("cell:click", (A) => {
      var p;
      (p = this.contextmenuRef.value) == null || p.close(), this.currentKeydown.has("Control") || this.graphShadow.clearSelectedCells(), this.eventCall("cell:click", A);
    }), (i = this.graph) == null || i.on("cell:mouseenter", (A) => {
      this.eventCall("cell:mouseenter", A);
    }), (a = this.graph) == null || a.on("cell:mouseleave", (A) => {
      this.eventCall("cell:mouseleave", A);
    }), (o = this.graph) == null || o.on("cell:selected", (A) => {
      const { cell: p } = A;
      this.currentKeydown.has("Control") ? (this.graphShadow.toggleSelectedCell(p), this.eventCall("cell:selected", A)) : this.graphShadow.clearSelectedCells();
    }), (r = this.graph) == null || r.on("cell:unselected", (A) => {
      const { cell: p } = A;
      this.graphShadow.delSelectedCell(p), this.eventCall("cell:unselected", A);
    }), (s = this.graph) == null || s.on("cell:contextmenu", (A) => {
      var m, y;
      const { cell: p, x: h, y: g } = A, w = (m = this.graph) == null ? void 0 : m.localToGraph({ x: h, y: g });
      (y = this.contextmenuRef.value) == null || y.open(w, p), this.eventCall("cell:contextmenu", A);
    }), (l = this.graph) == null || l.on("cell:selectAll", () => {
      var p, h;
      const A = (p = this.graph) == null ? void 0 : p.getCells();
      A && A.length > 0 && ((h = this.graph) == null || h.select(A), this.graphShadow.resetSelectedCells(A), this.eventCall("cell:selectAll", A));
    });
  }
  // 边连接事件
  edge() {
    ...
    (e = this.graph) == null || e.on("edge:added", (r) => {
      ...
      const { edge: s } = r;
      this.graphShadow.updateEdge(s), this.eventCall("edge:connected", r);
    }), (i = this.graph) == null || i.on("edge:contextmenu", (r) => {
      this.eventCall("edge:contextmenu", r);
    }), (a = this.graph) == null || a.on("edge:mouseenter", (r) => {
      const { edge: s } = r;
      s.attr("line/stroke", "#3685f288"), this.eventCall("edge:mouseenter", r);
    }), (o = this.graph) == null || o.on("edge:mouseleave", (r) => {
      const { edge: s } = r;
      s.attr("line/stroke", "#C0C7D0"), this.eventCall("edge:mouseleave", r);
    });
  }
  node() {
    var e, t, i, a, o, r, s;
    (e = this.graph) == null || e.on("node:click", (l) => {
      ...
      this.clickHandle = setTimeout(() => {
        if (console.log("++++++++++++++++++", (/* @__PURE__ */ new Date()).getTime()), this.currentKeydown.has("Control"))
          return;
        const { node: A } = l;
        this.graphShadow.resetCurrentCell(A), this.graphForm.openDrawer(), this.eventCall("node:click", l), this.clickHandle = void 0;
      }, 500);
    }), (t = this.graph) == null || t.on("node:removed", (l) => {
      const { node: A } = l;
      this.graphShadow.removeCells([A]), this.eventCall("node:removed", l);
    }), (i = this.graph) == null || i.on("node:added", (l) => {
      this.eventCall("node:added", l);
    }), (a = this.graph) == null || a.on("node:moved", (l) => {
      this.eventCall("node:moved", l);
    }), (o = this.graph) == null || o.on("node:selected", (l) => {
      this.eventCall("node:selected", l);
    }), (r = this.graph) == null || r.on("node:unselected", (l) => {
...
class Ft {
  constructor(e) {
    ...
    //
    C(this, "graph");
    C(this, "graphFormFailCells", /* @__PURE__ */ new Set());
    // 状态判断，当 size == 0 时则验证通过
    C(this, "data", Q({}));
    C(this, "status", /* @__PURE__ */ new Map());
    C(this, "cellColumn", /* @__PURE__ */ new Map());
    C(this, "visible", Q(!1));
    this.graphShadow = e, this.currentNode = e.currentCell, te(this.currentNode, (t, i) => {
  ...
  initCell(e) {
    const t = e.id;
    if (this.status.set(t, Q({ result: !0, info: [] })), ee(this.data.value, t) || (this.data.value[t] = {}), !this.cellColumn.has(t)) {
      const i = [], a = this.graphShadow.getTabs(e);
      for (const o of a.value)
        if (o.type == "form" && o.validate == !0) {
          const r = o.column || [], s = o.prop;
          s ? i.push({ prop: s, tag: "div", cls: r }) : i.push(...r);
        }
  ...
  getCellStatus(e) {
    return this.status.has(e.id) || this.status.set(e.id, Q({ result: !0, info: [] })), this.status.get(e.id);
  }
  // // 初始化节点表单
  // initNode(id:string){
  //   if(!has(this.data,id)){
  ...
  // }
  // 初始化 form 数据
  // initFormData(data: Record<string, Record<string, any>>) {
  //   // if (data) {
  //   //   this.data.value = { ...data }
  //   // }
  // }
  // initCellFormData(cell: Cell | string, data: Record<string, any> = {}) {
  //   const id = typeof cell === 'string' ? cell : cell.id;
  //   if (!has(this.data.value, id)) {
  ...
  validateForm(e, t) {
    this.currentNode.value && e && t && t.validate == !0 && e.validate((i, a) => {
      ...
      if (!o)
        return;
      if (i) {
        o.value = { result: !0, info: [] }, (s = this.currentNode.value) != null && s.id && this.graphFormFailCells.delete(this.currentNode.value.id);
        return;
      }
      (l = this.currentNode.value) != null && l.id && this.graphFormFailCells.add((A = this.currentNode.value) == null ? void 0 : A.id);
      const r = Object.keys(a).map((p) => a[p].map((h) => h.message)).flat(1);
      console.log(":::::validate:::::", i, a, r, o), o.value = { result: i, info: r };
    });
  }
  async validateCell(e) {
    const t = e.id, i = this.data.value[t] || {}, a = this.cellColumn.get(t) || [], { status: o, info: r } = await z1.valideForm(i, a), s = this.getCellStatus(e);
    if (!s)
      return;
    if (o) {
      s.value = { result: !0, info: [] }, this.graphFormFailCells.delete(t);
      return;
    }
    this.graphFormFailCells.add(t);
    const l = Object.keys(r).map((A) => r[A].map((p) => p.message)).flat(1);
  ...
  //
  resetCellId(e, t) {
    ee(this.data, e) && this.resetCellFormData(t, this.data.value[e]);
  }
  //
  getGraphFormData() {
    var i;
...
const Qt = { class: "_search" }, Dt = ["onMousedown", "title"], It = { class: "_label" }, Mt = /* @__PURE__ */ X({
  __name: "nodeList",
  props: {
  ...
  setup(n) {
    const e = n, t = Q(), { graph: i } = pe(e), { nodeList: a } = e, { initNodeFn: o } = e, r = Q(""), s = Q(), l = Q([]), A = u1(r, 500), p = M(() => {
      const w = A.value;
      let m = c(a) || [];
      w ? (m = m.filter(({ label: d, name: f, group: B }) => d.includes(w) || f.includes(w) || (B == null ? void 0 : B.includes(w))), l.value.push(...m.map((d) => d.group || ""))) : l.value = [];
      const y = [], u = [];
      for (const d of m) {
        const { group: f = "默认分组" } = d, B = y.indexOf(f);
        B > -1 ? u[B][1].push(d) : (y.push(f), u.push([f, [d]]));
      }
      return console.log("====>", m, u), u;
    }), h = () => {
      i.value && (s.value = new y1({
        target: i.value,
        dndContainer: t.value,
        getDragNode: (w) => w.clone({ keepId: !0 }),
        getDropNode: (w) => w.clone({ keepId: !0 })
      }));
    }, g = (w, m) => {
      var f;
      const y = i.value;
      if (!y)
        return;
      s.value || h(), w.shape || (w.shape = "vue-node"), w.ports || (w.ports = {});
      const u = w.ports;
      if (u.groups || (u.groups = je.groups), o) {
        try {
          o(w).then((B) => {
            var D;
            return (D = s.value) == null ? void 0 : D.start(y.createNode(B), m);
          });
        } catch (B) {
          console.warn(B);
        }
      ...
      (f = s.value) == null || f.start(y.createNode(d), m);
    };
    return re(() => {
      h();
    }), (w, m) => (F(), b("div", {
      ...
      N(c(m1), {
        ...
        default: V(() => [
          (F(!0), b(j, null, ae(p.value, ([y, u]) => (F(), S(c(B1), {
            key: y,
            title: y,
            name: y
          }, {
            default: V(() => [
              (F(!0), b(j, null, ae(u, (d) => (F(), b("div", {
                class: "_node_item",
                onMousedown: (f) => g(d, f),
                title: d.label
              }, [
                N(c(z), { class: "_icon" }, {
                  default: V(() => [
                    N(c(ue), {
                      name: d.icon || "#prep-virtual-node-font"
                    }, null, 8, ["name"])
                  ]),
                  _: 2
                }, 1024),
                E("span", It, K(d.label), 1)
              ], 40, Dt))), 256))
            ]),
            _: 2
          }, 1032, ["title", "name"]))), 128))
  ...
  let o = n;
  return t && (o = We(o, t)), i && (o = ze(o, i)), a && (o = qe(o, a)), o;
}, qe = (n, e) => {
  let t = {}, i = [...n];
  ...
  if (a) {
    let l = !1, A = 1;
    for (const p of a)
      l = l || p == null, t[A++] = p == null ? i : i.splice(0, p);
    l && i.length > 0 && (t[A] = i);
  } else if (o) {
    const l = new Array().concat(o), A = i.map((p) => ({ ...p, $_key: l.map((h) => v(p, h) || "").join() }));
    t = ve(A, "$_key");
  } else
    s ? t = ve(i, s) : r && (t = r(i));
  return t;
  ...
  return i && (t = E1(t, i)), a && (t = a(t)), o && (t = t.reverse()), t;
}, We = (n, e) => {
  let t = [...n];
  const { key: i = "id", blackList: a, whiteList: o, fn: r, items: s } = e;
  return a && (t = t.filter((l) => !a.includes(v(l, i)))), o && (t = t.filter((l) => o.includes(v(l, i)))), r && (t = t.filter((l) => r(l))), s && t.push(...s), t;
}, Ht = `## 组件使用说明
...
`, bt = { class: "_menu" }, vt = {
  ...
  setup(n, { expose: e }) {
    const t = n, { context: i } = t, { config: a } = pe(t), o = i == null ? void 0 : i.graphTools, r = i == null ? void 0 : i.markdownRef, s = [
      { title: "导出", key: "export", icon: F1, handle: () => o == null ? void 0 : o.export() },
      { title: "导入", key: "import", icon: Q1, handle: () => o == null ? void 0 : o.import() },
      { title: "撤销", key: "undo", icon: D1, handle: () => o == null ? void 0 : o.undo() },
      { title: "恢复", key: "redo", icon: I1, handle: () => o == null ? void 0 : o.redo() },
      { title: "放大", key: "zoomBig", icon: M1, handle: () => o == null ? void 0 : o.zoomBig() },
      { title: "缩小", key: "zoomSmall", icon: H1, handle: () => o == null ? void 0 : o.zoomSmall() },
      { title: "保存", key: "save", icon: Qe, handle: () => o == null ? void 0 : o.zoomSmall() },
      { title: "帮助", key: "help", icon: b1, handle: () => {
        var A;
        return (A = r == null ? void 0 : r.value) == null ? void 0 : A.init(Ht);
      } },
      { key: "fullscreen", title: M(() => o != null && o.isFullScreen.value ? "退出全屏" : "全屏"), type: M(() => o != null && o.isFullScreen.value ? "primary" : "default"), icon: De, handle: () => o == null ? void 0 : o.toggleFullScreen() }
    ], l = M(() => {
      const { elems: A = [], filter: p, order: h, group: g } = c(a) || {}, w = [...s, ...c(A)];
      let m = w;
      return p && (m = We(w, p)), h && (m = ze(m, h)), g && (m = qe(m, g)), console.log("menu - list = ", m, A, p, h, g, a.value), m && !Array.isArray(m) && (m = Object.keys(m).map((y) => v(m, y))), m;
    });
    return e({}), (A, p) => (F(), b("div", bt, [
      (F(!0), b(j, null, ae(l.value, (h) => (F(), b(j, null, [
        Array.isArray(h) ? (F(), b("div", vt, [
          (F(!0), b(j, null, ae(h, (g) => (F(), b(j, null, [
            g.tag ? (F(), S(c(_), {
              key: 0,
              elem: h,
              params: c(i)
            }, null, 8, ["elem", "params"])) : (F(), S(c(I), {
              key: 1,
              onClick: g.handle,
              title: g.title,
              icon: g.icon
  ...
  setup(n, { expose: e }) {
    const t = n, { config: i, context: a } = t, { elem: o } = pe(t), r = R(o.value || {}), { showFooter: s, ...l } = i, A = R(l), p = Q(!1);
    let h;
    const g = (d, f) => {
      h = f, d && (r.value = d), r.value && (p.value = !0);
    }, w = () => {
      p.value = !1;
    }, m = (d, f) => {
      typeof d == "string" ? A.value[d] = f : A.value = ie({}, l, d);
    }, y = () => {
      a.graphEvents.hasEvent("dialog:cancel") ? a.graphEvents.eventCall("dialog:cancel", h) : w();
    }, u = () => {
      a.graphEvents.hasEvent("dialog:submit") ? a.graphEvents.eventCall("dialog:submit", h) : w();
    };
    return te(o, (d) => {
      d && (r.value = d);
    }), e({
    ...
    }, A.value, { "destroy-on-close": "" }), {
      default: V(() => [
        N(c(_), {
          elem: r.value,
          params: c(a)
        }, null, 8, ["elem", "params"]),
        c(s) ? (F(), S(c(P), { key: 0 })) : J("", !0),
        c(s) ? (F(), b("div", Lt, [
          N(c(I), {
            onClick: He(y, ["stop"])
          }, {
...
class kt {
  constructor(e) {
    ...
    //
    C(this, "names", ["Transform", "Selection", "Clipboard", "History"]);
    //
    C(this, "plugins", {
      Transform: S1,
      Selection: L1,
...
class Nt {
  constructor(e = {}) {
    ...
    C(this, "mode", Q("edit"));
    //
    C(this, "cells", /* @__PURE__ */ new Map());
    //
    C(this, "currentCell", R());
    // 已选的节点集合
    C(this, "selectedCells", R([]));
    // 剪切板中复制的节点集合
    C(this, "clipboardCells", R([]));
    //
    C(this, "defaultNodeMarkup", Ie);
  ...
  initCell(e) {
    ...
    let a = v(i, "status.aggregateSnapshot.runStatus") || "";
    const o = {
      id: t.id,
      cell: t,
      status: Q({}),
      // step:ref("init"),
      step: Q(a === "Disabled" ? "disabled" : "init"),
      label: Q(t.prop("label") || i.label || ""),
      desc: Q(t.prop("desc") || i.desc || ""),
    ...
    t.isEdge() && (o.source = Q(((s = t == null ? void 0 : t.source) == null ? void 0 : s.cell) || ""), o.target = Q(((l = t == null ? void 0 : t.target) == null ? void 0 : l.cell) || ""), o.labelConfig = R({})), t.isNode() && (o.inCells = Q(/* @__PURE__ */ new Set()), o.outCells = Q(/* @__PURE__ */ new Set())), this.cells.set(t.id, o);
  }
  //
  updateEdge(e) {
  ...
  setLabel(e, t) {
    const i = this.get(e);
    i.label.value != t && (i.label.value = t);
  }
  setStatus(e, t) {
    const i = this.get(e);
    i.status.value = t;
  ...
  resetSelectedCells(e = []) {
    this.selectedCells.value = e, e.length > 0 ? T.success(`已选中 [ ${e.length} ] 个元素`) : T.info("取消选中");
  }
  //
  removeCells(e = []) {
    var i, a;
    ...
    for (const o of e) {
      if (o.isEdge()) {
        const r = o.id, s = this.get(o), l = s.source.value, A = s.target.value;
        l && ((i = this.cells.get(l)) == null ? void 0 : i.outCells.value).delete(r), A && ((a = this.cells.get(A)) == null ? void 0 : a.outCells.value).delete(r);
      }
      this.del(o);
    }
  ...
  resetClipboardCells(e = []) {
    this.clipboardCells.value = e, e.length > 0 && T.success(`已复制 [ ${e.length} ] 个元素`);
  }
  //
  addSelectedCell(e) {
...
class Gt {
  constructor(e) {
    ...
    //
    C(this, "zoomSize", 1);
    C(this, "zoomSpeed", 0.1);
    //
    C(this, "canUndo", Q(!1));
    C(this, "canRedo", Q(!1));
    C(this, "isFullScreen", Q(!1));
...
const Rt = {
  ...
  class: /* @__PURE__ */ Ee(["_running-box"])
}, Ot = /* @__PURE__ */ E("span", { style: { "--i": "1" } }, null, -1), Kt = /* @__PURE__ */ E("span", { style: { "--i": "2" } }, null, -1), Ut = /* @__PURE__ */ E("span", { style: { "--i": "3" } }, null, -1), Yt = /* @__PURE__ */ E("span", { style: { "--i": "4" } }, null, -1), Jt = /* @__PURE__ */ E("span", { style: { "--i": "5" } }, null, -1), Tt = /* @__PURE__ */ E("span", { style: { "--i": "6" } }, null, -1), Zt = /* @__PURE__ */ E("span", { style: { "--i": "7" } }, null, -1), jt = /* @__PURE__ */ E("span", { style: { "--i": "8" } }, null, -1), qt = /* @__PURE__ */ E("span", { style: { "--i": "9" } }, null, -1), zt = /* @__PURE__ */ E("span", { style: { "--i": "10" } }, null, -1), Wt = [
  Ot,
  Kt,
  Ut,
  Yt,
  ...
  setup(n) {
    var se, ne;
    const e = n, { edge: t, context: i } = e, { graphShadow: a, graph: o, graphForm: r } = i, s = M(() => {
      const k = e.config, G = a.getEdgeLabelConfig(t).value || {};
      return { enabled: !0, icon: 0, icons: [N1], prop: "edge", params: {}, title: "", ...k, ...G };
    }), { icon: l, prop: A, params: p } = c(s), h = r.getCellFormData(t), g = a.getEdgeData(t), w = g.source, m = g.target, y = g.step, u = g.label, d = (se = o.value) == null ? void 0 : se.getCellById(c(w)), f = (ne = o.value) == null ? void 0 : ne.getCellById(c(m)), B = Q(c(l)), D = M(() => {
      const k = s.value.icons[c(B)];
      return k.icon ? k : { icon: k };
    }), H = Q(!1), x = Q(!1);
    let L;
    const O = (k) => {
      window.clearTimeout(L), k === !1 ? L = setTimeout(() => {
        H.value = !1;
      }, 500) : H.value = !0;
    }, q = () => {
      const k = s.value.icons;
      if (c(k).length == 1)
        return;
      B.value >= k.length - 1 ? B.value = 0 : B.value++;
      const G = k[B.value];
      h[A] = typeof G == "string" ? B.value : G.value;
    };
    return re(() => {
    }), (k, G) => s.value.enabled ? (F(), b("div", Rt, [
      N(c(Ye), {
        placement: "top",
        width: "auto",
        teleported: !1,
        visible: x.value || H.value,
        ...
        reference: V(() => [
          E("div", {
            class: "_icon-box",
            onClick: q,
            onMouseenter: G[0] || (G[0] = () => O(!0)),
            onMouseleave: G[1] || (G[1] = () => O(!1))
          }, [
            E("span", {
              flex: "",
              "items-center": "",
              ...
              "rd-4": "",
              "p-x-4": "",
              style: Ve(c(u) ? "" : "border:none;padding:0;")
            }, [
              N(c(z), {
                class: Ee([]),
                "text-16": ""
        ...
        default: V(() => [
          E("div", {
            class: "_popover-box",
            onMouseenter: G[3] || (G[3] = () => O(!0)),
            onMouseleave: G[4] || (G[4] = () => O(!1))
          }, [
            E("div", Xt, [
              E("b", _t, K(s.value.title), 1),
              N(c(I), {
                link: "",
                type: x.value ? "primary" : "info",
                onClick: G[2] || (G[2] = (we) => x.value = !x.value)
              }, {
                icon: V(() => [
                  N(c(ue), {
                    name: "#icon-tuding",
            ...
            s.value.elem ? (F(), b("div", $t, [
              N(c(_), {
                elem: s.value.elem,
                params: { edge: c(t), sourceNode: c(d), targetNode: c(f), ...c(i), ...c(p) }
              }, null, 8, ["elem", "params"])
            ])) : J("", !0)
          ], 32)
        ]),
  ...
  setup(n, { expose: e }) {
    const i = o1(n, "value"), a = Q(i.value || ""), o = (h) => {
      /\.md$/.test(h) && fetch(h).then((g) => g.text()).then((g) => {
        A(g);
      });
    }, r = (h) => {
    }, s = async (h) => {
    ...
    return te(i, (h = "") => {
      ...
      default: V(() => [
        N(c(W1), { value: a.value }, null, 8, ["value"])
      ]),
      _: 1
    }, 8, ["modelValue"]));
  }
...
class ii {
  ...
  //
  initMenus() {
    const e = this.config.node || [], t = this.config.edge || [], i = this.config.blank || [], o = this.config.useDefaultMenu ?? !0 ? { node: [...dt], edge: [...ct], blank: [...pt] } : { node: [], edge: [], blank: [] };
    return e.length > 0 && (o.node = new Array().concat(e, o.node.length > 0 ? [{ tag: P }, o.node] : [])), t.length > 0 && (o.edge = new Array().concat(t, o.edge.length > 0 ? [{ tag: P }, o.edge] : [])), i.length > 0 && (o.blank = new Array().concat(i, o.blank.length > 0 ? [{ tag: P }, o.blank] : [])), o;
  }
  // 创建右键菜单
  createContextmenu(e, t) {
    var r;
    const i = t ? t.isNode() ? "node" : "edge" : "blank", a = t ? this.graphShadow.get(t) : {};
    let o = this.menus[i] || [];
    if (i === "node") {
      const s = (t == null ? void 0 : t.getData()) || {}, l = s == null ? void 0 : s.contextmenu;
      l && Array.isArray(l) && l.length > 0 && (o = [...l, { tag: P }, ...o]);
    }
    this.x.value = e.x + this.offset[0], this.y.value = e.y + this.offset[1], this.params.value = { ...this.context, ...a, graph: (r = this.graph) == null ? void 0 : r.value, contextmenu: this, selectedCells: this.graphShadow.selectedCells, clipboardCells: this.graphShadow.clipboardCells }, this.menu.value = { tag: "div", class: "_context-menu", cls: o }, this.key.value = (/* @__PURE__ */ new Date()).getTime(), this.visible.value = !0;
  }
  close() {
    this.visible.value = !1;
  }
...
const oi = /* @__PURE__ */ X({
  ...
  setup(n, { expose: e }) {
    ...
    return e({
      ...
      open: (r, s) => {
        i.createContextmenu(r, s);
      }
    }), (r, s) => Oe((F(), b("div", {
      class: "_contextmenu-box",
      contenteditable: "false",
      style: Ve(`position:absolute;z-index:9999;left:${c(i).x.value}px;top:${c(i).y.value}px`)
    }, [
      (F(), S(c(_), {
        key: c(i).key.value,
        elem: c(i).menu.value,
        params: c(i).params.value,
        context: { params: { ElMessage: c(T), ElNotification: c(G1) } }
      }, null, 8, ["elem", "params", "context"]))
    ], 4)), [
      [Ke, c(i).visible.value]
    ]);
  }
}), ai = { class: "_box-main" }, ri = { class: "_main-content" }, si = {
  name: "ElsX6"
}, ni = /* @__PURE__ */ X({
  ...si,
  props: {
    ...
    defaultNodeMarkup: { default: () => Ie },
    register: {},
    events: { default: () => ({}) },
    viewModel: { type: Boolean }
  },
  setup(n, { expose: e }) {
    const t = n, { viewModel: i, nodeListConfig: a } = pe(t), { graphConfig: o, menuConfig: r, pluginsConfig: s, contextmenuConfig: l, edgeLabelConfig: A, defaultNodeMarkup: p, register: h, events: g } = t, w = R1(), m = R(), y = Q(), u = Q(), d = Q(), f = Q(), B = Q(), D = Q(), H = Q(), x = Q(), L = new Nt().resetDefaultNodeMarkup(p), O = new Ft(L), q = new Et({ graphShadow: L, graphForm: O, contextmenuRef: D, events: g, containerBox: d }), se = new kt(s), ne = new Gt({ elsX6Ref: y }), k = {
      graph: m,
      graphShadow: L,
      graphForm: O,
      graphEvents: q,
    ...
    return le("GRAPH-SHADOW", L), le("GRAPH", m), le("GRAPH-FORM", O), le("GRAPH-MARKDOWN", f), le("GRAPH-CONTEXT", k), At(), ht(), h && h(Be), re(() => {
      const G = ie(ot, o);
      m.value = $(new Be({
        ...G,
        // 自定义 边的弹出展示
        onEdgeLabelRendered: (we) => {
          const { selectors: Ae, edge: he } = we, Me = Ae.foContent;
          Me && a1(
            Ue(ei, {
              edge: he,
              config: A,
        ...
        container: u.value
      })), se.usePlugins(m.value), L.setGraph(m.value), O.setGraph(m.value), ne.init(m.value), q.resetGraph(m.value).registerEvent().onMounted(k);
    }), e({
      graph: m
    }), (G, we) => {
      var Ae, he;
      return F(), b("div", {
        ...
        N(Bt),
        E("div", ai, [
          (Ae = c(a)) != null && Ae.enabled || !c(i) ? (F(), S(Mt, Fe({
            key: 0,
            graph: m.value
          }, c(a)), null, 16, ["graph"])) : J("", !0),
          E("div", ri, [
            ((he = c(r)) == null ? void 0 : he.enabled) !== !1 || !c(i) ? (F(), S(St, {
              key: 0,
              ref_key: "menuRef",
              ref: x,
              class: "_menu",
...
}), li = "/openmetadata-api", Xe = (n) => {
  const e = li + "/openMetadata/query", t = new FormData();
  return t.append("suffix", n), new Promise((i, a) => {
    fetch(e, { method: "POST", body: t }).then(async (o) => {
      const r = o.ok, s = await (r ? o.json() : o.text());
      r ? i(s) : a(s);
    }).catch((o) => a(o));
  });
}, ci = async () => {
  const n = "v1/services/messagingServices?fields=owner&limit=9999";
  try {
    return await Xe(n);
  } catch {
    return;
  ...
  const e = `v1/topics?service=${n}&fields=owner%2Ctags&include=non-deleted`;
  try {
    return await Xe(e);
  } catch {
    return;
  ...
  const e = Q({}), t = Q({}), i = Q([]), a = Q([]), o = Q([]), r = Q([]), s = "name", l = (n == null ? void 0 : n.kafkaOptionKey) || "connection.config.bootstrapServers", A = (n == null ? void 0 : n.topicOptionKey) || "name", p = (n == null ? void 0 : n.kafkaFormatKeys) || me[0], h = (n == null ? void 0 : n.topicFormatKeys) || me[1];
  ci().then((d) => {
    i.value = d.data, o.value = d.data.map((f) => ({ label: f.name, value: v(f, l), tag: $(ye) }));
  }), te(e, (d) => {
    const f = d == null ? void 0 : d.name;
    f && di(f).then((B) => {
      a.value = B.data, r.value = B.data.map((D) => ({ label: D.name, value: v(D, A), tag: $(ye) }));
    });
  }), te(t, () => {
  });
  const g = (d, f) => {
    ...
    if (v(e.value, l) != f) {
      e.value = i.value.filter((H) => v(H, l) == f)[0] || {};
      const D = p;
      Object.keys(D).forEach((H) => {
        const x = v(D, H), L = v(e.value, H);
        ee(c(d), x) && Y(d, x, L);
      }), console.log("setKafkaServer.................", d), y(d);
    }
  }, m = (d, f) => {
    t.value = a.value.filter((D) => v(D, A) == f)[0] || {};
    const B = h;
    Object.keys(B).forEach((D) => {
      const H = v(B, D), x = v(t.value, D);
      ee(c(d), H) && Y(d, H, x);
    });
  }, y = (d) => {
    t.value = {};
    ...
    Object.keys(f).forEach((B) => {
      const D = v(f, B);
      ee(c(d), D) && Y(c(d), D, null);
    });
  };
  return { valueKey: s, currentKafka: e, currentTopic: t, kafkaList: i, topicList: a, kafkaOptions: o, topicOptions: r, resetFormData: (d, f) => {
    const [B, D] = f;
    Object.keys(B).map((H) => {
      const x = B[H], L = v(c(e), H);
      L != null && Y(d, x, L);
    }), Object.keys(D).map((H) => {
      const x = D[H], L = v(c(t), H);
      L != null && Y(d, x, L);
    }), console.log(".... ==> ", d);
  }, setKafkaServer: w, setKafkaTopic: m, initKafkaServer: g, NIFI_FORMAT_KEYS: me };
}, { kafkaOptions: xe, topicOptions: ke, valueKey: ji, currentKafka: qi, currentTopic: zi, resetFormData: Wi, NIFI_FORMAT_KEYS: Xi, setKafkaServer: Ne, setKafkaTopic: Ge, initKafkaServer: _i } = pi(), Ai = {
  "org.apache.nifi.processors.kafka.pubsub.ConsumeKafka_2_6": {
    "bootstrap.servers": { tag: $(U), filterable: !0, allowCreate: !0, defaultFirstOption: !0, cls: xe, ":modelValue": "formData['bootstrap.servers']", "@update:modelValue": ({ formData: n, $: e }) => Ne(n, e[0]) },
    topic: { tag: $(U), filterable: !0, allowCreate: !0, defaultFirstOption: !0, cls: ke, ":modelValue": "formData['topic']", "@update:modelValue": ({ formData: n, $: e }) => Ge(n, e[0]) }
  ...
  "org.apache.nifi.processors.groovyx.ExecuteGroovyScript": {
    "groovyx-script-body": { type: "code", attr: { dialogTitle: "groovyx-script-body" } }
  }
}, { copy: Re } = P1(), hi = (n, e, t) => {
  const i = n.relationships, a = t.that, o = t.modelValue;
  t.id;
  const r = n.outPorts, s = e.inPorts;
  return {
    tag: "div",
    cls: [
      {
        ...
        column: [
          // 基础信息
          { tag: W, label: "名称", prop: "name", value: "" },
          { tag: W, label: "编号", prop: "id", disabled: !0 },
          //
          { tag: U, label: "从输出", prop: "source.id", "v-if": r.length > 0, cls: r.map((l) => ({ value: l.id, label: l.component.name })) },
          { tag: U, label: "输入", prop: "destination.id", "v-if": s.length > 0, cls: s.map((l) => ({ value: l.id, label: l.component.name })) },
          // 连线规则 关系
          { tag: Se, label: "输出数据流", value: i.length == 1 ? [i[0].name] : [], "v-if": i.length > 0, required: !0, prop: "selectedRelationships", cls: i.map((l) => ({ tag: fe, label: l.name, title: l.description })) },
          // 优先级
          { tag: Se, label: "优先级设置器", prop: "prioritizers", cls: a.prioritizers.map((l) => ({ tag: fe, label: l.type, cls: l.type.split(".").reverse()[0] })) },
          //
          { tag: W, label: "FlowFile 过期时间", prop: "flowFileExpiration", value: "0 sec" },
          //
          { tag: W, label: "背压对象阈值", prop: "backPressureObjectThreshold", value: "1000", rules: [{ pattern: /^\d+(\.\d+)?$/, message: "只能输入数字" }] },
          { tag: W, label: "背压大小阈值", prop: "backPressureDataSizeThreshold", value: "1 GB" },
          //
          { tag: U, label: "负载均衡策略", prop: "loadBalanceStrategy", value: "DO_NOT_LOAD_BALANCE", cls: [{ label: "do not load balance", value: "DO_NOT_LOAD_BALANCE" }, { label: "partition by attribute", value: "PARTITION_BY_ATTRIBUTE" }, { label: "round robin", value: "ROUND_ROBIN" }, { label: "single node", value: "SINGLE_NODE" }] },
          { tag: W, label: "属性名称", prop: "loadBalancePartitionAttribute", value: "", "v-if": ({ formData: l }) => l.value.loadBalanceStrategy == "PARTITION_BY_ATTRIBUTE" },
          {
            tag: U,
            label: "负载均衡压缩",
            prop: "loadBalanceCompression",
            "v-if": ({ formData: l }) => l.value.loadBalanceStrategy != "DO_NOT_LOAD_BALANCE",
  ...
  const e = n.groupBreadcrumb, t = e.length - 1, i = e.map((a, o) => ({ tag: I, link: !0, key: "elem", type: o == t ? "primary" : "success", cls: a.name, "@click": () => {
    n.initGraph(a.id);
  }, disabled: o == t, style: o == t }));
  if (i.length > 1) {
    const a = i.length - 1;
    for (let o = a; o > 0; o--)
      i.splice(o, 0, { tag: "i", key: "elem", cls: ">" });
  }
  return i.push({
    tag: "div",
    cls: []
  ...
  useDefaultMenu: !1,
  node: [
    { tag: I, link: !0, icon: Z, cls: "开始", "v-if": ({ status: t }) => c(t).runStatus == "Stopped", "@click": ({ cell: t, contextmenu: i }) => n.nodeRun(t, i) },
    { tag: I, link: !0, icon: Z, cls: "停止", "v-if": ({ status: t }) => c(t).runStatus == "Running", "@click": ({ cell: t, contextmenu: i }) => n.nodeStop(t, i) },
    { tag: I, link: !0, icon: Z, cls: "执行一次", "v-if": ({ status: t, cell: i }) => c(t).runStatus == "Stopped" && n.nodeType(i) == "PROCESS", "@click": ({ cell: t, contextmenu: i }) => n.nodeRunOnce(t, i) },
    { tag: I, link: !0, icon: Z, cls: "校验", "v-if": ({ cell: t, status: i }) => n.nodeType(t) == "PROCESS" && c(i).runStatus != "Running", "@click": ({ cell: t, contextmenu: i }) => n.nodeCheck(t, i) },
    //
    { tag: P, "v-if": ({ status: t }) => c(t).runStatus != "Invalid" },
    //
    { tag: I, link: !0, icon: Z, cls: "查看", "v-if": ({ status: t }) => c(t).runStatus == "Running", "@click": ({ cell: t, contextmenu: i }) => n.nodeEdit(t, i) },
    { tag: I, link: !0, icon: Z, cls: "编辑", "v-if": ({ cell: t, status: i }) => n.nodeType(t) != "FUNNELS" && c(i).runStatus != "Running", "@click": ({ cell: t, contextmenu: i }) => n.nodeEdit(t, i) },
    { tag: P, "v-if": ({ cell: t }) => n.nodeType(t).includes("PROCESS") },
    { tag: I, link: !0, icon: Z, cls: "查看历史", "v-if": ({ cell: t }) => ["PROCESS", "PROCESS-GROUP"].includes(n.nodeType(t)), "@click": ({ cell: t, contextmenu: i }) => n.initCellHistory(t, i) },
    // { tag: ElButton, link: true, icon: Edit, cls: "查看状态", "v-if": ({ cell }: any) => adapter.nodeType(cell).includes("PROCESS"), "@click": ({ cell, contextmenu }: any) => adapter.initNodeStatus(cell, contextmenu) },
    { tag: P },
    {
      tag: I,
      link: !0,
      ...
      "@click": ({ cell: t, contextmenu: i, graph: a, graphShadow: o }) => {
        const s = o.get(t).step;
        n.nodeDisable(t, i, s.value == "disabled");
      }
    },
    { tag: P },
    { tag: I, link: !0, icon: oe, cls: "删除", "@click": ({ cell: t, contextmenu: i }) => n.nodeDel(t, i) },
    { tag: I, link: !0, icon: oe, cls: "批量删除", "v-if": ({ selectedCells: t }) => t.value.length > 1, "@click": ({ selectedCells: t, contextmenu: i }) => n.nodesDel(t.value, i) }
  ],
  edge: [
    { tag: I, link: !0, icon: Z, cls: "列出队列", "@click": ({ cell: t, contextmenu: i }) => n.initCellHistory(t, i) },
    { tag: I, link: !0, icon: Z, cls: "清空队列", "@click": ({ cell: t, contextmenu: i }) => n.initCellHistory(t, i) },
    { tag: P },
    { tag: I, link: !0, icon: Z, cls: "查看历史", "@click": ({ cell: t, contextmenu: i }) => n.initCellHistory(t, i) },
    { tag: P },
    { tag: I, link: !0, icon: Z, cls: "编辑", "@click": ({ cell: t, contextmenu: i }) => n.edgeEdit(t, i) },
    { tag: P },
    { tag: I, link: !0, icon: oe, cls: "删除", "@click": ({ cell: t, contextmenu: i }) => n.edgeDel(t, i) }
  ],
  blank: [
    { tag: I, link: !0, icon: Qe, cls: "全选" },
    { tag: I, link: !0, icon: Je, cls: "复制", ":disabled": "selectedCells.length == 0" },
    { tag: I, link: !0, icon: Te, cls: "粘贴", ":disabled": "clipboardCells.length == 0" },
    { tag: P },
    {
      tag: I,
      link: !0,
      icon: De,
      cls: "适合画布",
      "@click": ({ graph: t, contextmenu: i }) => {
        t.zoomToFit({ padding: { left: 50, top: 50, right: 50, bottom: 100 } }), i.close();
      }
    },
    { tag: P },
    { tag: I, link: !0, icon: oe, cls: "批量删除", "v-if": ({ selectedCells: t }) => t.value.length > 1, "@click": ({ selectedCells: t, contextmenu: i }) => n.nodesDel(t.value, i) }
  ...
  if (!t)
    return;
  const i = (h = e.graphShadow) == null ? void 0 : h.get(n), a = (g = e.graphShadow) == null ? void 0 : g.get(i.source.value), o = (w = e.graphShadow) == null ? void 0 : w.get(i.target.value), r = e.nodeType(a), s = e.nodeType(o), l = t.component, A = l.source, p = l.destination;
  return {
    tag: "div",
    class: "_edge-label-box",
    cls: [
      { tag: "fieldset", class: "_node-box _source-node", cls: [
        { tag: "legend", cls: a.label },
        { tag: "div", "v-if": r == "PROCESS", cls: [
          { tag: "p", cls: ["输入", { tag: "b", cls: M(() => a.status.value.input) }] },
          { tag: "p", cls: ["读/写", { tag: "b", cls: M(() => `${a.status.value.read} / ${a.status.value.written}`) }] },
          { tag: "p", cls: ["输出", { tag: "b", cls: M(() => a.status.value.output) }] },
          { tag: "p", cls: ["任务/时间", { tag: "b", cls: M(() => `${a.status.value.tasks} / ${a.status.value.tasksDuration}`) }] }
        ] }
      ] },
      {
        tag: "div",
        class: "_edge-box",
        cls: [
          { tag: "p", "v-if": A.type == "OUTPUT_PORT", cls: ["从", { tag: "b", cls: A.name }] },
          { tag: "p", "v-if": p.type == "INPUT_PORT", cls: ["到", { tag: "b", cls: p.name }] },
          { tag: "p", "v-if": i.label, cls: ["名称", { tag: "b", cls: i.label }] },
          { tag: "p", cls: ["排队等待", { tag: "b", cls: M(() => i.status.value.queued) }] }
        ]
      },
      { tag: "fieldset", class: "_node-box _target-node", cls: [
        { tag: "legend", cls: o.label },
        { tag: "div", "v-if": s == "PROCESS", cls: [
          { tag: "p", cls: ["输入", { tag: "b", cls: M(() => o.status.value.input) }] },
          { tag: "p", cls: ["读/写", { tag: "b", cls: M(() => `${o.status.value.read} / ${o.status.value.written}`) }] },
          { tag: "p", cls: ["输出", { tag: "b", cls: M(() => o.status.value.output) }] },
          { tag: "p", cls: ["任务/时间", { tag: "b", cls: M(() => `${o.status.value.tasks} / ${o.status.value.tasksDuration}`) }] }
        ] }
      ] }
    ]
  };
  ...
  var w, m;
  const t = n.data, i = t.component.type, a = e.nodeType(n), o = ((m = (w = t.component) == null ? void 0 : w.config) == null ? void 0 : m.descriptors) || {}, r = Ai[i], s = a == "PROCESS" && o ? Object.keys(o).map((y) => {
    const u = o[y], d = u.name, f = u.displayName, B = u.description, D = u.required, H = u.dependencies.length > 0 ? "select" : "string", x = H == "select" ? u.dependencies.map((O) => ({ label: O.propertyName, value: O.dependentValues[0] })) : [], L = r == null ? void 0 : r[d];
    if (L !== !1)
      return L ? Object.assign({ type: H, prop: d, label: f, desc: B, required: D, cls: x }, L) : { type: H, prop: d, label: f, desc: B, required: D, value: u.defaultValue, cls: x };
  }).filter((y) => y != null) : [], l = a == "PROCESS" ? t.component.relationships.map((y, u) => ({
    tag: "p",
    class: "nifi-form-relationships",
    cls: [
      { tag: "span", cls: y.name },
      { tag: fe, prop: "relationships." + u + ".autoTerminate", label: "", cls: "Terminate" },
      { tag: fe, prop: "relationships." + u + ".retry", cls: "retry", label: "" }
    ]
  })) : [], A = {
    tag: "div",
    "v-if": ({ formData: y }) => {
      var u;
      return ((u = y.value.relationships) == null ? void 0 : u.filter((d) => d.retry).length) > 0;
    },
    cls: [
      { tag: K1, prop: "config.retryCount", label: "重试尝试次数", tip: "For relationships set to retry, this number indicates how many times a FlowFile will attempt to reprocess before it is routed elsewhere." },
      {
        tag: U1,
        prop: "config.backoffMechanism",
        label: "重试退避策略",
        tip: "Penalize: Retry attempts will occur in time, but the processor will continue to process other FlowFiles. Yield: No other FlowFile processing will occur until all retry attempts have been made.",
        cls: [
          { tag: Le, label: "YIELD_PROCESSOR", cls: "暂停执行" },
          { tag: Le, label: "PENALIZE_FLOWFILE", cls: "惩罚" }
        ]
      },
      { tag: W, prop: "config.maxBackoffPeriod", label: "重试最大退避时间", tip: "Initial retries are based on the Penalty/Yield Duration time specified in the Settings tab. The duration time is repeatedly doubled for every subsequent retry attempt. This number indicates the maximum allowable time period before another retry attempt occurs." }
    ]
  }, p = [
    { label: "属性配置", type: "form", validate: !0, column: [{ tag: $1, label: "", prop: "config.properties", isFormElem: !0, keys: s }] },
    {
      label: "高级配置",
      type: "form",
      validate: !0,
      column: [
        {
          ...
          cls: [
            { tag: "legend", cls: "基础" },
            { prop: "state", label: "是否启用", tag: V1, activeValue: "STOPPED", inactiveValue: "DISABLED" },
            ...
            { tag: U, prop: "config.bulletinLevel", label: "公告级别", cls: [{ value: "DEBUG", label: "调试" }, { value: "INFO", label: "信息" }, { value: "WARN", label: "警告" }, { value: "ERROR", label: "错误" }, { value: "NONE", label: "无" }], tip: "The level at which this processor will generate bulletins." }
          ]
        },
        {
          tag: "fieldset",
          cls: [
            { tag: "legend", cls: "调度" },
            {
              ...
              "@change": ({ formData: y, $: u }) => {
                u[0] == "CRON_DRIVEN" ? (Y(c(y), "config.schedulingPeriod", "* * * * * ?"), Y(c(y), "config.concurrentlySchedulableTaskCount", "1")) : (Y(c(y), "config.schedulingPeriod", "0 sec"), Y(c(y), "config.concurrentlySchedulableTaskCount", "1"));
              },
            ...
            { tag: U, prop: "config.executionNode", label: "执行", cls: [{ value: "ALL", label: "所有节点" }, { value: "PRIMARY", label: "主节点" }], tip: "The node(s) that this processor will be scheduled to run on when clustered." }
          ]
        },
        {
          tag: "fieldset",
    ...
    // { label: "关系", type: "form", validate: true, column: [...relationships, retry] },
    { label: "注释", type: "form", column: [{ tag: "el-input", type: "textarea", class: "nifi-form-tip", autoSize: !0, prop: "config.comments", label: "" }] }
  ], h = [
    {
      label: "高级配置",
      type: "form",
      validate: !0,
      column: [
        { prop: "parameterContext", label: "流程编组参数上下文" },
        { prop: "comments", label: "流程编组注释", type: "textarea" },
        {
          tag: U,
          prop: "flowfileConcurrency",
          label: "流程编组FlowFile并发数",
          cls: [
            { value: "UNBOUNDED", label: "无限制" },
            { value: "SINGLE_FLOWFILE_PER_NODE", label: "单个节点每个FlowFile" },
            { value: "SINGLE_BATCH_PER_NODE", label: "单个节点每个批次" },
            { value: "Unknown", label: "Unknown" }
          ]
        },
        {
          tag: U,
          prop: "flowfileOutboundPolicy",
          label: "流程编组出站策略",
          cls: [
            { value: "STREAM_WHEN_AVAILABLE", label: "当可用时流式传输" },
            { value: "BATCH_OUTPUT", label: "批量输出" }
          ]
        },
        { prop: "defaultFlowFileExpiration", label: "默认FlowFile过期时间" },
        { prop: "defaultBackPressureObjectThreshold", label: "默认后压对象阈值" },
        { prop: "defaultBackPressureDataSizeThreshold", label: "默认后压数据大小阈值" }
      ]
    },
    // { label: "控制器配置", type: "elem", elem: { tag: DialogTable, application: 'Group', node: data, controllerType: controllers } }
    { label: "控制器配置", type: "elem", elem: { tag: X1, application: "Group", node: t, controllerType: [] } }
  ], g = {
    label: "基础信息",
    type: "form",
    validate: !0,
    ...
    column: [
      {
        tag: W,
        "v-if": a == "PROCESS" || a == "PROCESS-GROUP",
        isFormElem: !1,
        label: "名称",
        elFormItem: !0,
        prop: "data.label",
        ":modelValue": "data.label",
        "@update:modelValue": ({ data: y, $: u, cell: d, formData: f }) => {
          var B, D;
          y.label.value = u[0] || d.data.component.name, Y(c(f), "name", u[0] || d.data.component.name), (B = e.graphForm) != null && B.getCellFormData(d) && Y((D = e.graphForm) == null ? void 0 : D.getCellFormData(d), "name", u[0] || d.data.component.name);
        }
      },
      { tag: "p", class: "nifi-form-item", cls: [{ tag: "b", cls: "编号" }, { tag: ce, cls: t.id, "@click": () => T.success(`复制 [ ${t.id} ]`) && Re(t.id) }] },
      { tag: "p", class: "nifi-form-item", "v-if": t.component.type != null, cls: [{ tag: "b", cls: "类型" }, { tag: ce, cls: t.component.type, title: t.component.type, "@click": () => T.success(`复制 [ ${t.component.type} ]`) && Re(t.component.type) }] },
      { tag: "p", class: "nifi-form-item", "v-if": t.revision != null, cls: [{ tag: "b", cls: "版本号" }, { tag: ce, cls: t.revision.version, type: "success" }] },
      { tag: "p", class: "nifi-form-item", "v-if": t.status, cls: [{ tag: "b", cls: "运行状态" }, { tag: ce, type: "info", cls: t.status.runStatus }, { tag: ce, cls: t.status.statsLastRefreshed }] }
    ]
  };
  return a == "PROCESS" ? [g, ...p] : a == "PROCESS-GROUP" ? [g, ...h] : [];
}, ui = { class: "nifi-history" }, wi = { class: "_left" }, mi = { class: "_info" }, Bi = /* @__PURE__ */ E("i", null, "ID", -1), yi = /* @__PURE__ */ E("i", null, "GroupId", -1), Ei = { key: 0 }, Fi = /* @__PURE__ */ E("i", null, "Source Name", -1), Qi = { key: 1 }, Di = /* @__PURE__ */ E("i", null, "Destination Name", -1), Ii = /* @__PURE__ */ E("i", null, "开始时间", -1), Mi = /* @__PURE__ */ E("i", null, "结束时间", -1), Hi = /* @__PURE__ */ E("p", null, [
  /* @__PURE__ */ E("i", null, "最小值"),
  /* @__PURE__ */ ge("/"),
  /* @__PURE__ */ E("i", null, "最大值"),
  /* @__PURE__ */ ge("/"),
  /* @__PURE__ */ E("i", null, "平均值")
], -1), bi = { class: "_right" }, vi = { class: "_header" }, Si = { class: "_chart-box" }, Li = /* @__PURE__ */ X({
  __name: "history",
  props: {
    data: {}
  },
  setup(n) {
    var w, m, y, u;
    const e = n, { data: t } = pe(e), i = Q(), a = Q(), o = {
      tooltip: {
        trigger: "axis",
        position: function(d) {
          return [d[0], "10%"];
      ...
      const { statusHistory: d } = c(t), { componentDetails: f } = d;
      return f;
    }), s = M(() => {
      const { statusHistory: d } = c(t), { fieldDescriptors: f } = d;
      return f.map((B) => ({ label: B.label, value: B.field, title: B.description }));
    }), l = Q(((u = (y = (m = (w = c(t)) == null ? void 0 : w.statusHistory) == null ? void 0 : m.fieldDescriptors) == null ? void 0 : y[0]) == null ? void 0 : u.field) || ""), A = M(() => {
      var d, f;
      return ((f = (d = c(t)) == null ? void 0 : d.statusHistory) == null ? void 0 : f.aggregateSnapshots) || [];
    }), p = M(() => c(A).map((d) => [d.timestamp, v(d.statusMetrics, c(l))])), h = M(() => c(p).map((d) => d[1])), g = M(() => ({ title: { text: c(l) }, series: [{ name: c(l), data: c(p) || [] }] }));
    return te(g, (d) => {
      var f;
      (f = a.value) == null || f.setOption(d);
    }), re(() => {
      a.value = $(Y1(i.value)), console.log("ops === ", ie({}, o, c(g))), a.value.setOption(ie({}, o, c(g))), setTimeout(() => {
        a.value.resize();
      }, 50);
    }), (d, f) => (F(), b("div", ui, [
      E("div", wi, [
        E("div", mi, [
          E("p", null, [
            Bi,
            E("b", null, K(r.value.Id), 1)
          ]),
          E("p", null, [
            yi,
            E("b", null, K(r.value["Group Id"]), 1)
          ]),
          c(ee)(r.value, "Source Name") ? (F(), b("p", Ei, [
            Fi,
            E("b", null, K(r.value["Source Name"]), 1)
          ])) : J("", !0),
          c(ee)(r.value, "Destination Name") ? (F(), b("p", Qi, [
            Di,
            E("b", null, K(r.value["Destination Name"]), 1)
          ])) : J("", !0)
        ]),
        E("div", null, [
          E("p", null, [
            Ii,
            E("b", null, K(new Date(A.value[0].timestamp).toLocaleString()), 1)
          ]),
          E("p", null, [
            Mi,
            E("b", null, K(new Date(A.value.at(-1).timestamp).toLocaleString()), 1)
          ])
        ]),
        E("div", null, [
          Hi,
          E("p", null, K(c(J1)(h.value)) + " " + K(l.value.includes("Bytes") ? "bytes" : "") + " / " + K(c(T1)(h.value)) + " " + K(l.value.includes("Bytes") ? "bytes" : "") + " / " + K(c(Z1)(h.value)) + " " + K(l.value.includes("Bytes") ? "bytes" : ""), 1)
        ])
      ]),
      E("div", bi, [
        E("div", vi, [
          N(c(U), {
            ...
            default: V(() => [
              (F(!0), b(j, null, ae(s.value, (B) => (F(), S(c(ye), {
                label: B.label,
                value: B.value,
                title: B.title,
                key: B.value
	...
	"dataType": {
		...
		"mathDataType": ["CaptureChangePostgreSQL",
			"TrainWithWekaProcessor",
			"NaiveBayesClassifierProcessor",
			"SAPProcessor",
			"LinerRegression",
  ...
  "cellData":{
    "sourceType":{
      "ports":{"items":[{ "id": "out", "group": "right" }]},
			"icon": "#prep-param-assign-font"
    },
    "dataStoreType":{
      "ports":{"items":[{ "id": "in", "group": "left" }]},
			"icon": "#prep-monitor-task-total"
    },
    "dataHandlerType":{
      "ports":{"items":[{ "id": "out", "group": "right" },{ "id": "in", "group": "left" }]},
			"icon": "#prep-condition-font"
    },
    "mathDataType":{
      "ports":{"items":[{ "id": "out", "group": "right" },{ "id": "in", "group": "left" }]},
			"icon": "#prep-loop-container-font"
    },
    "cDataType":{
      "ports":{"items":[{ "id": "out", "group": "right" },{ "id": "in", "group": "left" }]},
			"icon": "#prep-virtual-node-font"
    },
    "otherType":{
      "ports":{"items":[{ "id": "out", "group": "right" },{ "id": "in", "group": "left" }]},
			"icon": "#prep-monitor-api-total"
    },
		"default":{
			"icon": "#prep-virtual-node-font"
    }
  },
  "portIn":{ "id": "in", "group": "left" },
  "portOut":{ "id": "out", "group": "right" },
  "prioritizers":[
...
class ki {
  constructor() {
    C(this, "NIFI_DATA", {});
    C(this, "initFinishFlag", !1);
    C(this, "refreshTimeHandle");
    C(this, "groupRefreshCount", 1);
    //
    C(this, "contextmenu", {});
    //
    C(this, "clientId", "");
    ...
    //
    C(this, "nodeList", Q([]));
    C(this, "cellMetadata", /* @__PURE__ */ new Map());
    C(this, "edgeFormData", Q({}));
    C(this, "currentEdgeJson", {});
    //
    C(this, "groupId", "");
    C(this, "groupFlowData", {});
    C(this, "groupBreadcrumb", []);
    C(this, "graphData", []);
    C(this, "graphFormData", {});
    C(this, "graphCellData", {});
    //
    C(this, "graph");
    C(this, "graphForm");
    C(this, "graphShadow");
    C(this, "graphDialogRef");
    C(this, "graphDrawerRef");
    //
    C(this, "currentConnectForm", Q({}));
    C(this, "dialogRef");
    //
    C(this, "menuElems", R([]));
    C(this, "menuConfig", R({ enabled: !0, elems: this.menuElems, filter: { key: "key", whiteList: ["elem"] } }));
    //
    C(this, "events", {
      mounted: (e) => {
        this.graph = e.graph.value, this.graphForm = e.graphForm, this.graphShadow = e.graphShadow, this.graphDialogRef = e.dialogRef, this.graphDrawerRef = e.drawerRef, this.initFinishFlag && this.graph && this.graph.fromJSON(this.graphData);
      },
      "render:done": () => {
        var e;
        (e = this.graph) == null || e.zoomToFit(), this.initGraphStatus();
      },
      "init:edge": (e) => this.edgeInit(e),
      "init:node": (e) => this.nodeInit(e),
      "node:added": (e) => {
        const t = e.node;
        t.data && t.data.id || this.nodeAdd(t);
      },
      "node:moved": (e) => {
        const t = e.node;
        this.nodeMove(t);
      ...
      "node:dblclick": ({ node: e }) => {
        this.nodeType(e) == "PROCESS-GROUP" && this.initGraph(e.id);
      },
      "drawer:submit": (e, t) => {
        this.nodeSave(e, t);
      },
      "dialog:submit": () => {
        var e;
        (e = this.dialogRef) == null || e.submit().then((t) => {
          this.edgeSubmit(t);
        });
      },
      "currentNode:change": (e, t) => {
        var i;
        (i = this.graphForm) == null || i.getCellFormData(e || t);
      }
    });
    this.apiGetClientId(), this.initProcessType(), this.initPrioritizers(), this.initRoot(), this.apiGetRootStatus(), this.NIFI_DATA = JSON.parse(xi), this.initGraph(), this.contextmenu = gi(this), re(() => {
    }), r1(() => {
      this.refreshTimeHandle && clearInterval(this.refreshTimeHandle);
    });
  }
  //
  async procesorUpdate(e) {
    const { component: t, revision: i } = e, a = { disconnectedNodeAcknowledged: !1, component: t, revision: i };
    await _1(e.id, a) && (this.apiUpdateEdge(e), this.initGraph());
  }
  // 构建节点列表
  buildNodesFromTypes() {
    this.processTypes.map((e) => {
      const { bundle: t, tags: i, type: a, description: o, restricted: r } = e, s = a.split(".").reverse()[0], l = t.group;
      return { name: s, group: l, label: s, tags: i, type: a, description: o, restricted: r };
    });
  }
  //
  async initPrioritizers() {
    try {
      const e = await this.apiGetPrioritizers();
      this.prioritizers = e.prioritizerTypes;
    } catch {
    }
  }
  ...
  async initRoot() {
    try {
      const e = await this.apiGetFlowByGroup();
      this.rootGroups = e.processGroupFlow.flow.processGroups;
      const { id: t, name: i } = e.processGroupFlow.breadcrumb.breadcrumb;
      this.rootId = t, this.rootName = i;
    } catch (e) {
      console.warn(e);
    }
  }
  // 初始化任务画布
  async initGraph(e = "root") {
    var t;
    this.groupRefreshCount = -1, (t = this.graph) == null || t.clearCells({ silent: !0 }), this.graphData = [], this.graphFormData = {}, this.graphCellData = {}, this.menuElems.value = [], this.initFinishFlag = !1;
    try {
      await this.initFlow(e), await this.initGraphFlowData(), this.graph ? (console.log("初始化画布~ ==========>"), this.graph.fromJSON(this.graphData)) : this.initFinishFlag = !0;
    } catch (i) {
      console.warn(i);
    }
    return this;
  ...
  //
  async initFlow(e) {
    const t = await this.apiGetFlowByGroup(e);
    this.groupFlowData = t.processGroupFlow.flow, this.groupId = t.processGroupFlow.id;
    let i = t.processGroupFlow.breadcrumb;
    const a = [i.breadcrumb];
    for (; i.parentBreadcrumb; )
      i = i.parentBreadcrumb, a.push(i.breadcrumb);
    this.groupBreadcrumb = a.reverse(), this.menuElems.value = Ci(this);
  }
  // 初始化算子元素，节点和边
  async initGraphFlowData() {
    const { connections: e = [], processors: t = [], processGroups: i = [], inputPorts: a, outputPorts: o } = this.groupFlowData;
    for (const s of i) {
      const l = await this.apiGetControllServices(s.id), A = [], p = s.inputPortCount || 0, h = s.outputPortCount || 0;
      p > 0 && A.push(this.NIFI_DATA.portIn), h > 0 && A.push(this.NIFI_DATA.portOut);
      const g = {
        id: s.id,
        position: s.position,
        shape: "vue-node",
        ...
        ports: { items: A }
        // data: {
        //   ...node, tabs: this.setConfig(node, 'Group')
        // }
      };
      this.graphData.push(g), this.graphFormData[s.id] = s.component, this.graphCellData[s.id] = s;
    }
    for (const s of t) {
      const l = this.NIFI_DATA.cellData, A = this.nodeList.value.filter((w) => w.name == s.component.type)[0].groupName, p = l[A] || {}, h = await this.apiGetNode(s.id), g = {
        ...p,
        id: s.id,
        position: s.position,
        shape: "vue-node",
        name: s.component.type,
        label: s.component.name,
        // data: node
        data: h
      };
      this.graphData.push(g), this.graphFormData[s.id] = s.component.config, this.graphCellData[s.id] = s;
    }
    const r = [...t, ...i];
    for (const s of e) {
      const l = s.sourceGroupId != this.groupId ? s.sourceGroupId : s.sourceId, A = s.destinationGroupId != this.groupId ? s.destinationGroupId : s.destinationId, p = s.component.source, h = s.component.destination, g = p.type == "PROCESSOR" ? p.name : `${r.filter((u) => u.id == l)[0].component.name} ( ${p.name} )`, w = h.type == "PROCESSOR" ? h.name : `${r.filter((u) => u.id == A)[0].component.name} (${h.name})`, m = `[${g}] -> [${w}]`, y = {
        id: s.id,
        shape: "vue-edge",
        source: { cell: l, port: "out" },
        target: { cell: A, port: "in" },
        title: m,
        data: s
      };
      this.graphData.push(y), this.graphFormData[s.id] = s.component, this.graphCellData[s.id] = s;
    }
  }
  initGraphStatus() {
    const { connections: e = [], processors: t = [], processGroups: i = [], inputPorts: a, outputPorts: o, funnels: r } = this.groupFlowData;
    this.cellUpdate(t), this.cellUpdate(e), this.cellUpdate(i), this.cellUpdate(r);
  }
  // 属性表单数据构建
  initNodeForm() {
  }
  ...
  // 初始化 边的 label config
  initEdgeLabelConfig(e) {
    var i;
    const t = Pe(e, this);
    (i = this.graphShadow) == null || i.set(e, "edgeLabelConfig", { elem: t });
  }
  initCellFormData(e) {
    e.data.component;
  }
  // 初始化节点的历史记录 
  async initCellHistory(e, t) {
    var i, a;
    t.close();
    try {
      const o = await this.apiGetHistory(e);
      console.log(o), ((a = (i = o == null ? void 0 : o.statusHistory) == null ? void 0 : i.aggregateSnapshots) == null ? void 0 : a.length) == 0 ? T.info("历史记录不足，请稍后再试") : j1({ title: "状态历史", message: Ue(Li, { data: o }) });
    } catch (o) {
      T.error("接口调用失败！"), console.warn(o);
    }
  }
  // 初始化节点的状态记录
  initNodeStatus(e, t) {
  ...
  nodeType(e) {
    var s, l;
    const t = e.id ? (s = this.graphShadow) == null ? void 0 : s.get(e, "node-type") : void 0;
    if (t)
      return t;
    const i = e.data, a = /nifi-api\/([\w-]+)\//.exec(i.url || "");
    if (a)
      return a[1].toUpperCase();
    if (i.type)
      return i.type;
    let o = "FUNNELS";
    const r = i.component.type;
    if (r)
      switch (r) {
        case "INPUT_PORTS":
          o = "INPUT_PORTS";
    ...
    return e.id && ((l = this.graphShadow) == null || l.set(e, "node-type", o)), o;
  }
  // Node
  async nodeInit(e) {
    var t, i;
    if (e.data && e.data.id) {
      ...
      ({ ...e, id: a.id, ...a });
      const o = fi(e, this);
      (t = this.graphShadow) == null || t.setTabs(e, o), (i = this.graphForm) == null || i.resetCellFormData(e, a.component);
    }
  }
  async nodeAdd(e) {
    var t, i;
    try {
      ...
      const s = await this.apiNewNode(a, o), l = {
        ...r,
        id: s.id,
        data: { ...s }
      };
      (i = this.graph) == null || i.addNode(l), setTimeout(() => {
        this.cellUpdate([s]);
      }, 100);
    } catch (a) {
      console.warn(a);
  ...
  async nodeEdit(e, t) {
    var i;
    t == null || t.close(), (i = this.graphForm) == null || i.openDrawer(e);
  }
  async nodeSave(e, t) {
    var o;
    const i = (o = this.graphForm) == null ? void 0 : o.getCellFormData(e), a = e.data;
    a.component = i, await this.nodeUpdate(a, e), t(), this.nodeCheck(e);
  }
  async nodeDel(e, t) {
    var a;
    const i = this.nodeType(e);
    try {
      switch (i) {
        case "PROCESS":
          await this.apiDelNode(e);
          break;
        case "PROCESS-GROUP":
          await this.apiDelGroup(e);
          break;
      }
      (a = this.graph) == null || a.removeCell(e), t == null || t.close();
    } catch {
    }
  }
  async nodesDel(e, t) {
  ...
  async nodeMove(e) {
    ...
    try {
      await this.nodeUpdate(i, e);
    } catch {
    }
  }
  async nodeUpdate(e, t) {
    const i = this.nodeType(t);
    let a;
    i == "PROCESS" && (a = await this.apiUpdateNode(e)), i == "PROCESS-GROUP" && (a = await this.apiUpdateGroup(e)), a && this.cellUpdate([a]);
  }
  // node 启用/禁用
  async nodeDisable(e, t, i) {
    try {
      const a = await this.apiDisOrEnableNode(e, i);
      t.close(), this.cellUpdate([a]);
    } catch {
    }
  }
  async nodeCheck(e, t) {
    ...
    switch (i) {
      case "PROCESS":
        a = [this.apiValidateNode, this.apiGetValidateNode, this.apiDelValidateNode, this.apiGetNode];
        break;
    }
    if (!(a.length < 1))
      try {
        (o = this.graphShadow) == null || o.setStep(e, "loading");
        const r = await a[0].call(this, e), { requestId: s } = r.request;
        await a[1].call(this, e, s), await a[2].call(this, e, s);
        const l = await a[3].call(this, e.id);
        this.cellUpdate([l]);
      } catch (r) {
        console.warn(r);
      }
  ...
  async nodeRun(e, t) {
    ...
    switch (i) {
      case "PROCESS":
        a = await this.apiRunProcessNode(e);
        break;
      case "PROCESS-GROUP":
        a = await this.apiRunGroup(e);
        break;
    }
    a && this.cellUpdate([a]);
  }
  async nodeRunOnce(e, t) {
    t.close();
    const i = this.nodeType(e);
    let a;
    switch (i) {
      case "PROCESS":
        a = await this.apiRunOnceProcessNode(e);
        break;
    }
    a && this.cellUpdate([a]);
  }
  async nodeStop(e, t) {
    ...
    switch (i) {
      case "PROCESS":
        a = await this.apiStopProcessNode(e);
        break;
      case "PROCESS-GROUP":
        a = await this.apiStopGroup(e);
        break;
    }
    a && this.cellUpdate([a]);
  }
  ...
  getEdgeData(e) {
    var m, y, u, d, f, B, D;
    const t = e.data, i = (m = this.graphShadow) == null ? void 0 : m.get(e), a = c(i.source), o = c(i.target), r = (y = this.graph) == null ? void 0 : y.getCellById(a), s = (u = this.graph) == null ? void 0 : u.getCellById(o), l = ((f = (d = r == null ? void 0 : r.data) == null ? void 0 : d.component) == null ? void 0 : f.relationships) || [], A = t.component.name || (t.component.selectedRelationships || []).join(",");
    let p = "", h = [], g = [], w = {};
    return t != null && t.id ? (p = e.prop("title"), w = e.data.component, h = ((B = this.graphShadow) == null ? void 0 : B.get(a, "outputPorts")) || [], g = ((D = this.graphShadow) == null ? void 0 : D.get(o, "inputPorts")) || []) : p = `[${r == null ? void 0 : r.prop("label")}] -> [${s == null ? void 0 : s.prop("label")}]`, { title: p, outPorts: h, inPorts: g, modelValue: w, label: A, relationships: l, sourceNode: r, targetNode: s, sourceId: a, targetId: o, id: t == null ? void 0 : t.id };
  }
  async getEdgeInfo(e) {
    var u, d, f, B, D, H, x, L, O;
    const t = (u = this.graphShadow) == null ? void 0 : u.get(e), i = c(t.source), a = c(t.target), o = (d = this.graph) == null ? void 0 : d.getCellById(i), r = (f = this.graph) == null ? void 0 : f.getCellById(a);
    let s = [], l = [];
    const A = ((D = (B = o == null ? void 0 : o.data) == null ? void 0 : B.component) == null ? void 0 : D.relationships) || [], p = `[${o == null ? void 0 : o.prop("label")}] -> [${r == null ? void 0 : r.prop("label")}]`, h = o == null ? void 0 : o.data.component.parentGroupId, g = r == null ? void 0 : r.data.component.parentGroupId;
    let w = { id: i, groupId: h, type: "PROCESSOR" }, m = { id: a, groupId: g, type: "PROCESSOR" };
    if ((o == null ? void 0 : o.data.outputPortCount) > 0) {
      const q = await this.apiGetGroupData(i);
      s = q.processGroupFlow.flow.outputPorts, w.id = s[0].id, w.type = "OUTPUT_PORT", w.groupId = i, (H = this.graphShadow) == null || H.set(i, "processGroupFlow", q.processGroupFlow), (x = this.graphShadow) == null || x.set(i, "outputPorts", s);
    }
    if ((r == null ? void 0 : r.data.inputPortCount) > 0) {
      const q = await this.apiGetGroupData(a);
      l = q.processGroupFlow.flow.inputPorts, m.id = l[0].id, m.type = "INPUT_PORT", m.groupId = a, (L = this.graphShadow) == null || L.set(a, "processGroupFlow", q.processGroupFlow), (O = this.graphShadow) == null || O.set(a, "inputPorts", l);
    }
    return { title: p, inPorts: l, outPorts: s, source: w, destination: m, modelValue: { source: w, destination: m }, relationships: A, sourceNode: o, targetNode: r };
  }
  async edgeElem(e) {
    const { title: t, inPorts: i, outPorts: a, relationships: o, targetNode: r, modelValue: s } = await this.getEdgeInfo(e), l = hi({ relationships: o, outPorts: a }, { cell: r, inPorts: i }, { that: this, modelValue: s });
    return { title: t, outPorts: a, inPorts: i, modelValue: s, elem: l };
  }
  async edgeInit(e) {
    var t, i;
    if (e.data && e.data.id) {
      const a = Pe(e, this), { title: o, label: r } = this.getEdgeData(e);
      (t = this.graphShadow) == null || t.setEdgeLabelConfig(e, { title: o, elem: a }), (i = this.graphShadow) == null || i.setLabel(e, r);
    }
  }
  async edgeAdd(e) {
    var a, o, r, s, l;
    this.currentEdgeJson = e.toJSON(), console.log("edgeAdd...........", this.currentEdgeJson);
    const { elem: t, title: i } = await this.edgeElem(e);
    (o = (a = this.graphDialogRef) == null ? void 0 : a.value) == null || o.open(t), (s = (r = this.graphDialogRef) == null ? void 0 : r.value) == null || s.setConfig({ title: i }), (l = this.graph) == null || l.removeCell(e);
  }
  async edgeEdit(e, t) {
    var s, l, A, p;
    const { elem: i, title: a, inPorts: o, outPorts: r } = await this.edgeElem(e);
    t.close(), (l = (s = this.graphDialogRef) == null ? void 0 : s.value) == null || l.open(i), (p = (A = this.graphDialogRef) == null ? void 0 : A.value) == null || p.setConfig({ title: a });
  }
  async edgeSubmit(e) {
    var t;
    if (this.currentEdgeJson.id)
      this.apiNewEdge(e).then((i) => {
        var r, s, l;
        const a = i.component.name || (i.component.selectedRelationships || []).join(","), o = {
          ...this.currentEdgeJson,
          id: i.id,
          label: a,
          data: i
        };
        (r = this.graph) == null || r.addEdge(o), (l = (s = this.graphDialogRef) == null ? void 0 : s.value) == null || l.close(), this.currentEdgeJson = {}, setTimeout(() => {
          this.cellUpdate([i]);
        }, 10);
      });
    else {
      const i = (t = this.graph) == null ? void 0 : t.getCellById(e.id), a = i == null ? void 0 : i.data;
      a.component = e, this.apiUpdateEdge(a).then((o) => {
        var r, s;
        (s = (r = this.graphDialogRef) == null ? void 0 : r.value) == null || s.close(), this.cellUpdate([o]);
      });
    }
  }
  async edgeDel(e, t) {
    var i;
    try {
      await this.apiDelEdge(e), (i = this.graph) == null || i.removeCell(e), t.close();
    } catch {
    }
  }
  //
  ...
  async cellUpdate(e = []) {
    e.forEach((t) => {
      var r, s, l, A, p, h;
      const i = t.id, a = (r = this.graph) == null ? void 0 : r.getCellById(i);
      if (!a)
        return;
      const o = ie(a.data || {}, t);
      if (t.component.name || (t.component.selectedRelationships || []).join(","), a.prop("data", o), (s = this.graphShadow) == null || s.setStatus(a, o.status.aggregateSnapshot), o.status.runStatus)
        switch (o.status.runStatus) {
          case "Invalid":
            (l = this.graphShadow) == null || l.setStep(a, "invalid");
            break;
          case "Running":
            (A = this.graphShadow) == null || A.setStep(a, "running");
            break;
          case "Stopped":
            (p = this.graphShadow) == null || p.setStep(a, "stop");
            break;
          case "Disabled":
            (h = this.graphShadow) == null || h.setStep(a, "disabled");
            break;
        }
    });
  }
  //
  async groupRefresh() {
    this.refreshTimeHandle && clearInterval(this.refreshTimeHandle), this.refreshTimeHandle = setInterval(async () => {
      if (this.groupRefreshCount <= 0) {
        this.groupRefreshCount++;
        return;
      }
      this.groupRefreshCount--;
      try {
        const e = await this.apiGetGroupData(this.groupId), { processGroupFlow: t } = e, { flow: i } = t, { processors: a, connections: o, processGroups: r, outputPorts: s, labels: l, inputPorts: A, funnels: p } = i;
        this.cellUpdate(a), this.cellUpdate(o);
      } catch (e) {
        console.warn(e);
      }
      this.groupRefreshCount <= 0 && this.groupRefreshCount++;
    }, 1e4);
  }
  // async edgeUpdate(data:any[]){
  //   data.forEach(d => {
  //     const id = d.id;
  //     const e = this.graph?.getCellById(id)
  //     if(e && e.isEdge()){
  //       e.data != d && e?.prop('data', d)
  //       const label = d.component.name || (d.component.selectedRelationships || []).join(',')
  //       this.graphShadow.setLabel(e,label)
  //       this.graphShadow.setStatus(e,d.status.aggregateSnapshot)
  //     }
  //   })
  // }
  // 分组
  ...
  // 获取 clientId
  apiGetClientId() {
    fetch("/nifi-api/flow/client-id").then((e) => e.text()).then((e) => {
      this.clientId = e;
    });
  }
  // 获取所有算子类型
  apiGetProcessTypes() {
    return this.apiGet("/nifi-api/flow/processor-types");
  }
  // 获取优先级规则列表 /nifi-api/flow/prioritizers
  apiGetPrioritizers() {
    return this.apiGet("/nifi-api/flow/prioritizers");
  }
  //
  apiGetRootStatus() {
    fetch("/nifi-api/flow/status").then((e) => e.json()).then((e) => {
      this.rootStatus = e.controllerStatus;
    });
  }
  // 获取某个处理组的画布数据 作为当前画布数据
  apiGetFlowByGroup(e = "root") {
    const t = `/nifi-api/flow/process-groups/${e}?uiOnly=true`;
    return this.apiGet(t);
  }
  // 获取分组数据
  apiGetGroupData(e) {
    const t = `/nifi-api/flow/process-groups/${e}`;
    return this.apiGet(t);
  }
  // 更新处理组
  apiUpdateGroup(e) {
    const i = `/nifi-api/process-groups/${e.component.id}`;
    return this.apiPut(i, e);
  }
  // 新增处理组 /nifi-api/process-groups/617a06d1-018c-1000-1046-055f2507deef/process-groups
  apiNewGroup(e) {
    const t = `/nifi-api/process-groups/${this.groupId}/process-groups`, { name: i, position: a = { x: 0, y: 0 } } = e, o = { disconnectedNodeAcknowledged: !1, component: { name: i, position: a }, revision: { clientId: this.clientId, version: 0 } };
    return this.apiPost(t, o);
  }
  // 删除分组 /nifi-api/process-groups/2cd72cfe-018e-1000-dd9e-fcc182e71b38?version=2&clientId=31283df2-018e-1000-632b-5fddde15f99e&disconnectedNodeAcknowledged=false
  apiDelGroup(e) {
    const t = e.id, i = e.data, { clientId: a, version: o } = i.revision, r = `/nifi-api/process-groups/${t}?version=${o}&clientId=${a}&disconnectedNodeAcknowledged=false`;
    return this.apiDelete(r);
  }
  // 运行 /nifi-api/remote-process-groups/process-group/313b8bee-018e-1000-90a9-940a52ee7804/run-status
  apiRunGroup(e) {
    return this.apiGroupRunStatus(e, "TRANSMITTING");
  }
  // 停止
  apiStopGroup(e) {
    return this.apiGroupRunStatus(e, "STOPPED");
  }
  apiGroupRunStatus(e, t) {
    const a = `/nifi-api/remote-process-groups/process-group/${e.id}/run-status`, o = { state: t, disconnectedNodeAcknowledged: !1 };
    return this.apiPut(a, o);
  }
  // /nifi-api/flow/process-groups/313b8bee-018e-1000-90a9-940a52ee7804
  // 新建节点
  apiNewNode(e, t = { x: 0, y: 0 }) {
    const i = this.processTypes.filter((r) => r.type == e)[0] || {}, a = {
      revision: { clientId: this.clientId, version: 0 },
      disconnectedNodeAcknowledged: !1,
      component: {
        type: i.type,
        bundle: i.bundle,
        name: i.type.split(".").reverse()[0],
        position: t
      }
    }, o = `/nifi-api/process-groups/${this.groupId}/processors`;
    return this.apiPost(o, a);
  }
  apiGetNode(e) {
    const t = `/nifi-api/processors/${e}`;
    return this.apiGet(t);
  }
  apiUpdateNode(e) {
    const i = `/nifi-api/processors/${e.component.id}`;
    return this.apiPut(i, e);
  }
  apiDelNode(e) {
    const t = e.id, i = e.data, { clientId: a, version: o } = i.revision, r = [`clientId=${a}`, `version=${o}`, "disconnectedNodeAcknowledged=false"], s = `/nifi-api/processors/${t}?${r.join("&")}`;
    return this.apiDelete(s);
  }
  // /nifi-api/processors/1d55e3ff-018e-1000-b658-f4df3ddbad78/config/analysis
  apiAnalyseNode(e) {
    const t = e.id, i = { configurationAnalysis: { componentId: t, properties: {} } }, a = `/nifi-api/processors/${t}/config/analysis`;
    return this.apiPost(a, i);
  }
  // 校验 /nifi-api/processors/1d55e3ff-018e-1000-b658-f4df3ddbad78/config/verification-requests
  apiValidateNode(e) {
    const t = e.id, i = { request: { componentId: t, properties: {}, attributes: {} } }, a = `/nifi-api/processors/${t}/config/verification-requests`;
    return this.apiPost(a, i);
  }
  // 查询验证 /nifi-api/processors/c97dcb95-018d-1000-01ab-46e97b222414/config/verification-requests/3148f9e6-018e-1000-866d-784d66c7cdb7
  apiGetValidateNode(e, t) {
    const a = `/nifi-api/processors/${e.id}/config/verification-requests/${t}`;
    return this.apiGet(a);
  }
  // 删除验证 /nifi-api/processors/072a360c-018e-1000-c09f-bf5e4279d89d/config/verification-requests/314c1c14-018e-1000-f129-c25bdb3084bf
  apiDelValidateNode(e, t) {
    const a = `/nifi-api/processors/${e.id}/config/verification-requests/${t}`;
    return this.apiDelete(a);
  }
  // 开始运行 /nifi-api/processors/072a360c-018e-1000-c09f-bf5e4279d89d/run-status
  apiRunProcessNode(e) {
    return this.apiRunStatusNode(e, "RUNNING");
  }
  // /nifi-api/processors/072a360c-018e-1000-c09f-bf5e4279d89d/run-status
  apiStopProcessNode(e) {
    return this.apiRunStatusNode(e, "STOPPED");
  }
  apiRunOnceProcessNode(e) {
    return this.apiRunStatusNode(e, "RUN_ONCE");
  }
  apiRunStatusNode(e, t) {
    const i = e.id, a = e.data, { clientId: o, version: r } = a.revision, s = { revision: { clientId: o, version: r }, state: t, disconnectedNodeAcknowledged: !1 }, l = `/nifi-api/processors/${i}/run-status`;
  ...
  apiNewEdge(e) {
    const t = {
      ...
      disconnectedNodeAcknowledged: !1,
      revision: { clientId: this.clientId, version: 0 }
    }, i = `/nifi-api/process-groups/${this.groupId}/connections`;
    return this.apiPost(i, t);
  }
  // /nifi-api/connections/0c1f55f5-018d-1000-abff-0a68162e5e8b
  apiUpdateEdge(e) {
    const i = `/nifi-api/connections/${e.component.id}`;
    return this.apiPut(i, e);
  }
  // /nifi-api/connections/fc720224-018c-1000-6a95-eec47ec29ad6?version=1&clientId=fb8841f2-018c-1000-3d37-b5243a3a26db&disconnectedNodeAcknowledged=false
  apiDelEdge(e) {
    const t = e.data, i = t.id, a = t.revision.version, o = t.revision.clientId, r = `/nifi-api/connections/${i}?version=${a}&clientId=${o}`;
    return this.apiDelete(r);
  }
  //
  apiNewGroupNode() {
  ...
  // 获取分组控制器服务表格信息
  apiGetControllServices(e) {
    return new Promise((t) => {
      fetch(`/nifi-api/flow/process-groups/${e}/controller-services?uiOnly=true`).then((i) => i.json()).then((i) => {
        t(i);
      });
    });
  }
  // -------------------------------------节点的启用、禁用-------------------------------------------
  getReversion(e) {
    const { store: { data: { data: { revision: t } } } } = e;
    return t;
  }
  // node节点禁用/启用api /nifi-api/processors/0b07eede-018d-1000-0068-c742f19e99c7/run-status  PUT
  apiDisOrEnableNode(e, t = !1) {
    return this.apiRunStatusNode(e, t ? "STOPPED" : "DISABLED");
  }
  // 创建标签节点 /nifi-api/process-groups/617a06d1-018c-1000-1046-055f2507deef/labels
  apiNewLabel(e) {
    const t = `/nifi-api/process-groups/${this.groupId}/labels`, i = e.position(), a = {
      revision: {
    ...
    return this.apiPost(t, a);
  }
  // 修改标签节点 /nifi-api/labels/2f062c17-018d-1000-9991-ca2b420b023d
  apiUpdateLabel(e) {
    const i = `/nifi-api/labels/${e.component.id}`;
    return this.apiPut(i, e);
  }
  // 删除标签节点 /nifi-api/labels/2f19339b-018d-1000-0d53-c7ddd7441531?version=1&clientId=2f05931b-018d-1000-5b56-f8d0b1dc8921&disconnectedNodeAcknowledged=false
  apiDelLabel(e) {
    const { revision: t, id: i } = e, a = `/nifi-api/labels/${i}?version=${t.version}&clientId=${t.clientId}&disconnectedNodeAcknowledged=false`;
    return this.apiDelete(a);
  }
  /* ****************************funnels 漏斗*********************** */
  apiNewFunnel(e) {
    const t = `/nifi-api/process-groups/${this.groupId}/funnels`, i = e.position(), a = {
      revision: {
        clientId: "52f54a38-018d-1000-d049-0812f2ec4c8e",
        version: 0
      },
      disconnectedNodeAcknowledged: !1,
      component: {
  ...
  apiUpdateFunnel(e) {
    const t = `/nifi-api/funnels/${e.component.id}`;
    return this.apiPut(t, e);
  }
  apiDelFunnel(e) {
    const t = e.data || {}, { revision: i = {}, id: a } = t, { version: o, clientId: r } = i, s = `/nifi-api/funnels/${a}?version=${o}&clientId=${r}&disconnectedNodeAcknowledged=false`;
    return this.apiDelete(s);
  }
  /* *****************************history************************************** */
  apiGetHistory(e) {
    const t = e.id, i = e.isEdge() ? "edge" : this.nodeType(e);
    let a = "";
    switch (i) {
      case "edge":
        a = "connections";
    ...
    const o = `/nifi-api/flow/${a}/${t}/status/history`;
    return this.apiGet(o);
  }
  // 基础请求处理逻辑封装
  apiPost(e, t = {}) {
    return new Promise((i, a) => {
      fetch(e, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(t) }).then(async (o) => {
        const r = o.ok, s = await (r ? o.json() : o.text());
        r ? i(s) : (T.warning(s), a(s));
      }).catch((o) => a(o));
    });
  }
  apiGet(e) {
    return new Promise((t, i) => {
      fetch(e).then(async (a) => {
        ...
        o ? t(r) : (T.warning(r), i(r));
      }).catch((a) => i(a));
    });
  }
  apiPut(e, t = {}) {
    return new Promise((i, a) => {
      fetch(e, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(t) }).then(async (o) => {
        const r = o.ok, s = await (r ? o.json() : o.text());
        r ? i(s) : (T.warning(s), a(s));
      }).catch((o) => a(o));
    });
  ...
  apiDelete(e) {
    return new Promise((t, i) => {
      fetch(e, { method: "DELETE" }).then(async (a) => {
        const o = a.ok, r = await (o ? a.json() : a.text());
        o ? t(r) : (T.warning(r), i(r));
      }).catch((a) => i(a));
    });
