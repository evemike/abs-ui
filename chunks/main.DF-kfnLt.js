...
import { defineComponent as G, useSlots as P, toRefs as X, ref as i, shallowRef as x, watch as T, onMounted as q, openBlock as c, createElementBlock as b, createElementVNode as f, normalizeClass as J, renderSlot as B, normalizeStyle as K, withDirectives as Q, createVNode as Y, unref as l, createCommentVNode as C, createBlock as Z, vShow as ee, markRaw as te } from "vue";
import { aR as oe, aS as ae, aT as le, aU as s, aV as v, aW as R, aN as se, C as O, a0 as re, aX as ne } from "./vendor.Bh6KHC77.js";
...
const we = {
  ...
  setup(H, { expose: L, emit: D }) {
    const M = D, N = H;
    P(), le();
    const { modelValue: k, showOperate: j, theme: m, format: n, teleport: _e, dialog: be, dialogTitle: Ce, lang: p, readOnly: u } = X(N), y = i(), E = i();
    i();
    const r = x(), d = x();
    let a = k.value || "";
    const o = i(!0), w = i("");
