...
import { aJ as de, f as E, p as pe, ay as ie, o as fe, aK as ce, y as N, g as p, as as _, aq as me, aI as ve, an as ye, ar as T, aL as _e, j as Ve, P as be, a5 as H, ao as we, aM as x } from "./vendor.DW1gWLiY.js";
import { C as q } from "./main.De1Wc5h8.js";
import { E as ke } from "./main.BG0bARjT.js";
const he = {
  flex: "",
  "items-center": "",
  "justify-between": "",
  ...
  setup(G, { emit: M }) {
    ...
    (() => {
      ...
      if (F.length == 0)
        ...
        let s = m || {};
        Array.isArray(m) && (s = Object.fromEntries(m.map((v) => [v[a], v[o]]))), b.value = F.map((v) => ({ ...v, value: p(s, v.prop) ?? v.value }));
      }
