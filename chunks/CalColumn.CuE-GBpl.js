...
import { defineComponent as ee, toRefs as te, ref as p, watch as W, resolveComponent as N, openBlock as M, createElementBlock as P, createVNode as a, unref as u, isRef as oe, withCtx as n, createElementVNode as f, createTextVNode as k, toDisplayString as x, createCommentVNode as J, computed as ne, reactive as X, onMounted as se, createBlock as H } from "vue";
import { a5 as ie, m as Y, aB as Z, f as $, a as Q, i as re, j as de, au as q } from "./vendor.jH9g53BU.js";
import { C as ue } from "./main.CUCPbsxK.js";
import { _ as ce } from "./_plugin-vue_export-helper.CHgC5LLL.js";
import { d as z, b as pe, e as fe } from "./index.DEa1ourJ.js";
const me = [
  {
    name: "四则运算函数",
    children: [
  ...
  class: "field_content",
  "h-468": ""
}, Ve = { class: "fun_tree" }, ge = { class: "custom-tree-node" }, xe = { class: "multi-ellipsis" }, ke = { key: 0 }, Ce = { class: "fun_tree field_tree" }, ye = { class: "custom-tree-node" }, De = { class: "multi-ellipsis" }, Ne = { key: 0 }, Fe = { class: "field_body" }, Ee = { class: "field_top" }, Re = { class: "field_bottom" }, we = { class: "field_footer" }, Se = /* @__PURE__ */ ee({
  __name: "Dialog",
  props: {
  ...
  setup(C, { emit: F }) {
    const b = F, K = C, { modelValue: L, fieldData: E, inputValue: I } = te(K), y = p(), j = p(), s = p(), r = p(""), c = p(""), V = p([
      {
        name: "字段",
        children: I.value
      }
    ]), D = p("从左侧列表选择或直接输入函数、字段"), g = p(E.value.fieldName), R = p(E.value.expression), w = {
      children: "children",
      label: "name"
    }, O = (t, o) => {
      var e;
      o.isLeaf && ((e = y.value) == null || e.insertValue(t.name));
    }, d = (t, o) => {
      var e;
      if (o.isLeaf) {
        ...
        (e = y.value) == null || e.insertValue(t.name), D.value = "从左侧列表选择或直接输入函数、字段";
      }
    }, _ = () => {
      ...
      let t = (o = y.value) == null ? void 0 : o.getValue();
      if (t === "") {
        Q.error("表达式不可为空");
        return;
      }
                ...
                a(u(Z), {
                  ...
                  default: n(({ node: l, data: m }) => [
                    f("div", ge, [
                      ...
                      m.children && m.children.length > 0 ? (M(), P("span", ke, " (" + x(m.children.length) + ") ", 1)) : J("", !0)
                    ])
                  ]),
                  _: 1
                }, 8, ["data"])
                  ...
                  default: n(({ node: l, data: m }) => [
                    f("div", ye, [
                      a(i, null, {
                        ...
                        default: n(() => [
                          f("div", De, x(l.label), 1)
                        ]),
                        _: 2
                      }, 1024),
                      m.children && m.children.length > 0 ? (M(), P("span", Ne, " (" + x(m.children.length) + ") ", 1)) : J("", !0)
                    ])
                  ]),
                  _: 1
                }, 8, ["data"])
  ...
  setup(C) {
    const F = C, { formdata: b, inputV: K, step: L, expression: E, newField: I, graphShadow: y } = te(F);
    let j = ne(() => L.value === "running");
    const s = p(), r = p(K.value), c = p(!1), V = p(), D = p(0), g = () => {
      d.tableData.push({
        fieldName: "",
        expression: "",
        prompt: ""
      ...
      V.value = e, D.value = i, c.value = !0;
    }, w = (e) => {
      d.tableData[D.value] = e;
    }, O = (e) => {
    ...
    const _ = (e, i, l) => {
      ...
      if (d.tableData.filter((A) => A.fieldName === i).length > 1)
    ...
    se(() => {
      y.value.set(b.value.id, "checkForm", o), y.value.set(b.value.id, "tableData", d.tableData);
    });
    ...
    return (e, i) => {
      const l = N("el-input"), m = N("el-tooltip"), A = N("el-form-item"), G = N("el-table-column"), le = N("el-table"), ae = N("el-form");
      return M(), P("div", {
...
}), Be = /* @__PURE__ */ ce(Te, [["__scopeId", "data-v-f6a43327"]]), je = () => {
  let C = [], F = [], b = [];
  ...
  return { name: ["org.apache.nifi.column.processors.CalColumn_2_0"], excludeKeys: ["new-field", "expression", "output-param"], selfFormColumn: [
    ...
    F = z(V.expression), b = z(V["new-field"]), C = pe(s, r, K);
  }, hooksSubmit: (s, r) => {
    var g, R, w, O, d;
    fe(s, r);
    let c = ((g = r.event.shadow) == null ? void 0 : g.get(s.id).tableData) ?? [], V = c.filter((_) => _.fieldName === ""), D = new Set(
