import { ref as x, markRaw as A, unref as f, defineComponent as Q, watch as B, openBlock as O, createElementBlock as I, createElementVNode as E, createVNode as D, withCtx as N, Fragment as R, renderList as U, createBlock as $, normalizeProps as z, guardReactiveProps as C } from "vue";
import { g as W, a as X } from "./api.CF1BbFLh.js";
import { g as c, aI as L, ba as w, ap as M } from "./vendor.CawUkpaF.js";
const P = [
  // kafka
  {
  ...
  let m = [], k = [];
  const h = x([]), K = x([]), T = (s == null ? void 0 : s.kafkaOptionKey) || "connection.config.bootstrapServers", b = (s == null ? void 0 : s.topicOptionKey) || "name", g = (s == null ? void 0 : s.kafkaFormatKeys) || P[0], V = (s == null ? void 0 : s.topicFormatKeys) || P[1], S = 'config.properties["bootstrap.servers"]', F = 'config.properties["topic"]';
  W().then(async (e) => {
    ...
    return B(d, (_) => {
      ...
      E("div", et, [
        ...
        D(f(M), {
          ...
          default: N(() => [
            (O(!0), I(R, null, U(f(h), (u) => (O(), $(f(L), z(C(u)), null, 16))), 256))
          ]),
          _: 1
        }, 8, ["modelValue"])
      ]),
      E("div", ot, [
        ...
        D(f(M), {
          ...
          default: N(() => [
            (O(!0), I(R, null, U(f(K), (u) => (O(), $(f(L), z(C(u)), null, 16))), 256))
          ]),
          _: 1
        }, 8, ["modelValue"])
      ])
