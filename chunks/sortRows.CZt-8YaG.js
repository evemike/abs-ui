...
import { defineComponent as A, toRefs as j, ref as Y, computed as D, resolveComponent as y, openBlock as U, createElementBlock as E, createVNode as e, withCtx as n, createElementVNode as N, unref as t, Fragment as P, renderList as I, createTextVNode as G } from "vue";
import { m as K, d as L, e as s, f as w, bb as O, ap as q, aE as B, bc as H, bd as J, ay as M, aq as F } from "./vendor.vR4RX31U.js";
...
const W = { class: "container-lef" }, X = { class: "h-full flex justify-center items-center" }, Z = { class: "flex" }, $ = /* @__PURE__ */ A({
  ...
  setup(k) {
    ...
    return (a, i) => {
      const V = y("el-input"), g = y("el-col"), C = y("el-switch"), R = y("el-row");
      return U(), E("div", null, [
        e(R, { gutter: 10 }, {
          default: n(() => [
            e(g, { span: 8 }, {
