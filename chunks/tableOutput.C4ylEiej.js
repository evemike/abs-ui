...
import { _ as me, a as be, b as fe, c as he, d as ye, e as we, f as ke, g as Ne, h as xe, i as Te, j as Ve, k as Ce, l as Ye, m as $e, n as De, o as Pe, p as Fe, q as Ie, r as Oe, s as qe, t as Le, u as Ee, v as je, w as ze, x as Se, y as Ue, z as Be, A as Me, B as Re, C as Ge, D as Ae, E as He, F as Je, G as Ke, H as Qe, I as We, J as Xe, K as Ze, L as ea, M as aa, N as ta, O as ia, P as na, Q as la, R as sa, S as oa, T as _a, U as ra, V as ca, W as pa, X as ua, Y as da, Z as ga, $ as va, a0 as ma, a1 as ba, a2 as fa, a3 as ha, a4 as ya, a5 as wa, a6 as ka, a7 as Na, a8 as xa, a9 as Ta, aa as Va, ab as Ca } from "./table.DtQlpGd_.js";
import { defineComponent as ee, ref as ne, reactive as X, h as F, toRefs as Ya, watch as ge, openBlock as y, createElementBlock as E, createElementVNode as M, createVNode as w, unref as t, createBlock as ae, withCtx as I, createTextVNode as le, toDisplayString as $a, createCommentVNode as Da, computed as Z, onMounted as Pa, Fragment as _e, renderList as re, withModifiers as ce } from "vue";
import { bh as pe, f as se, aD as Fa, bm as Ia, _ as Oa, aP as qa, g as f, d as ue, e as B, as as oe, aL as La, O as te, aq as Ea, at as T, a as de, au as K } from "./vendor.jH9g53BU.js";
...
const ja = {
    ...
    const j = /* @__PURE__ */ Object.assign({ "./icon/airbyte.png": me, "./icon/airflow.png": be, "./icon/amazon-s3.png": fe, "./icon/amundsen.png": he, "./icon/athena.png": ye, "./icon/atlas.png": we, "./icon/azuresql.png": ke, "./icon/bigquery.png": Ne, "./icon/clickhouse.png": xe, "./icon/databrick.png": Te, "./icon/dbt.png": Ve, "./icon/delta-lake.png": Ce, "./icon/domo.png": Ye, "./icon/doris.png": $e, "./icon/druid.png": De, "./icon/dynamodb.png": Pe, "./icon/glue.png": Fe, "./icon/googleCloudService.png": Ie, "./icon/hive.png": Oe, "./icon/ibmdb2.png": qe, "./icon/iceberg.png": Le, "./icon/impala.png": Ee, "./icon/kafka.png": je, "./icon/kinesis.png": ze, "./icon/looker.png": Se, "./icon/mariadb.png": Ue, "./icon/metabase.png": Be, "./icon/mlflow.png": Me, "./icon/mode.png": Re, "./icon/mongodb.png": Ge, "./icon/mssql.png": Ae, "./icon/mysql.png": He, "./icon/oracle.png": Je, "./icon/pinot.png": Ke, "./icon/postgres.png": Qe, "./icon/power-bi.png": We, "./icon/presto.png": Xe, "./icon/qliksense.png": Ze, "./icon/quicksight.png": ea, "./icon/redash.png": aa, "./icon/redpanda.png": ta, "./icon/redshift.png": ia, "./icon/sagemaker.png": na, "./icon/salesforce.png": la, "./icon/saphana.png": sa, "./icon/singlestore.png": oa, "./icon/snowflakes.png": _a, "./icon/sqlalchemy.png": ra, "./icon/sqlite.png": ca, "./icon/superset.png": pa, "./icon/tableau.png": ua, "./icon/trino.png": da, "./icon/vertica.png": ga }), z = /* @__PURE__ */ Object.assign({ "./svg/dakaishujukulianjie.svg": va, "./svg/database.svg": ma, "./svg/field.svg": ba, "./svg/icon_clickhouse.svg": fa, "./svg/liebiaoziduanguanli.svg": ha, "./svg/mongodb.svg": ya, "./svg/mysql.svg": wa, "./svg/oracle.svg": ka, "./svg/postgresql.svg": Na, "./svg/schema.svg": xa, "./svg/server.svg": Ta, "./svg/shujuku.svg": Va, "./svg/table.svg": Ca }), G = Y, { serverId: S, schemaIds: A, groups: H, testConnect: O } = G, q = R, L = (r, c) => {
      ...
      setup(r, c) {
        const { id: v = "", groups: N } = r, d = { label: "label", leaf: "isLeaf", children: "children", value: "value", emitPath: !1 }, m = X([]), D = async () => {
          m.length = 0;
          const u = await ie(), P = Oa(u.data, "serviceType"), n = Object.keys(P).filter((a) => N.length > 0 ? N.includes(a) : !0).map((a) => ({ label: a, value: a, data: a, icon: a, type: "group", children: P[a].map((o) => ({ group: a, label: o.displayName || o.name, type: u.type, value: o.id, data: o, isLeaf: !0 })) }));
          if (m.push(...n), v) {
        ...
        const W = (u) => {
          if (u.isLeaf) {
            const P = u.value, J = u.data;
            Q = P, c.emit("up:id", P), c.emit("up:server", J), console.log("Server --------------", P, J);
          }
        };
        return D(), () => F(pe, { modelValue: Q, options: m, props: { ...d } }, {
          default: ({ data: u }) => F("div", { style: "display:flex;align-items:center;gap:.5em;", onClick: () => W(u) }, [
            F("img", { style: "height:1em;max-height:1em;", src: L(u.type == "group" ? u.label : u.type, u.type), title: `${u.type} - ${u.label}` }),
            F("span", u.label)
          ])
        });
      }
      ...
      setup(r, c) {
        const { server: v } = Ya(r), { ids: N = [] } = r, d = X([...N]), m = X([]), D = (n = []) => {
          ...
          if (n) {
            ...
            D();
        }, u = { label: "label", leaf: "isLeaf", children: "children", value: "value", lazy: !0, emitPath: !0, multiple: !1, checkStrictly: !1 }, P = async (n, a) => {
          const o = n.data;
          let x = [];
          if (o && o.children)
            x = o.children;
        ...
        }), () => F(pe, { modelValue: d, options: m, props: { ...u, lazyLoad: P }, "onUpdate:modelValue": (n) => {
          console.log("------->", n);
        } }, {
          default: ({ data: n }) => F("div", { style: "display:flex;align-items:center;gap:.5em;", onClick: () => J(n) }, [
            F("img", { style: "height:1em;max-height:1em;", src: L(n.type), title: `${n.type} - ${n.label}` }),
            F("span", n.label)
          ])
        });
      }
    }), ve = qa(() => {
      q("change", p.value, V, $, e);
    }, 500);
    return (r, c) => {
      var v, N;
      return y(), E("div", ja, [
        M("div", za, [
          w(t(h), {
            ...
            groups: t(H),
            "onUp:server": g,
            "onUp:id": c[0] || (c[0] = (d) => q("update:serverId", d))
          }, null, 8, ["id", "groups"]),
          w(t(b), {
            class: "min-w-400",
            ids: t(A),
            server: p.value,
            "onUp:ids": c[1] || (c[1] = (d) => q("update:schemaIds", d)),
            "onUp:database": _,
            "onUp:name": i
          }, null, 8, ["ids", "server"]),
          M("div", null, [
            t(O) != null ? (y(), ae(t(se), {
              key: 0,
              loading: s.value,
              icon: l[(v = p.value) == null ? void 0 : v.id] == !0 ? t(Fa) : t(Ia),
  ...
  setup(Y, { emit: R }) {
    const j = Y, { inputProps: z, outputProps: G, formdata: S, outputFileds: A, inputFileds: H, data: O = [] } = j, q = R, L = Z(() => f(S, H) || []), s = Z(() => f(S, A) || []), l = Z(() => {
      ...
      return t(L).map((i) => ({ name: f(i, e.name), type: f(i, e.type), remark: f(i, e.remark) }));
    }), g = ne(O), k = () => {
      const e = [];
      for (const i of t(p)) {
    ...
    const h = (e, i) => {
      ...
      if (t(g).length > 0) {
        ...
        q("change", e), q("update:data", t(g));
      }
    };
    return Pa(() => {
      O.length != t(L).length && k();
    }), (e, i) => (y(), E("div", Ua, [
      M("div", Ba, [
        w(t(ue), {
          data: p.value,
            ...
            w(t(B), {
              ...
              default: I((_) => [
                w(t(oe), {
                  ...
                  default: I(() => [
                    (y(!0), E(_e, null, re(l.value, (b) => (y(), ae(t(La), {
                      label: b.label,
                      value: b.value
