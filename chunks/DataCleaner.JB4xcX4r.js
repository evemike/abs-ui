...
import { defineComponent as oe, toRefs as ne, ref as v, reactive as P, onMounted as se, resolveComponent as L, openBlock as A, createElementBlock as G, createTextVNode as B, createVNode as n, unref as u, withCtx as p, createElementVNode as I, toDisplayString as ue, Fragment as re, renderList as ie, createBlock as de, nextTick as j } from "vue";
import { ay as Q, A as pe, B as F, af as ce, H as W, y as X, z as b, ax as Y, a as fe } from "./vendor.4pP_Prrf.js";
...
const ve = ["int", "long", "short", "float", "double"], Z = [
  ...
  setup(f) {
    const x = f, { formdata: C, inputV: O, propOutput: E, propInput: J } = ne(x), M = v(!1), k = () => {
      ...
      m.value.length === e.cleaningData.length ? j(() => {
        var t;
      ...
      await ((t = _.value) == null ? void 0 : t.validate((a, l) => {
        a ? (H(), y()) : console.log("error submit!", l);
      }));
    }, U = v(""), w = v(""), le = Q(() => {
                            ...
                            n(d, {
                              ...
                              default: p(() => [
                                n(r, {
                                  ...
                                  default: p(() => [
                                    (A(!0), G(re, null, ie(u($)(i.type), (c) => (A(), de(o, {
                                      label: c.label,
                                      value: c.value,
                                      key: c.value
