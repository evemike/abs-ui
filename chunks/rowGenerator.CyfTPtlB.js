import { defineComponent as k, toRefs as R, ref as $, resolveComponent as C, openBlock as u, createElementBlock as I, createElementVNode as w, createVNode as l, unref as a, withCtx as t, createTextVNode as x, Fragment as S, renderList as h, createBlock as A } from "vue";
import { f as v, d as L, e as s, as as b, aL as g, au as P, y, at as z } from "./vendor.jH9g53BU.js";
const X = `{
  "formatters": {
    "localDateFormats": [
      "",
...
`, F = /* @__PURE__ */ w("div", { style: { "font-weight": "bold", display: "inline-block", "font-size": "15px" } }, "条件：", -1), G = { style: { display: "inline-block", "margin-bottom": "5px", "margin-right": "5%" } }, J = /* @__PURE__ */ k({
  __name: "editTable",
  props: {
    formData: { default: () => ({}) },
    preview: {}
  ...
  setup(U) {
    const V = U, { formData: r, preview: B } = R(V), i = JSON.parse(X), M = i.formatters.formats;
    ...
    const N = async () => {
      var d, _, o;
      ((o = (_ = (d = r.value) == null ? void 0 : d.fields) == null ? void 0 : _.field) == null ? void 0 : o.length) != 0 && B.value && B.value();
    };
    return (d, _) => {
      const o = C("el-input"), D = C("el-form");
      return u(), I("div", null, [
        w("div", null, [
          F,
          w("div", G, [
...
}, tabs: [
  {
    ...
    column: [
      ...
      { prop: "never_ending", label: "从不停止生成行", tag: z, inlinePrompt: !0, activeValue: "Y", inactiveValue: "N", activeText: "Y", inactiveText: "N" },
