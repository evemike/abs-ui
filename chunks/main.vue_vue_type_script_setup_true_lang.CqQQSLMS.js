import { unref as g, computed as q, useAttrs as U, ref as z, toRef as w, h as x, onUnmounted as K, defineComponent as H, useSlots as Y, reactive as C, onMounted as T, watch as D, onBeforeUnmount as J, openBlock as Q, createElementBlock as X, createVNode as Z } from "vue";
import { a as A, E as ee } from "./main.DvwxyXtf.js";
import { aH as te, a_ as G, a4 as b, i as $, B as y, a$ as L, b0 as I, b1 as se, b2 as re, az as N, m as oe, o as ne, b3 as O, r as le, q as ce, b4 as ie, n as ae, e as ue, aN as fe, aD as de, L as me, aP as he, b5 as pe, aO as ge } from "./vendor.oF5jPd5s.js";
const k = (n = [], e = () => {
}, t = {}) => {
...
((n) => {
  n.buildRules = (e) => {
    const t = g(e.required) ?? !1, o = g(e.trigger) ?? "blur", s = b(e, "message") ? A.getExpValue(g(e.message), e) : b(e, "label") ? A.getExpValue(j.required, e) : "", r = $(g(e.rules)) ? [...g(e.rules)] : [], u = Object.keys(j), i = [];
    let l = !1;
    return r.forEach((c) => {
      var m;
      const a = { ...g(c) }, f = ((m = u.filter((h) => b(a, h))) == null ? void 0 : m[0]) || "common", d = a.message || g(e.message) || b(e, "label") ? y(j, f) : "";
      a.message = d ? A.getExpValue(d, { ...e, ...a }) : "", b(a, "required") && (l = !0), b(a, "trigger") || (a.trigger = o), i.push(a);
...
const ye = P.buildRules, ke = P.buildElFormItemProps, Fe = P.isNeedElFormItem, ve = ({ tag: n, parent: e }) => n || (e && b(V, O(e.tagname)) ? V[O(e.tagname)] : le), _e = (n) => {
  ...
  if (!t)
    return;
  const { formProps: o, emitChange: s } = n.context, r = n.parent, u = O(e.tagname), i = O(r == null ? void 0 : r.tagname), l = P.initProp(n), c = l.join("."), a = { isFormElem: !1 };
  if (l.length > 0 && (a.formProp = l), Ie(t, u, i)) {
  ...
  elRadioGroup: ue,
  elSelect: fe
}, Ie = (n, e, t) => g(n.isFormElem) === !0 ? !0 : t && b(V, t) ? O(V[t].name) !== e : !(!P.SELF_FORM_NAMES.includes(e) && !Ae.includes(e)), Oe = (n) => {
  if (n == null || !n)
    return;
  const o = { ...{
    placement: "top-start",
  ...
  setup(n, { expose: e, emit: t }) {
    ...
    T(() => {
      i && a();
    }), i && D(w(s, "modelValue"), (E) => {
      E != l && (c === !1 && E && Object.assign(l, E), c === !0 && (c = !1));
    });
    const d = C(/* @__PURE__ */ new Set()), m = { formProps: d, formData: l, emitChange: f }, p = (s.UIPluging || Pe)(s, m, { slots: u });
    if (s.autoClean) {
      let E = [];
      T(() => {
        E = Array.from(d);
        ...
        R.length > 0 && (R.forEach((S) => I(g(l), S)), E = _, o("update:modelValue", g(l)));
      });
    }
