import { ref as x, markRaw as A, unref as f, defineComponent as Q, watch as B, openBlock as O, createElementBlock as I, createElementVNode as E, createVNode as D, withCtx as N, Fragment as R, renderList as U, createBlock as $, normalizeProps as q, guardReactiveProps as z } from "vue";
import { g as W, a as X } from "./api.CF1BbFLh.js";
import { g as c, aI as L, ba as w, aq as C } from "./vendor.DW1gWLiY.js";
const P = [
  // kafka
  {
    ...
    return B(d, (_) => {
      ...
      E("div", et, [
        ...
        D(f(C), {
          ...
          default: N(() => [
            (O(!0), I(R, null, U(f(h), (u) => (O(), $(f(L), q(z(u)), null, 16))), 256))
          ]),
          _: 1
        }, 8, ["modelValue"])
      ]),
      E("div", ot, [
        ...
        D(f(C), {
          ...
          default: N(() => [
            (O(!0), I(R, null, U(f(K), (u) => (O(), $(f(L), q(z(u)), null, 16))), 256))
          ]),
          _: 1
        }, 8, ["modelValue"])
      ])
