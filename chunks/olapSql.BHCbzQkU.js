import { defineComponent as $, toRefs as j, computed as L, ref as b, resolveComponent as I, openBlock as k, createElementBlock as R, createElementVNode as i, Fragment as K, renderList as Q, unref as _, createBlock as T, withCtx as F, createTextVNode as O, toDisplayString as V, createVNode as N } from "vue";
import { bf as Y, bd as z, B as J, v as M, a as D } from "./vendor.4pP_Prrf.js";
import { C as U } from "./main.ClmZZr2j.js";
const A = {
  "w-full": "",
  "h-full": "",
  "overflow-auto": ""
  ...
  setup(y, { emit: x }) {
    const m = y, v = x, { sourceList: d, sql: p } = j(m), { preview: g } = m, o = L({
      get: () => h(p.value, !1),
      set: (e) => {
        const l = h(e, !0);
        v("update:sql", l), q();
