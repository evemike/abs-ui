...
const q1 = /* @__PURE__ */ j({
  ...
  setup(c) {
    const e = c, { node: t } = e, i = $e("GRAPH-CONTEXT"), { graphForm: a, graphShadow: o } = i, r = x(), s = D(() => {
      const C = ((o == null ? void 0 : o.selectedCells.value) || []).map((m) => m.id);
      return !!(C.length > 0 && C.includes((t == null ? void 0 : t.id) || ""));
    }), n = D(() => {
      var m;
      const A = t == null ? void 0 : t.id, C = (m = o == null ? void 0 : o.currentCell.value) == null ? void 0 : m.id;
      return !!(A && C && A == C);
    }), d = D(() => {
      const A = o == null ? void 0 : o.get(t);
      return V(A, "metadata.status.aggregateSnapshot.runStatus") || "";
    }), p = x({});
    return te(() => {
      var A;
      ...
      class: Qe(["default_node_style", d.value, { "is-selected": s.value, "is-current": n.value }])
    }, [
      r.value ? (E(), H(l(z), {
        key: 0,
        elem: r.value,
        params: p.value
      }, null, 8, ["elem", "params"])) : O("", !0)
    ], 2));
  }
}), z1 = [
  {
...
Note: This Processor expects CEF messages WITHOUT the syslog headers (i.e. starting at "CEF:0"`,
  ...
  connecting: {
    ...
    validateConnection({
      ...
      if (!o || !r || o[0] == "in" || r[0] == "out" || (o[1] || r[1]) && o[1] != r[1])
        return !1;
      const s = this.getEdges().filter((C) => C != a), n = s.filter((C) => C.getSourceCell() == c).length, d = s.filter((C) => C.getTargetCell() == e).length;
      return !(o[2] && Le(o[2]) && n >= Number(o[2]) || r[2] && Le(r[2]) && d >= Number(r[2]));
    }
  },
  highlighting: {
  ...
  // 
  defaultLabel: {
    markup: r1.getForeignObjectMarkup(),
    attrs: {
      fo: {
        width: 30,
        height: 30,
      ...
      cls: [
        {
          ...
          cls: [
            { tag: le, "#reference": "", class: "_node-tip-icon", cls: { tag: s1 } },
  ...
  cls: [
    { tag: "div", cls: [
      { tag: "b", class: "_title", cls: [{ tag: le, cls: { tag: Be, ":name": "data.icon" } }, "{{ data.label || '' }}"] }
      // { tag: "b", "@click": "() => close()", class: "_btn", cls: { tag: ElIcon, class: "_close", cls: Close } }
    ] },
    { tag: "div", class: "", cls: [
      { tag: I, "@click": ({ graphEvents: c, close: e, cell: t }) => {
...
W1.newProcessorTypes.filter((c) => c.type.includes("ConsumeAMQP") || c.type.includes("ConsumeIMAP") || c.type.includes("ConsumeJMS")).map((c) => {
    ...
    tabs: [
      {
        label: "基础信息",
        type: "elem",
        elem: { tag: T, prop: "node.label", ":modelValue": "label", "@update:modelValue": ({ label: t, $: i }) => {
          t.value = i[0];
        } }
      },
      {
...
function At(c, e) {
  return E(), M("svg", lt, pt);
}
const ht = /* @__PURE__ */ U1(nt, [["render", At]]), Ct = /* @__PURE__ */ j({
  __name: "drawer",
  props: {
    context: {},
    config: { default: () => ({
  ...
  setup(c) {
    ...
    const s = D(() => {
      ...
      tt
    )), d = D(() => r.value ? a.getTabs(r.value).value : []), p = D(() => d.value.map((u, f) => u.default ? "default-tab" : f + "")), A = D(() => ({ ...i, cell: r.value, data: r.value ? a.get(r.value) : {}, formStatus: r.value ? o.getCellStatus(r.value) : {} })), C = x(), m = d1((u, f) => {
      f && (C.value = f), o.validateForm(f || C.value, u);
    }, 100);
    return (u, f) => (E(), H(l(qe), De({
      "modal-class": "_graph-drawer",
      "text-14": ""
    }, l(t), {
      modelValue: l(o).visible.value,
      "onUpdate:modelValue": f[5] || (f[5] = (h) => l(o).visible.value = h)
    }), {
      header: N(({ close: h, titleId: w, titleClass: y }) => [
        s.value ? (E(), H(l(z), {
          key: s.value,
          elem: n.value,
          params: A.value,
          context: { params: { close: h, titleId: w, titleClass: y } }
        }, null, 8, ["elem", "params", "context"])) : O("", !0)
      ]),
      default: N(() => [
        d.value.length > 0 ? (E(), M(J, { key: 0 }, [
          d.value.length > 1 ? (E(), H(l(l1), {
            "model-value": "default-tab",
            key: s.value
          }, {
            default: N(() => [
              (E(!0), M(J, null, ee(d.value, (h, w) => (E(), H(l(c1), {
                key: w + "-" + s.value,
                name: p.value[w],
                label: h.label
              }, {
                default: N(() => [
                  h.prop != null ? (E(), H(l(se), {
                    key: 0,
                    ref_for: !0,
                    ref: (y) => C.value = y,
                    onChange: () => l(m)(h),
                    "model-value": l(V)(l(o).data.value[s.value], h.prop),
                    "onUpdate:modelValue": (y) => {
                      const Q = {};
                      l(Z)(Q, h.prop, y), l(o).resetCellFormData(s.value, Q);
                    },
                    params: A.value,
                    column: h.column
                  }, null, 8, ["onChange", "model-value", "onUpdate:modelValue", "params", "column"])) : h.type === "form" ? (E(), H(l(se), {
                    key: 1,
                    ref_for: !0,
                    ref: (y) => C.value = y,
                    onChange: () => l(m)(h),
                    "model-value": l(o).data.value[s.value],
                    "onUpdate:modelValue": f[0] || (f[0] = (y) => l(o).resetCellFormData(s.value, y)),
                    params: A.value,
                    column: h.column
                  }, null, 8, ["onChange", "model-value", "params", "column"])) : (E(), H(l(z), {
                    key: 2,
                    elem: h.elem,
                    params: A.value,
                    context: { params: { index: w } }
            ...
            d.value[0].prop != null ? (E(), H(l(se), {
              key: 0,
              ref: (h) => C.value = h,
              onChange: f[1] || (f[1] = () => l(m)(d.value[0])),
              "model-value": l(V)(l(o).data.value[s.value], d.value[0].prop),
              "onUpdate:modelValue": f[2] || (f[2] = (h) => {
                const w = {};
                l(Z)(w, d.value[0].prop, h), l(o).resetCellFormData(s.value, w);
              }),
              params: A.value,
              column: d.value[0].column
            }, null, 8, ["model-value", "params", "column"])) : d.value[0].type === "form" ? (E(), H(l(se), {
              key: 1,
              ref: (h) => C.value = h,
              onChange: f[3] || (f[3] = () => l(m)(d.value[0])),
              "model-value": l(o).data.value[s.value],
              "onUpdate:modelValue": f[4] || (f[4] = (h) => l(o).resetCellFormData(s.value, h)),
              params: A.value,
              column: d.value[0].column
            }, null, 8, ["model-value", "params", "column"])) : (E(), H(l(z), {
              key: 2,
              elem: d.value[0].elem,
              params: A.value,
...
class gt {
  ...
  constructor(e) {
    ...
    g(this, "selectedCells", x([]));
    g(this, "clipboardCells", x([]));
    g(this, "clickHandle");
  ...
  cell() {
    ...
    (e = this.graph) == null || e.on("cell:added", (d) => {
      ...
      var u, f;
      const { cell: p, x: A, y: C } = d, m = (u = this.graph) == null ? void 0 : u.localToGraph({ x: A, y: C });
      (f = this.contextmenuRef.value) == null || f.open(m, p), this.eventCall("cell:contextmenu", d);
...
class ft {
  ...
  initCell(e) {
    const t = e.id;
    if (this.status.set(t, F({ result: !0, info: [] })), ne(this.data.value, t) || (this.data.value[t] = {}), !this.cellColumn.has(t)) {
  ...
  getCellStatus(e) {
    return this.status.has(e.id) || this.status.set(e.id, F({ result: !0, info: [] })), this.status.get(e.id);
  }
  // // 初始化节点表单
  // initNode(id:string){
  //   if(!has(this.data,id)){
  ...
  async validateCell(e) {
    const t = e.id, i = this.data.value[t] || {}, a = this.cellColumn.get(t) || [], { status: o, info: r } = await Y1.valideForm(i, a), s = this.getCellStatus(e);
    if (!s)
      return;
    if (o) {
...
const ut = { class: "_search" }, wt = ["onMousedown", "title"], mt = { class: "_label" }, Bt = /* @__PURE__ */ j({
  __name: "nodeList",
  props: {
  ...
  setup(c) {
    const e = c, t = F(), { graph: i, nodeList: a } = ce(e), { initNodeFn: o } = e, r = F(""), s = F(), n = F([]), d = p1(r, 500), p = D(() => {
      const m = d.value;
      let u = a.value || [];
      m ? (u = u.filter(({ label: w, name: y, group: Q }) => w.includes(m) || y.includes(m) || (Q == null ? void 0 : Q.includes(m))), n.value.push(...u.map((w) => w.group || ""))) : n.value = [];
      const f = [], h = [];
      for (const w of u) {
        const { group: y = "默认分组" } = w, Q = f.indexOf(y);
        Q > -1 ? h[Q][1].push(w) : (f.push(y), h.push([y, [w]]));
      }
      return console.log("====>", u, h), h;
    }), A = () => {
      i.value && (s.value = new g1({
        target: i.value,
      ...
      if (!f)
        return;
      s.value || A(), m.shape || (m.shape = "vue-node"), m.ports || (m.ports = {});
      const h = m.ports;
      if (h.groups || (h.groups = ze.groups), o) {
        try {
          o(m).then((Q) => {
            var L;
            return (L = s.value) == null ? void 0 : L.start(f.createNode(Q), u);
          });
        } catch (Q) {
          console.warn(Q);
        }
      ...
      (y = s.value) == null || y.start(f.createNode(w), u);
    };
    return te(() => {
      A();
    }), (m, u) => (E(), M("div", {
      ...
      v(l(h1), {
        ...
        default: N(() => [
          (E(!0), M(J, null, ee(p.value, ([f, h]) => (E(), H(l(C1), {
            key: f,
            title: f,
            name: f
          }, {
            default: N(() => [
              (E(!0), M(J, null, ee(h, (w) => (E(), M("div", {
                class: "_node_item",
                onMousedown: (y) => C(w, y),
                title: w.label
              }, [
  ...
  if (a) {
    ...
    const n = new Array().concat(o), d = i.map((p) => ({ ...p, $_key: n.map((A) => V(p, A) || "").join() }));
    t = Se(d, "$_key");
  } else
    s ? t = Se(i, s) : r && (t = r(i));
  return t;
  ...
  return i && (t = f1(t, i)), a && (t = a(t)), o && (t = t.reverse()), t;
}, Ft = (c, e) => {
  let t = [...c];
...
`, Dt = { class: "_menu" }, It = {
  ...
  setup(c, { expose: e }) {
    const t = c, { context: i } = t, { config: a } = ce(t), o = i == null ? void 0 : i.graphTools, r = i == null ? void 0 : i.markdownRef, s = [
      { title: "导出", key: "export", icon: u1, handle: () => o == null ? void 0 : o.export() },
      { title: "导入", key: "import", icon: w1, handle: () => o == null ? void 0 : o.import() },
      { title: "撤销", key: "undo", icon: m1, handle: () => o == null ? void 0 : o.undo() },
      { title: "恢复", key: "redo", icon: B1, handle: () => o == null ? void 0 : o.redo() },
      { title: "放大", key: "zoomBig", icon: y1, handle: () => o == null ? void 0 : o.zoomBig() },
      { title: "缩小", key: "zoomSmall", icon: E1, handle: () => o == null ? void 0 : o.zoomSmall() },
      { title: "保存", key: "save", icon: Ie, handle: () => o == null ? void 0 : o.zoomSmall() },
      { title: "帮助", key: "help", icon: F1, handle: () => {
        var d;
        return (d = r == null ? void 0 : r.value) == null ? void 0 : d.init(Qt);
      } },
      { key: "fullscreen", title: D(() => o != null && o.isFullScreen.value ? "退出全屏" : "全屏"), type: D(() => o != null && o.isFullScreen.value ? "primary" : "default"), icon: Me, handle: () => o == null ? void 0 : o.toggleFullScreen() }
    ], n = D(() => {
      const { elems: d = [], filter: p, order: A, group: C } = l(a) || {}, m = [...s, ...l(d)];
      let u = m;
      return p && (u = Ft(m, p)), A && (u = Et(u, A)), C && (u = yt(u, C)), console.log("menu - list = ", u, d, p, A, C, a.value), u && !Array.isArray(u) && (u = Object.keys(u).map((f) => V(u, f))), u;
    });
    return e({}), (d, p) => (E(), M("div", Dt, [
      (E(!0), M(J, null, ee(n.value, (A) => (E(), M(J, null, [
        Array.isArray(A) ? (E(), M("div", It, [
          (E(!0), M(J, null, ee(A, (C) => (E(), M(J, null, [
            C.tag ? (E(), H(l(z), {
              key: 0,
              elem: A,
              params: l(i)
            }, null, 8, ["elem", "params"])) : (E(), H(l(I), {
              key: 1,
              onClick: C.handle,
              title: C.title,
              icon: C.icon
  ...
  setup(c, { expose: e }) {
    const t = c, { config: i, context: a } = t, { elem: o } = ce(t), r = x(o.value || {}), { showFooter: s, ...n } = i, d = x(n), p = F(!1), A = (h) => {
      h && (r.value = h), r.value && (p.value = !0);
    }, C = () => {
      p.value = !1;
    }, m = (h, w) => {
      typeof h == "string" ? d.value[h] = w : d.value = _({}, n, h);
    }, u = () => {
...
class Lt {
  ...
  initCell(e) {
    ...
    const o = {
      ...
      status: F({}),
      // step:ref("init"),
      step: F(a === "Disabled" ? "disabled" : "init"),
      label: F(t.prop("label") || i.label || ""),
      desc: F(t.prop("desc") || i.desc || ""),
    ...
    t.isEdge() && (o.source = F(((s = t == null ? void 0 : t.source) == null ? void 0 : s.cell) || ""), o.target = F(((n = t == null ? void 0 : t.target) == null ? void 0 : n.cell) || ""), o.labelConfig = x({})), t.isNode() && (o.inCells = F(/* @__PURE__ */ new Set()), o.outCells = F(/* @__PURE__ */ new Set())), this.cells.set(t.id, o);
  }
  //
  updateEdge(e) {
  ...
  resetSelectedCells(e = []) {
    this.selectedCells.value = e, e.length > 0 ? Y.success(`已选中 [ ${e.length} ] 个元素`) : Y.info("取消选中");
  }
  //
  removeCells(e = []) {
    var i, a;
  ...
  resetClipboardCells(e = []) {
    this.clipboardCells.value = e, e.length > 0 && Y.success(`已复制 [ ${e.length} ] 个元素`);
  }
  //
  addSelectedCell(e) {
...
const xt = {
  ...
  class: /* @__PURE__ */ Qe(["_running-box"])
}, Gt = /* @__PURE__ */ B("span", { style: { "--i": "1" } }, null, -1), Rt = /* @__PURE__ */ B("span", { style: { "--i": "2" } }, null, -1), Pt = /* @__PURE__ */ B("span", { style: { "--i": "3" } }, null, -1), Vt = /* @__PURE__ */ B("span", { style: { "--i": "4" } }, null, -1), Ot = /* @__PURE__ */ B("span", { style: { "--i": "5" } }, null, -1), Kt = /* @__PURE__ */ B("span", { style: { "--i": "6" } }, null, -1), Ut = /* @__PURE__ */ B("span", { style: { "--i": "7" } }, null, -1), Yt = /* @__PURE__ */ B("span", { style: { "--i": "8" } }, null, -1), Jt = /* @__PURE__ */ B("span", { style: { "--i": "9" } }, null, -1), Tt = /* @__PURE__ */ B("span", { style: { "--i": "10" } }, null, -1), Zt = [
  Gt,
  Rt,
  Pt,
  Vt,
  ...
  setup(c) {
    var ie, oe;
    const e = c, { edge: t, context: i } = e, { graphShadow: a, graph: o, graphForm: r } = i, s = D(() => {
      const b = e.config, S = a.getEdgeLabelConfig(t).value || {};
      return { enabled: !0, icon: 0, icons: [b1], prop: "edge", params: {}, title: "", ...b, ...S };
    }), { icon: n, prop: d, params: p } = l(s), A = r.getCellFormData(t), C = a.getEdgeData(t), m = C.source, u = C.target, f = C.step, h = C.label, w = (ie = o.value) == null ? void 0 : ie.getCellById(l(m)), y = (oe = o.value) == null ? void 0 : oe.getCellById(l(u)), Q = F(l(n)), L = D(() => {
      const b = s.value.icons[l(Q)];
      return b.icon ? b : { icon: b };
    }), k = F(!1), q = F(!1);
    let K;
    const U = (b) => {
      window.clearTimeout(K), b === !1 ? K = setTimeout(() => {
        k.value = !1;
      }, 500) : k.value = !0;
    }, de = () => {
      const b = s.value.icons;
      if (l(b).length == 1)
        return;
      Q.value >= b.length - 1 ? Q.value = 0 : Q.value++;
      const S = b[Q.value];
      A[d] = typeof S == "string" ? Q.value : S.value;
    };
    return te(() => {
    }), (b, S) => s.value.enabled ? (E(), M("div", xt, [
      v(l(Te), {
        placement: "top",
        width: "auto",
        teleported: !1,
        visible: q.value || k.value,
        ...
        reference: N(() => [
          B("div", {
            class: "_icon-box",
            onClick: de,
            onMouseenter: S[0] || (S[0] = () => U(!0)),
            onMouseleave: S[1] || (S[1] = () => U(!1))
          }, [
            B("span", {
              flex: "",
              "items-center": "",
              ...
              "rd-4": "",
              "p-x-4": "",
              style: Ke(l(h) ? "" : "border:none;padding:0;")
            }, [
              v(l(le), {
                class: Qe([]),
                "text-16": ""
        ...
        default: N(() => [
          B("div", {
            class: "_popover-box",
            onMouseenter: S[3] || (S[3] = () => U(!0)),
            onMouseleave: S[4] || (S[4] = () => U(!1))
          }, [
            B("div", jt, [
              B("b", qt, G(s.value.title), 1),
              v(l(I), {
                link: "",
                type: q.value ? "primary" : "info",
                onClick: S[2] || (S[2] = (ye) => q.value = !q.value)
              }, {
                icon: N(() => [
                  v(l(Be), {
                    name: "#icon-tuding",
            ...
            s.value.elem ? (E(), M("div", zt, [
              v(l(z), {
                elem: s.value.elem,
                params: { edge: l(t), sourceNode: l(w), targetNode: l(y), ...l(i), ...l(p) }
              }, null, 8, ["elem", "params"])
            ])) : O("", !0)
          ], 32)
        ]),
  ...
  setup(c, { expose: e }) {
    const i = i1(c, "value"), a = F(i.value || ""), o = (A) => {
      /\.md$/.test(A) && fetch(A).then((C) => C.text()).then((C) => {
        d(C);
      });
    }, r = (A) => {
    }, s = async (A) => {
    ...
    return X(i, (A = "") => {
      ...
      default: N(() => [
        v(l(J1), { value: a.value }, null, 8, ["value"])
      ]),
      _: 1
    }, 8, ["modelValue"]));
  }
...
class _t {
  ...
  //
  initMenus() {
    const e = this.config.node || [], t = this.config.edge || [], i = this.config.blank || [], o = this.config.useDefaultMenu ?? !0 ? { node: [...ot], edge: [...it], blank: [...at] } : { node: [], edge: [], blank: [] };
    return e.length > 0 && (o.node = new Array().concat(e, o.node.length > 0 ? [{ tag: R }, o.node] : [])), t.length > 0 && (o.edge = new Array().concat(t, o.edge.length > 0 ? [{ tag: R }, o.edge] : [])), i.length > 0 && (o.blank = new Array().concat(i, o.blank.length > 0 ? [{ tag: R }, o.blank] : [])), o;
  }
  // 创建右键菜单
  createContextmenu(e, t) {
    ...
    if (i === "node") {
      ...
      s && Array.isArray(s) && s.length > 0 && (a = [...s, { tag: R }, ...a]);
    }
...
const $t = /* @__PURE__ */ j({
  ...
  setup(c, { expose: e }) {
    ...
    return e({
      ...
      style: Ke(`position:absolute;z-index:9999;left:${l(i).x.value}px;top:${l(i).y.value}px`)
    }, [
      (E(), H(l(z), {
        key: l(i).key.value,
        elem: l(i).menu.value,
        params: l(i).params.value,
        context: { params: { ElMessage: l(Y), ElNotification: l(v1) } }
      }, null, 8, ["elem", "params", "context"]))
    ], 4)), [
      [Ye, l(i).visible.value]
    ]);
  }
}), ei = { class: "_box-main" }, ti = { class: "_main-content" }, ii = {
  name: "ElsX6"
}, oi = /* @__PURE__ */ j({
  ...ii,
  props: {
  ...
  setup(c, { expose: e }) {
    const t = c, { viewModel: i, nodeListConfig: a } = ce(t), { graphConfig: o, menuConfig: r, pluginsConfig: s, contextmenuConfig: n, edgeLabelConfig: d, defaultNodeMarkup: p, register: A, events: C } = t, m = L1(), u = x(), f = F(), h = F(), w = F(), y = F(), Q = F(), L = F(), k = F(), q = F(), K = new Lt().resetDefaultNodeMarkup(p), U = new ft(K), de = new gt({ graphShadow: K, graphForm: U, contextmenuRef: L, events: C, containerBox: w }), ie = new vt(s), oe = new St({ elsX6Ref: f }), b = {
      graph: u,
      graphShadow: K,
      graphForm: U,
      graphEvents: de,
    ...
    return ae("GRAPH-SHADOW", K), ae("GRAPH", u), ae("GRAPH-FORM", U), ae("GRAPH-MARKDOWN", y), ae("GRAPH-CONTEXT", b), rt(), st(), A && A(Ee), te(() => {
      const S = _(X1, o);
      u.value = W(new Ee({
        ...S,
        // 自定义 边的弹出展示
        onEdgeLabelRendered: (ye) => {
          const { selectors: pe, edge: Ae } = ye, be = pe.foContent;
          be && o1(
            Je(Wt, {
              edge: Ae,
              config: d,
        ...
        container: h.value
      })), ie.usePlugins(u.value), K.setGraph(u.value), U.setGraph(u.value), oe.init(u.value), de.resetGraph(u.value).registerEvent().onMounted(b);
    }), e({
      graph: u
    }), (S, ye) => {
      var pe, Ae;
      return E(), M("div", {
        ...
        v(ht),
        B("div", ei, [
          (pe = l(a)) != null && pe.enabled || !l(i) ? (E(), H(Bt, De({
            key: 0,
            graph: u.value
          }, l(a)), null, 16, ["graph"])) : O("", !0),
          B("div", ti, [
            ((Ae = l(r)) == null ? void 0 : Ae.enabled) !== !1 || !l(i) ? (E(), H(Mt, {
              key: 0,
              ref_key: "menuRef",
              ref: q,
              class: "_menu",
...
}), ai = "/openmetadata-api", We = (c) => {
  const e = ai + "/openMetadata/query", t = new FormData();
  ...
  const e = F({}), t = F({}), i = F([]), a = F([]), o = F([]), r = F([]), s = "name", n = [
    // kafka
    {
  ...
  return ri().then((p) => {
    i.value = p.data, o.value = p.data.map((A) => ({ label: A.name, value: A, tag: W(Fe) })), console.log("....", o.value);
  }), X(e, (p) => {
    const A = p == null ? void 0 : p.name;
    A && si(A).then((C) => {
      console.log(C), a.value = C.data, r.value = C.data.map((m) => ({ label: m.name, value: m, tag: W(Fe) }));
    });
  }), X(t, () => {
  }), { valueKey: s, currentKafka: e, currentTopic: t, kafkaList: i, topicList: a, kafkaOptions: o, topicOptions: r, resetFormData: (p, A) => {
    const [C, m] = A;
    Object.keys(C).map((u) => {
      const f = C[u], h = V(l(e), u);
      h != null && Z(p, f, h);
    }), Object.keys(m).map((u) => {
      const f = m[u], h = V(l(t), u);
      h != null && Z(p, f, h);
    });
  }, NIFI_FORMAT_KEYS: n };
}, { kafkaOptions: Ne, topicOptions: Ge, valueKey: ge, currentKafka: fe, currentTopic: ue, resetFormData: Re, NIFI_FORMAT_KEYS: Pe } = ni(), li = {
  "org.apache.nifi.processors.kafka.pubsub.ConsumeKafka_2_6": {
    "bootstrap.servers": { tag: W(P), filterable: !0, allowCreate: !0, defaultFirstOption: !0, valueKey: ge, cls: Ne, ":modelValue": fe, "onUpdate:modelValue": (c) => fe.value = c },
    topic: { tag: W(P), filterable: !0, allowCreate: !0, defaultFirstOption: !0, valueKey: ge, cls: Ge, ":modelValue": ue, "onUpdate:modelValue": (c) => ue.value = c, "@change": ({ formData: c }) => {
      Re(c, Pe);
    } }
  },
    ...
    cls: [
      {
        ...
        column: [
          // 基础信息
          { tag: T, label: "名称", prop: "name", value: "" },
          { tag: T, label: "编号", prop: "id", disabled: !0 },
          //
          { tag: P, label: "从输出", prop: "source.id", "v-if": r.length > 0, cls: r.map((n) => ({ value: n.id, label: n.component.name })) },
          { tag: P, label: "输入", prop: "destination.id", "v-if": s.length > 0, cls: s.map((n) => ({ value: n.id, label: n.component.name })) },
          // 连线规则 关系
          { tag: xe, label: "输出数据流", value: i.length == 1 ? [i[0].name] : [], "v-if": i.length > 0, required: !0, prop: "selectedRelationships", cls: i.map((n) => ({ tag: me, label: n.name, title: n.description })) },
          // 优先级
          { tag: xe, label: "优先级设置器", prop: "prioritizers", cls: a.prioritizers.map((n) => ({ tag: me, label: n.type, cls: n.type.split(".").reverse()[0] })) },
          //
          { tag: T, label: "FlowFile 过期时间", prop: "flowFileExpiration", value: "0 sec" },
          //
          { tag: T, label: "背压对象阈值", prop: "backPressureObjectThreshold", value: "1000", rules: [{ pattern: /^\d+(\.\d+)?$/, message: "只能输入数字" }] },
          { tag: T, label: "背压大小阈值", prop: "backPressureDataSizeThreshold", value: "1 GB" },
          //
          { tag: P, label: "负载均衡策略", prop: "loadBalanceStrategy", value: "DO_NOT_LOAD_BALANCE", cls: [{ label: "do not load balance", value: "DO_NOT_LOAD_BALANCE" }, { label: "partition by attribute", value: "PARTITION_BY_ATTRIBUTE" }, { label: "round robin", value: "ROUND_ROBIN" }, { label: "single node", value: "SINGLE_NODE" }] },
          { tag: T, label: "属性名称", prop: "loadBalancePartitionAttribute", value: "", "v-if": ({ formData: n }) => n.value.loadBalanceStrategy == "PARTITION_BY_ATTRIBUTE" },
          {
            tag: P,
            label: "负载均衡压缩",
  ...
  const e = c.groupBreadcrumb, t = e.length - 1, i = e.map((a, o) => ({ tag: I, link: !0, key: "elem", type: o == t ? "primary" : "success", cls: a.name, "@click": () => {
    c.initGraph(a.id);
  ...
  useDefaultMenu: !1,
  node: [
    { tag: I, link: !0, icon: he, cls: "编辑", "v-if": ({ cell: t }) => c.nodeType(t) != "FUNNELS", "@click": ({ cell: t, contextmenu: i }) => c.nodeEdit(t, i) },
    { tag: R, "v-if": ({ cell: t }) => c.nodeType(t).includes("PROCESS") },
    { tag: I, link: !0, icon: he, cls: "查看历史", "v-if": ({ cell: t }) => ["PROCESS", "PROCESS-GROUP"].includes(c.nodeType(t)), "@click": ({ cell: t, contextmenu: i }) => c.initCellHistory(t, i) },
    ...
    { tag: R },
    {
      ...
      "@click": ({ cell: t, contextmenu: i, graph: a, graphShadow: o }) => {
        ...
        c.nodeDisable(t, i, s.value == "disabled");
      }
    },
    { tag: R },
    { tag: I, link: !0, icon: $, cls: "删除", "@click": ({ cell: t, contextmenu: i }) => c.nodeDel(t, i) },
    { tag: I, link: !0, icon: $, cls: "批量删除", "v-if": ({ selectedCells: t }) => t.value.length > 1, "@click": ({ selectedCells: t, contextmenu: i }) => c.nodesDel(t.value, i) }
  ],
  edge: [
    { tag: I, link: !0, icon: he, cls: "查看历史", "@click": ({ cell: t, contextmenu: i }) => c.initCellHistory(t, i) },
    { tag: R },
    { tag: I, link: !0, icon: he, cls: "编辑", "@click": ({ cell: t, contextmenu: i }) => c.edgeEdit(t, i) },
    { tag: R },
    { tag: I, link: !0, icon: $, cls: "删除", "@click": ({ cell: t, contextmenu: i }) => c.edgeDel(t, i) }
  ],
  blank: [
    { tag: I, link: !0, icon: Ie, cls: "全选" },
    { tag: I, link: !0, icon: Ze, cls: "复制", ":disabled": "selectedCells.length == 0" },
    { tag: I, link: !0, icon: je, cls: "粘贴", ":disabled": "clipboardCells.length == 0" },
    { tag: R },
    {
      tag: I,
      link: !0,
  ...
  if (!t)
    return;
  const i = (A = e.graphShadow) == null ? void 0 : A.get(c), a = (C = e.graphShadow) == null ? void 0 : C.get(i.source.value), o = (m = e.graphShadow) == null ? void 0 : m.get(i.target.value), r = e.nodeType(a), s = e.nodeType(o);
    ...
    cls: [
      { tag: "fieldset", class: "_node-box _source-node", cls: [
        ...
        { tag: "div", "v-if": r == "PROCESS", cls: [
          { tag: "p", cls: ["输入", { tag: "b", cls: D(() => a.status.value.input) }] },
          { tag: "p", cls: ["读/写", { tag: "b", cls: D(() => `${a.status.value.read} / ${a.status.value.written}`) }] },
          { tag: "p", cls: ["输出", { tag: "b", cls: D(() => a.status.value.output) }] },
          { tag: "p", cls: ["任务/时间", { tag: "b", cls: D(() => `${a.status.value.tasks} / ${a.status.value.tasksDuration}`) }] }
        ] }
      ] },
      {
        tag: "div",
        ...
        cls: [
          ...
          { tag: "p", cls: ["排队等待", { tag: "b", cls: D(() => i.status.value.queued) }] }
        ]
      },
      { tag: "fieldset", class: "_node-box _target-node", cls: [
        { tag: "legend", cls: o.label },
        { tag: "div", "v-if": s == "PROCESS", cls: [
          { tag: "p", cls: ["输入", { tag: "b", cls: D(() => o.status.value.input) }] },
          { tag: "p", cls: ["读/写", { tag: "b", cls: D(() => `${o.status.value.read} / ${o.status.value.written}`) }] },
          { tag: "p", cls: ["输出", { tag: "b", cls: D(() => o.status.value.output) }] },
          { tag: "p", cls: ["任务/时间", { tag: "b", cls: D(() => `${o.status.value.tasks} / ${o.status.value.tasksDuration}`) }] }
        ] }
      ] }
    ]
  };
  ...
  var m, u;
  const t = c.data, i = t.component.type, a = e.nodeType(c), o = ((u = (m = t.component) == null ? void 0 : m.config) == null ? void 0 : u.descriptors) || {}, r = li[i], s = a == "PROCESS" && o ? Object.keys(o).map((f) => {
    const h = o[f], w = h.name, y = h.displayName, Q = h.description, L = h.required, k = h.dependencies.length > 0 ? "select" : "string", q = k == "select" ? h.dependencies.map((U) => ({ label: U.propertyName, value: U.dependentValues[0] })) : [], K = r == null ? void 0 : r[w];
    if (K !== !1)
      return K ? Object.assign({ type: k, prop: w, label: y, desc: Q, required: L, cls: q }, K) : { type: k, prop: w, label: y, desc: Q, required: L, value: h.defaultValue, cls: q };
  }).filter((f) => f != null) : [], n = a == "PROCESS" ? t.component.relationships.map((f, h) => ({
    tag: "p",
    class: "nifi-form-relationships",
    cls: [
      { tag: "span", cls: f.name },
      { tag: me, prop: "relationships." + h + ".autoTerminate", label: "", cls: "Terminate" },
      { tag: me, prop: "relationships." + h + ".retry", cls: "retry", label: "" }
    ]
  })) : [], d = {
    tag: "div",
    "v-if": ({ formData: f }) => {
      var h;
      return ((h = f.value.relationships) == null ? void 0 : h.filter((w) => w.retry).length) > 0;
    },
    cls: [
      { tag: N1, prop: "config.retryCount", label: "重试尝试次数", tip: "For relationships set to retry, this number indicates how many times a FlowFile will attempt to reprocess before it is routed elsewhere." },
      {
        tag: G1,
      ...
      column: [
        {
          ...
          cls: [
            ...
            { tag: P, prop: "config.bulletinLevel", label: "公告级别", cls: [{ value: "DEBUG", label: "调试" }, { value: "INFO", label: "信息" }, { value: "WARN", label: "警告" }, { value: "ERROR", label: "错误" }, { value: "NONE", label: "无" }], tip: "The level at which this processor will generate bulletins." }
          ]
        },
        {
          tag: "fieldset",
          cls: [
            { tag: "legend", cls: "调度" },
            {
              ...
              "@change": ({ formData: f, $: h }) => {
                h[0] == "CRON_DRIVEN" ? (Z(l(f), "config.schedulingPeriod", "* * * * * ?"), Z(l(f), "config.concurrentlySchedulableTaskCount", "1")) : (Z(l(f), "config.schedulingPeriod", "0 sec"), Z(l(f), "config.concurrentlySchedulableTaskCount", "1"));
              },
            ...
            { tag: P, prop: "config.executionNode", label: "执行", cls: [{ value: "ALL", label: "所有节点" }, { value: "PRIMARY", label: "主节点" }], tip: "The node(s) that this processor will be scheduled to run on when clustered." }
          ]
        },
        {
          tag: "fieldset",
    ...
    { label: "控制器配置", type: "elem", elem: { tag: T1, application: "Group", node: t, controllerType: [] } }
  ], C = {
    label: "基础信息",
    type: "form",
    validate: !0,
    ...
    column: [
      {
        ...
        "@update:modelValue": ({ data: f, $: h, cell: w, formData: y }) => {
          var Q, L;
          f.label.value = h[0] || w.data.component.name, Z(l(y), "name", h[0] || w.data.component.name), (Q = e.graphForm) != null && Q.getCellFormData(w) && Z((L = e.graphForm) == null ? void 0 : L.getCellFormData(w), "name", h[0] || w.data.component.name);
        }
      },
      { tag: "p", class: "nifi-form-item", cls: [{ tag: "b", cls: "编号" }, { tag: re, cls: t.id, "@click": () => Y.success(`复制 [ ${t.id} ]`) && Ve(t.id) }] },
      { tag: "p", class: "nifi-form-item", "v-if": t.component.type != null, cls: [{ tag: "b", cls: "类型" }, { tag: re, cls: t.component.type, title: t.component.type, "@click": () => Y.success(`复制 [ ${t.component.type} ]`) && Ve(t.component.type) }] },
  ...
  return a == "PROCESS" ? [C, ...p] : a == "PROCESS-GROUP" ? [C, ...A] : [];
}, hi = { class: "nifi-history" }, Ci = { class: "_left" }, gi = { class: "_info" }, fi = /* @__PURE__ */ B("i", null, "ID", -1), ui = /* @__PURE__ */ B("i", null, "GroupId", -1), wi = { key: 0 }, mi = /* @__PURE__ */ B("i", null, "Source Name", -1), Bi = { key: 1 }, yi = /* @__PURE__ */ B("i", null, "Destination Name", -1), Ei = /* @__PURE__ */ B("i", null, "开始时间", -1), Fi = /* @__PURE__ */ B("i", null, "结束时间", -1), Qi = /* @__PURE__ */ B("p", null, [
  /* @__PURE__ */ B("i", null, "最小值"),
  /* @__PURE__ */ we("/"),
  /* @__PURE__ */ B("i", null, "最大值"),
  /* @__PURE__ */ we("/"),
  /* @__PURE__ */ B("i", null, "平均值")
], -1), Di = { class: "_right" }, Ii = { class: "_header" }, Mi = { class: "_chart-box" }, Hi = /* @__PURE__ */ j({
  __name: "history",
  props: {
    data: {}
  },
  setup(c) {
    ...
    const e = c, { data: t } = ce(e), i = F(), a = F(), o = {
      ...
      const { statusHistory: w } = l(t), { componentDetails: y } = w;
      return y;
    }), s = D(() => {
      const { statusHistory: w } = l(t), { fieldDescriptors: y } = w;
      return y.map((Q) => ({ label: Q.label, value: Q.field, title: Q.description }));
    }), n = F(((h = (f = (u = (m = l(t)) == null ? void 0 : m.statusHistory) == null ? void 0 : u.fieldDescriptors) == null ? void 0 : f[0]) == null ? void 0 : h.field) || ""), d = D(() => {
      var w, y;
      return ((y = (w = l(t)) == null ? void 0 : w.statusHistory) == null ? void 0 : y.aggregateSnapshots) || [];
    }), p = D(() => l(d).map((w) => [w.timestamp, V(w.statusMetrics, l(n))])), A = D(() => l(p).map((w) => w[1])), C = D(() => ({ title: { text: l(n) }, series: [{ name: l(n), data: l(p) || [] }] }));
    return X(C, (w) => {
      var y;
      (y = a.value) == null || y.setOption(w);
    }), te(() => {
      ...
      B("div", Ci, [
        B("div", gi, [
          B("p", null, [
            ...
            B("b", null, G(r.value.Id), 1)
          ]),
          B("p", null, [
            ui,
            B("b", null, G(r.value["Group Id"]), 1)
          ]),
          l(ne)(r.value, "Source Name") ? (E(), M("p", wi, [
            mi,
            B("b", null, G(r.value["Source Name"]), 1)
          ])) : O("", !0),
          l(ne)(r.value, "Destination Name") ? (E(), M("p", Bi, [
            yi,
            B("b", null, G(r.value["Destination Name"]), 1)
          ])) : O("", !0)
        ]),
        B("div", null, [
          B("p", null, [
            Ei,
            B("b", null, G(new Date(d.value[0].timestamp).toLocaleString()), 1)
          ]),
          B("p", null, [
            Fi,
        ...
        B("div", null, [
          Qi,
          B("p", null, G(l(P1)(A.value)) + " " + G(n.value.includes("Bytes") ? "bytes" : "") + " / " + G(l(V1)(A.value)) + " " + G(n.value.includes("Bytes") ? "bytes" : "") + " / " + G(l(O1)(A.value)) + " " + G(n.value.includes("Bytes") ? "bytes" : ""), 1)
        ])
      ]),
      B("div", Di, [
        B("div", Ii, [
          v(l(P), {
            ...
            default: N(() => [
              (E(!0), M(J, null, ee(s.value, (Q) => (E(), H(l(Fe), {
                label: Q.label,
                value: Q.value,
                title: Q.title,
                key: Q.value
...
class vi {
  constructor() {
    ...
    //
    g(this, "currentConnectForm", F({}));
    g(this, "dialogRef");
    //
    g(this, "menuElems", x([]));
    g(this, "menuConfig", x({ enabled: !0, elems: this.menuElems, filter: { key: "key", whiteList: ["elem"] } }));
    //
    g(this, "events", {
      mounted: (e) => {
    ...
    this.apiGetClientId(), this.initProcessType(), this.initPrioritizers(), this.initRoot(), this.apiGetRootStatus(), this.NIFI_DATA = JSON.parse(bi), this.initGraph(), this.contextmenu = pi(this), te(() => {
      this.groupRefresh();
    }), a1(() => {
  ...
  async procesorUpdate(e) {
    ...
    await Z1(e.id, a) && (this.apiUpdateEdge(e), this.initGraph());
  }
  // 构建节点列表
  buildNodesFromTypes() {
  ...
  async initGraphFlowData() {
    ...
    for (const s of t) {
      ...
      this.graphData.push(C), this.graphFormData[s.id] = s.component.config, this.graphCellData[s.id] = s;
    }
    const r = [...t, ...i];
    for (const s of e) {
      const n = s.sourceGroupId != this.groupId ? s.sourceGroupId : s.sourceId, d = s.destinationGroupId != this.groupId ? s.destinationGroupId : s.destinationId, p = s.component.source, A = s.component.destination, C = p.type == "PROCESSOR" ? p.name : `${r.filter((h) => h.id == n)[0].component.name} ( ${p.name} )`, m = A.type == "PROCESSOR" ? A.name : `${r.filter((h) => h.id == d)[0].component.name} (${A.name})`, u = `[${C}] -> [${m}]`, f = {
        id: s.id,
        shape: "vue-edge",
  ...
  async initCellHistory(e, t) {
    ...
    try {
      ...
      console.log(o), ((a = (i = o == null ? void 0 : o.statusHistory) == null ? void 0 : i.aggregateSnapshots) == null ? void 0 : a.length) == 0 ? Y.info("历史记录不足，请稍后再试") : K1({ title: "状态历史", message: Je(Hi, { data: o }) });
    } catch (o) {
      Y.error("接口调用失败！"), console.warn(o);
    }
  }
  // 初始化节点的状态记录
  initNodeStatus(e, t) {
  ...
  getEdgeData(e) {
    var u, f, h, w, y, Q, L;
    const t = e.data, i = (u = this.graphShadow) == null ? void 0 : u.get(e), a = l(i.source), o = l(i.target), r = (f = this.graph) == null ? void 0 : f.getCellById(a), s = (h = this.graph) == null ? void 0 : h.getCellById(o), n = ((y = (w = r == null ? void 0 : r.data) == null ? void 0 : w.component) == null ? void 0 : y.relationships) || [], d = t.component.name || (t.component.selectedRelationships || []).join(",");
    let p = "", A = [], C = [], m = {};
    return t != null && t.id ? (p = e.prop("title"), m = e.data.component, A = ((Q = this.graphShadow) == null ? void 0 : Q.get(a, "outputPorts")) || [], C = ((L = this.graphShadow) == null ? void 0 : L.get(o, "inputPorts")) || []) : p = `[${r == null ? void 0 : r.prop("label")}] -> [${s == null ? void 0 : s.prop("label")}]`, { title: p, outPorts: A, inPorts: C, modelValue: m, label: d, relationships: n, sourceNode: r, targetNode: s, sourceId: a, targetId: o, id: t == null ? void 0 : t.id };
  }
  async getEdgeInfo(e) {
    var C, m, u, f, h, w, y, Q, L;
    const t = (C = this.graphShadow) == null ? void 0 : C.get(e), i = l(t.source), a = l(t.target), o = (m = this.graph) == null ? void 0 : m.getCellById(i), r = (u = this.graph) == null ? void 0 : u.getCellById(a);
    let s = [], n = [], d = { $EdgeJSONData: e.toJSON() };
    const p = ((h = (f = o == null ? void 0 : o.data) == null ? void 0 : f.component) == null ? void 0 : h.relationships) || [], A = `[${o == null ? void 0 : o.prop("label")}] -> [${r == null ? void 0 : r.prop("label")}]`;
    if (o == null || o.data.component.parentGroupId, r == null || r.data.component.parentGroupId, (o == null ? void 0 : o.data.outputPortCount) > 0) {
      const k = await this.apiGetGroupData(i);
      s = k.processGroupFlow.flow.outputPorts, s[0].id, (w = this.graphShadow) == null || w.set(i, "processGroupFlow", k.processGroupFlow), (y = this.graphShadow) == null || y.set(i, "outputPorts", s);
    }
    if ((r == null ? void 0 : r.data.inputPortCount) > 0) {
      const k = await this.apiGetGroupData(a);
      n = k.processGroupFlow.flow.inputPorts, n[0].id, (Q = this.graphShadow) == null || Q.set(a, "processGroupFlow", k.processGroupFlow), (L = this.graphShadow) == null || L.set(a, "inputPorts", n);
    }
    return { title: A, inPorts: n, outPorts: s, modelValue: d, relationships: p, sourceNode: o, targetNode: r };
  }
  async edgeElem(e) {
    const { title: t, inPorts: i, outPorts: a, relationships: o, targetNode: r, modelValue: s } = await this.getEdgeInfo(e), n = ci({ relationships: o, outPorts: a }, { cell: r, inPorts: i }, { that: this, modelValue: s });
    return { title: t, outPorts: a, inPorts: i, modelValue: s, elem: n };
  }
  async edgeInit(e) {
    var t, i;
    if (e.data && e.data.id) {
      const a = Oe(e, this), { title: o, label: r } = this.getEdgeData(e);
